...
class SectionRepository extends Repository
{
    ...
    /**
     * Store a single uploaded image against a section, returning the path on the disk, which the
     * storefront resolves to a url when it renders so the row survives a change of disk or domain.
     *
     * @param  int  $id
     */
