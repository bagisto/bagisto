...
class Configurable extends AbstractType
{
    ...
    public function getPriceHtml()
    {
        if ($this->haveSpecialPrice()) {
            ...
            . '<span class="special-price">' . core()->currency($this->evaluatePrice($this->getMinimalPrice())) . '</span>'.'<span class="regular-price"></span>'. ' <span class="card-discount"></span>';
        } elseif ($this->haveOffer()) {
            return '<div class="sticker sale">' . trans('shop::app.products.sale') . '</div>'
            . '<span class="price-label">' . trans('shop::app.products.price-label') . '</span>'
            . '<span class="regular-price">' . core()->currency($this->evaluatePrice($this->getMinimalPrice())) . '</span>'
            . '<span class="final-price">' . core()->currency($this->evaluatePrice($this->getOfferPrice())) . '</span>'. ' <span class="card-discount"></span>';
        } else {
