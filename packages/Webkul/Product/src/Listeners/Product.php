...
class Product
{
    ...
    /**
     * Remove the deleted products from the search index and reindex the related products
     * that still exist, so a surviving parent is not left deleted.
     *
     * @param  int  $productId
     * @return void
     */
