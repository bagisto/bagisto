...
return [
    'checkout' => [
        'cart' => [
            ...
            'invalid-file-extension' => 'Недійсне розширення файлу знайдено.',
    ...
    'catalog' => [
        'products' => [
            'edit' => [
                'price' => [
                    'group' => [
                        'duplicate-group-price-error' => 'Ціна групи клієнтів з такою ж кількістю та групою клієнтів вже існує.',
                    ],
                ],
            ],
        ],
