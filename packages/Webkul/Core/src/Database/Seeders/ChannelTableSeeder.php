...
class ChannelTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('channels')->insert([
            ...
            <div class="left-banner"><img src='.asset("/themes/default/assets/images/1.webp").' class="lazyload" alt="test" width="720" height="720" /></div>
            <div class="right-banner"><img src='. asset("/themes/default/assets/images/2.webp").' class="lazyload" alt="test" width="460" height="330" /> <img src='.asset("/themes/default/assets/images/3.webp").' class="lazyload" alt="test" width="460" height="330" /></div>
            </div>',
