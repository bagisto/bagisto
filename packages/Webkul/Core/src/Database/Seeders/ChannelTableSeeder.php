            ...
            [
                ...
                'footer_content' => '
                    <div class="list-container">
                        ...
                        <ul class="list-group">
                            <li><a href="'.$baseUrl.'/page/about-us">About Us</a></li>
                            <li><a href="'.$baseUrl.'/page/return-policy">Return Policy</a></li>
                            <li><a href="'.$baseUrl.'/page/refund-policy">Refund Policy</a></li>
                            <li><a href="'.$baseUrl.'/page/terms-conditions">Terms and conditions</a></li>
                            <li><a href="'.$baseUrl.'/page/terms-of-use">Terms of Use</a></li>
                            <li><a href="'.$baseUrl.'/page/contact-us">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="list-container">
