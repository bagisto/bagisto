...
class CartResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'sub_total_excl_tax'                 => $this->sub_total,
            'formatted_sub_total_incl_tax'       => core()->formatPrice($this->sub_total_incl_tax),
            'formatted_sub_total_excl_tax'       => core()->formatPrice($this->sub_total),
            'coupon_code'                        => $this->coupon_code,
            'discount_amount'                    => $this->discount_amount,
            'formatted_discount_amount'          => core()->formatPrice($this->discount_amount),
            'shipping_method'                    => $this->shipping_method,
            'shipping_amount_excl_tax'           => $this->shipping_amount,
            'formatted_shipping_amount_excl_tax' => core()->formatPrice($this->shipping_amount),
