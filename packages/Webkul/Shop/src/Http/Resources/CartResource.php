...
class CartResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'base_tax_amounts'              => Tax::getTaxRatesWithAmount($this, true),
            'base_discount_amount'          => core()->currency($this->base_discount_amount),
            ...
            'payment_method'                => $this->payment ? core()->getConfigData('sales.paymentmethods.' . $this->payment->method . '.title') : '',
        ];
    }
}
