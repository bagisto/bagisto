...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'invoice-reminder' => [
                'disregard-this-email' => 'اگر از پیش پرداخت کرده‌اید، لطفاً این ایمیل را نادیده بگیرید.',
                'please-make-payment'  => 'لطفاً هر چه سریعتر پرداخت خود را انجام دهید.',
                'thanks'               => 'سپاسگزاریم!',
                'overdue-invoice'      => 'فاکتور شما :invoice تأخیرکرده است به مدت :time.',
            ],
