...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'reminder' => [
                'already-paid'    => 'اگر قبلاً پرداخت کرده‌اید، این ایمیل را نادیده بگیرید.',
                'invoice-overdue' => 'فاکتور شما :invoice به مدت :time دیر شده است.',
                'make-payment'    => 'لطفاً پرداخت خود را در اسرع وقت انجام دهید.',
