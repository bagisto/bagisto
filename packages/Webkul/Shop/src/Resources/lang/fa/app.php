...
return [
    ...
    'checkout' => [
        'success' => [
            ...
            'order-id-info' => 'شماره سفارش شما #:order_id می‌باشد',
            'info'          => 'ما جزئیات سفارش و اطلاعات پیگیری آن را به شما ایمیل خواهیم کرد',
        ],

        'cart' => [
            'item-add-to-cart'          => 'مورد با موفقیت افزوده شد',
            ...
            'suspended-account-message' => 'حساب کاربری شما معلق شده است.',
            'missing-fields'            => 'برخی از فیلدهای مورد نیاز برای این محصول وجود ندارند.',
            'missing-options'           => 'گزینه‌ها برای این محصول وجود ندارند.',
            'missing-links'             => 'لینک‌های قابل دانلود برای این محصول وجود ندارند.',
            'select-hourly-duration'    => 'یک مدت زمان ساعتی را انتخاب کنید.',
            'qty-missing'               => 'حداقل یک محصول باید بیشتر از 1 تعداد داشته باشد.',
            'success-remove'            => 'مورد با موفقیت از سبد خرید حذف شد.',
            'inventory-warning'         => 'تعداد درخواستی موجود نیست، لطفاً بعداً دوباره تلاش کنید.',
            'illegal'                   => 'تعداد نمی‌تواند کمتر از 1 باشد.',
            'inactive'                  => 'محصول غیرفعال شده و از سبد خرید حذف شده است.',
            ...
            'index' => [
                ...
                'empty-product'            => 'شما هیچ محصولی در سبد خرید ندارید.',
            ...
            'coupon'   => [
                ...
                'already-applied' => 'کد تخفیف از قبل اعمال شده است.',
                'enter-your-code' => 'کد تخفیف خود را وارد کنید',
                'subtotal'        => 'مجموع جزئی',
                'button-title'    => 'اعمال',
            ],
            ...
            'summary' => [
                ...
                'tax'                 => 'مالیات',
                'delivery-charges'    => 'هزینه‌های حمل و نقل',
        ...
        'onepage' => [
            ...
            'order-comment' => [
                'title'  => 'توضیحات سفارش',
                'enter'  => 'توضیحات خود را وارد کنید',
                'update' => 'بروزرسانی',
            ],
