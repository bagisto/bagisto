...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'social-account-exists' => 'इस ईमेल से एक खाता पहले से मौजूद है। कृपया अपने ईमेल और पासवर्ड से साइन इन करें।',
            'title' => 'साइन इन करें',
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'इस इवेंट के लिए केवल :qty टिकट उपलब्ध हैं।',
                        'sold-out' => 'इस इवेंट के टिकट बिक चुके हैं।',
                        'ticket-exceeds-available' => 'केवल :qty ":ticket" टिकट उपलब्ध हैं।',
                        'ticket-sold-out' => '":ticket" टिकट बिक चुके हैं।',
                    ],
                    ...
                    'rental-unavailable' => 'यह किराये का उत्पाद चयनित तिथियों के लिए उपलब्ध नहीं है।',
                    'select-hourly-duration' => 'कम से कम एक घंटे की अवधि चुनें।',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'अपना प्रत्याहरण देखें',
        ],
        ...
        'lookup' => [
            ...
            'sent-notice' => 'यदि कोई मेल खाता ऑर्डर मौजूद है, तो हमने अभी उस पते पर एक प्रत्याहरण लिंक ईमेल किया है। यह 24 घंटे के लिए वैध रहेगा।',
            'legal-note' => 'EU Directive 2011/83/EU (संशोधित) के तहत आपके पास 14 दिनों के भीतर अनुबंध से हटने का वैधानिक अधिकार है। प्रत्याहरण के अन्य साधन — हमारी ग्राहक सेवा को भेजे गए लिखित बयान सहित — वैध रहेंगे।',
        ],

        'form' => [
            'page-title' => 'अपने प्रत्याहरण की पुष्टि करें',
            'heading' => 'अनुबंध से प्रत्याहरण की पुष्टि करें',
            'legal-notice-title' => 'यह कानूनी रूप से बाध्यकारी घोषणा है',
            'legal-effect' => 'इस फॉर्म को जमा करके आप ऑर्डर #:order_id के लिए अपने वैधानिक प्रत्याहरण अधिकार का प्रयोग करते हैं। जमा करने के क्षण से घोषणा कानूनी रूप से प्रभावी हो जाती है।',
            'order-summary' => 'ऑर्डर',
            'order-total' => 'कुल',
            'order-items' => 'आइटम',
            'placed-on' => ':date को रखा गया',
            'reason-label' => 'कारण',
            'reason-optional' => '(वैकल्पिक)',
            'reason-help' => 'कारण देना अनिवार्य नहीं है। आप यहां जो भी लिखेंगे वह प्रत्याहरण साक्ष्य पर दर्ज किया जाएगा और विक्रेता को भेजा जाएगा।',
            'reason-placeholder' => 'उदाहरण: "मन बदल गया", "आइटम वर्णन के अनुसार नहीं", या खाली छोड़ दें।',
            'submit' => 'प्रत्याहरण जमा करें',
            'cancel' => 'रद्द करें और वापस जाएं',
        ],

        'confirmation' => [
            'page-title' => 'प्रत्याहरण रसीद',
            'heading' => 'आपका प्रत्याहरण प्राप्त हो गया है',
            'heading-received' => 'आपका प्रत्याहरण प्राप्त हो गया है',
            'heading-refunded' => 'आपकी धन वापसी जारी कर दी गई है',
            'heading-declined' => 'आपका प्रत्याहरण अस्वीकृत कर दिया गया',
            ...
            'intro-received' => 'हमने आपकी घोषणा दर्ज कर ली है। यह पृष्ठ और जो ईमेल हमने अभी आपको भेजा है, दोनों स्थायी माध्यम पर पुष्टि के रूप में कार्य करते हैं।',
            'intro-refunded' => 'विक्रेता ने आपकी धन वापसी की प्रक्रिया कर दी है। प्रतिपूर्ति शीघ्र ही आपके मूल भुगतान साधन में पहुँच जाएगी।',
            'intro-declined' => 'विक्रेता ने इस घोषणा के तहत धन वापसी के आपके अधिकार पर आपत्ति की है। दिए गए कारण और आपके शेष विकल्पों के लिए नीचे विवरण देखें।',
            'received-at' => 'प्राप्ति समय',
            'reference' => 'संदर्भ',
            'copy-reference' => 'संदर्भ कॉपी करें',
            'reference-copied' => 'संदर्भ क्लिपबोर्ड पर कॉपी किया गया।',
            'order' => 'ऑर्डर',
            'email' => 'ईमेल',
            'reason' => 'कारण',
            'status' => 'स्थिति',
            'status-received' => 'प्राप्त',
            'status-refunded' => 'धन वापसी',
            'status-declined' => 'अस्वीकृत',
            'print' => 'प्रिंट करें',
            'next-steps-title' => 'आगे क्या होगा',
            'step-received' => 'आपकी घोषणा प्राप्त और दर्ज की गई है।',
            'step-email' => 'पुष्टि ईमेल आपके इनबॉक्स में भेजा गया।',
            'step-refund' => '14 दिनों के भीतर धन वापसी जारी की जाएगी।',
            'step-refund-done' => 'धन वापसी जारी कर दी गई है।',
            'step-declined' => 'विक्रेता द्वारा प्रत्याहरण अस्वीकृत।',
            'declined-reason-label' => 'विक्रेता द्वारा दिया गया कारण',
            'declined-notice' => 'EU उपभोक्ता कानून के तहत आपके अन्य सभी कानूनी उपाय बरकरार हैं। यदि आप इस निर्णय से असहमत हैं, तो सीधे विक्रेता से संपर्क करें।',
            'refund-notice' => 'जब तक आप स्पष्ट रूप से अन्यथा सहमत न हों, हम मूल लेनदेन के लिए उपयोग किए गए उसी भुगतान साधन के माध्यम से प्रतिपूर्ति करते हैं।',
            'email-sent' => 'पुष्टि ईमेल भेज दिया गया है।',
            'email-pending' => 'हम तुरंत पुष्टि ईमेल नहीं भेज सके; हमारी टीम इस पर कार्रवाई करेगी। कृपया इस पृष्ठ को अपनी रसीद के रूप में सहेजें।',
            'durable-medium-notice' => 'यह पृष्ठ आपकी रसीद है। आप इसे सहेज या प्रिंट कर सकते हैं।',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'प्रत्याहरण प्राप्त',
                'title-refunded' => 'धन वापसी जारी',
                'title-declined' => 'प्रत्याहरण अस्वीकृत',
                'greeting' => 'नमस्ते,',
                ...
                'intro-received' => 'हमें ऑर्डर #:order_id के लिए अनुबंध से आपकी प्रत्याहरण घोषणा प्राप्त हो गई है। कानूनी रूप से प्रभावी प्राप्ति का समय नीचे दर्ज किया गया है।',
                'intro-refunded' => 'ऑर्डर #:order_id के लिए आपकी धन वापसी जारी कर दी गई है। प्रतिपूर्ति शीघ्र ही आपके मूल भुगतान साधन में पहुँच जाएगी।',
                'intro-declined' => 'विक्रेता ने इस घोषणा के तहत ऑर्डर #:order_id के लिए धन वापसी के आपके अधिकार पर आपत्ति की है। दिया गया कारण नीचे है।',
                ...
                'declined-reason' => 'अस्वीकार का कारण',
                'refund-notice' => 'जहां धन वापसी देय है, हम उपरोक्त तिथि से 14 दिनों के भीतर मूल लेनदेन के लिए उपयोग किए गए उसी भुगतान साधन से प्रतिपूर्ति करते हैं, जब तक आप स्पष्ट रूप से अन्यथा सहमत न हों।',
