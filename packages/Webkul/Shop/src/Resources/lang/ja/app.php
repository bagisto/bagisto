...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'このイベントでは :qty 枚のチケットのみ利用可能です。',
                        'sold-out' => 'このイベントのチケットは完売しました。',
                        'ticket-exceeds-available' => '":ticket" のチケットは :qty 枚のみ利用可能です。',
                        'ticket-sold-out' => '":ticket" のチケットは完売しました。',
                    ],

                    'missing-options' => 'この製品にはオプションがありません。',
                    'inventory-warning' => '要求された数量は利用できません。後でやり直してください。',
                    'rental-unavailable' => 'このレンタル商品は選択された日付では利用できません。',
                    'select-hourly-duration' => '1時間以上のスロット時間を選択してください。',
                ],
    ...
    'eu-withdrawal' => [
        ...
        'lookup' => [
            ...
            'email' => 'メールアドレス',
            'submit' => '契約撤回のリンクを送信',
            'sent-notice' => '該当する注文が存在する場合、契約撤回手続きのリンクをそのメールアドレスにお送りしました。リンクは24時間有効です。',
            'legal-note' => 'お客様は、EU指令 2011/83/EU（改正後）に基づき、14日以内に契約を撤回する法定の権利を有します。当社カスタマーサービスへの書面による申し出を含む、その他の方法による撤回も引き続き有効です。',
        ],

        'form' => [
            'page-title' => '契約撤回の確定',
            'heading' => '契約撤回の確定',
            'legal-notice-title' => 'これは法的拘束力のある宣言です',
            'legal-effect' => 'このフォームを送信することにより、注文 #:order_id の法定撤回権を行使することになります。本宣言は送信した時点で法的に発効します。',
            'order-summary' => '注文',
            'order-total' => '合計',
            'order-items' => '商品',
            'placed-on' => '注文日：:date',
            'reason-label' => '理由',
            'reason-optional' => '（任意）',
            'reason-help' => '理由のご記入は必須ではありません。ここに記入された内容は契約撤回のエビデンスに記録され、販売者に送信されます。',
            'reason-placeholder' => '例：「気が変わった」「商品が説明と違う」、または空欄のままでも構いません。',
            'submit' => '契約撤回を送信',
            'cancel' => 'キャンセルして戻る',
        ],
        ...
        'confirmation' => [
            ...
            'heading-received' => '契約撤回を受け付けました',
            'heading-refunded' => '返金を実施しました',
            'heading-declined' => '契約撤回は却下されました',
            'intro' => 'お客様の宣言を記録しました。本ページおよびただいま送信した確認メールが、永続的媒体での確認として機能します。',
            'intro-received' => 'お客様の宣言を記録しました。本ページおよびただいま送信した確認メールが、永続的媒体での確認として機能します。',
            'intro-refunded' => '販売者が返金を処理しました。返金額は、まもなく元のお支払い方法に反映されます。',
            'intro-declined' => '販売者は本宣言に基づく返金請求権について異議を申し立てました。提示された理由および残された選択肢については、以下の詳細をご覧ください。',
            'received-at' => '受領日時',
            'reference' => '参照番号',
            'copy-reference' => '参照番号をコピー',
            'reference-copied' => '参照番号をクリップボードにコピーしました。',
            'order' => '注文',
            'email' => 'メールアドレス',
            'reason' => '理由',
            'status' => 'ステータス',
            ...
            'status-declined' => '却下',
            'print' => '印刷',
            'next-steps-title' => '今後の流れ',
            'step-received' => 'お客様の宣言は受領され、記録されました。',
            'step-email' => '確認メールをお客様の受信箱にお送りしました。',
            'step-refund' => '14日以内に返金を実施します。',
            'step-refund-done' => '返金が実施されました。',
            'step-declined' => '販売者により契約撤回が却下されました。',
            'declined-reason-label' => '販売者から提示された理由',
            'declined-notice' => 'EU消費者法に基づく他のすべての救済手段は引き続き有効です。本決定に同意されない場合は、販売者に直接ご連絡ください。',
            'refund-notice' => '別途明示的に合意した場合を除き、当初の取引でお客様が使用されたものと同じ支払い方法で返金いたします。',
            'email-sent' => '確認メールを送信しました。',
            'email-pending' => '確認メールを直ちに送信することができませんでした。担当者が対応いたします。本ページを受領証として保存してください。',
            'durable-medium-notice' => '本ページは受領証です。保存または印刷していただけます。',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title' => '契約撤回を受領しました',
                'title-received' => '契約撤回を受領しました',
                'title-refunded' => '返金を実施しました',
                'title-declined' => '契約撤回は却下されました',
                'greeting' => 'こんにちは。',
                'intro' => '注文 #:order_id の契約撤回宣言を受領しました。法的に有効な受領日時を以下に記録しています。',
                'intro-received' => '注文 #:order_id の契約撤回宣言を受領しました。法的に有効な受領日時を以下に記録しています。',
                'intro-refunded' => '注文 #:order_id の返金を実施しました。返金額は、まもなく元のお支払い方法に反映されます。',
                'intro-declined' => '販売者は、本宣言に基づく注文 #:order_id の返金請求権について異議を申し立てました。提示された理由は以下の通りです。',
                'summary' => '契約撤回の概要',
                'received-at' => '受領日時',
                'reference' => '参照番号',
                'order' => '注文',
                'email' => 'メールアドレス',
                'reason' => 'お客様の理由',
                'declined-reason' => '却下の理由',
                'refund-notice' => '返金が発生する場合、別途明示的に合意した場合を除き、上記日付から14日以内に、当初の取引でお客様が使用されたものと同じ支払い方法で返金いたします。',
