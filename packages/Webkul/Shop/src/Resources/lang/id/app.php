...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'Hanya :qty tiket tersedia untuk acara ini.',
                        'sold-out' => 'Tiket untuk acara ini sudah habis terjual.',
                        'ticket-exceeds-available' => 'Hanya :qty tiket ":ticket" tersedia.',
                        'ticket-sold-out' => 'Tiket ":ticket" sudah habis.',
                    ],

                    'missing-options' => 'Opsi tidak tersedia untuk produk ini.',
                    'inventory-warning' => 'Jumlah yang diminta tidak tersedia, silakan coba lagi nanti.',
                    'rental-unavailable' => 'Produk sewa ini tidak tersedia untuk tanggal yang dipilih.',
                    'select-hourly-duration' => 'Pilih durasi slot minimal satu jam.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'Lihat penarikan diri Anda',
        ],
        ...
        'lookup' => [
            'page-title' => 'Menarik Diri dari Kontrak',
            ...
            'sent-notice' => 'Jika ada pesanan yang cocok, kami baru saja mengirimkan email berisi tautan penarikan diri ke alamat tersebut. Tautan ini berlaku selama 24 jam.',
            'legal-note' => 'Anda memiliki hak hukum berdasarkan Direktif UE 2011/83/UE (sebagaimana telah diubah) untuk menarik diri dari kontrak Anda dalam waktu 14 hari. Cara penarikan diri lainnya — termasuk pernyataan tertulis yang dikirim ke layanan pelanggan kami — tetap berlaku.',
        ],

        'form' => [
            'page-title' => 'Konfirmasikan penarikan diri Anda',
            'heading' => 'Konfirmasi Penarikan Diri dari Kontrak',
            'legal-notice-title' => 'Ini adalah pernyataan yang mengikat secara hukum',
            'legal-effect' => 'Dengan mengirimkan formulir ini, Anda menggunakan hak hukum untuk menarik diri dari pesanan #:order_id. Pernyataan ini berlaku secara hukum sejak Anda mengirimkannya.',
            'order-summary' => 'Pesanan',
            'order-total' => 'Total',
            'order-items' => 'Item',
            'placed-on' => 'Dipesan pada :date',
            'reason-label' => 'Alasan',
            'reason-optional' => '(opsional)',
            'reason-help' => 'Anda tidak diwajibkan memberikan alasan. Apa pun yang Anda tulis di sini akan dicatat pada bukti penarikan diri dan dikirim ke penjual.',
            'reason-placeholder' => 'Sebagai contoh: "Berubah pikiran", "Barang tidak sesuai deskripsi", atau biarkan kosong.',
            'submit' => 'Kirim penarikan diri',
            'cancel' => 'Batal dan kembali',
        ],

        'confirmation' => [
            'page-title' => 'Bukti Penarikan Diri',
            'heading' => 'Penarikan diri Anda telah diterima',
            'heading-received' => 'Penarikan diri Anda telah diterima',
            'heading-refunded' => 'Pengembalian dana Anda telah dikeluarkan',
            'heading-declined' => 'Penarikan diri Anda ditolak',
            ...
            'intro-received' => 'Kami telah mencatat pernyataan Anda. Halaman ini dan email yang baru saja kami kirimkan keduanya berfungsi sebagai konfirmasi pada media yang tahan lama.',
            'intro-refunded' => 'Penjual telah memproses pengembalian dana Anda. Dana seharusnya segera tiba melalui metode pembayaran asli Anda.',
            'intro-declined' => 'Penjual menolak hak Anda atas pengembalian dana berdasarkan pernyataan ini. Lihat detail di bawah untuk alasan yang diberikan dan opsi yang tersisa bagi Anda.',
            'received-at' => 'Diterima pada',
            'reference' => 'Referensi',
            'copy-reference' => 'Salin referensi',
            'reference-copied' => 'Referensi disalin ke papan klip.',
            'order' => 'Pesanan',
            'email' => 'Email',
            'reason' => 'Alasan',
            'status' => 'Status',
            ...
            'print' => 'Cetak',
            'next-steps-title' => 'Langkah berikutnya',
            'step-received' => 'Pernyataan Anda telah diterima dan dicatat.',
            'step-email' => 'Email konfirmasi terkirim ke kotak masuk Anda.',
            'step-refund' => 'Pengembalian dana dikeluarkan dalam 14 hari.',
            'step-refund-done' => 'Pengembalian dana telah dikeluarkan.',
            'step-declined' => 'Penarikan diri ditolak oleh penjual.',
            'declined-reason-label' => 'Alasan yang diberikan oleh penjual',
            'declined-notice' => 'Anda tetap memiliki semua upaya hukum lain berdasarkan hukum perlindungan konsumen UE. Jika Anda tidak setuju dengan keputusan ini, hubungi penjual secara langsung.',
            'refund-notice' => 'Kami melakukan pengembalian dana menggunakan metode pembayaran yang sama dengan yang Anda gunakan untuk transaksi awal, kecuali Anda secara tegas menyetujui hal lain.',
            'email-sent' => 'Email konfirmasi telah dikirim.',
            'email-pending' => 'Kami tidak dapat segera mengirim email konfirmasi; tim kami akan menindaklanjutinya. Mohon simpan halaman ini sebagai bukti Anda.',
            'durable-medium-notice' => 'Halaman ini adalah bukti Anda. Anda dapat menyimpan atau mencetaknya.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'Penarikan diri diterima',
                'title-refunded' => 'Pengembalian dana dikeluarkan',
                'title-declined' => 'Penarikan diri ditolak',
                'greeting' => 'Halo,',
                ...
                'intro-received' => 'Kami telah menerima pernyataan penarikan diri dari kontrak untuk pesanan #:order_id. Stempel waktu penerimaan yang berlaku secara hukum dicatat di bawah ini.',
                'intro-refunded' => 'Pengembalian dana Anda untuk pesanan #:order_id telah dikeluarkan. Dana seharusnya segera tiba melalui metode pembayaran asli Anda.',
                'intro-declined' => 'Penjual menolak hak Anda atas pengembalian dana untuk pesanan #:order_id berdasarkan pernyataan ini. Alasan yang diberikan ada di bawah.',
                ...
                'declined-reason' => 'Alasan penolakan',
                'refund-notice' => 'Apabila pengembalian dana wajib dilakukan, kami melakukan pengembalian melalui metode pembayaran yang sama dengan yang Anda gunakan untuk transaksi awal, dalam waktu 14 hari sejak tanggal di atas, kecuali Anda secara tegas menyetujui hal lain.',
