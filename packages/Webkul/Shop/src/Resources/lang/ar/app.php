...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'يتوفر :qty تذاكر فقط لهذا الحدث.',
                        'sold-out' => 'تم بيع جميع تذاكر هذا الحدث.',
                        'ticket-exceeds-available' => 'يتوفر :qty تذاكر ":ticket" فقط.',
                        'ticket-sold-out' => 'تم بيع جميع تذاكر ":ticket".',
                    ],

                    'missing-options' => 'الخيارات مفقودة لهذا المنتج.',
                    'inventory-warning' => 'الكمية المطلوبة غير متوفرة، يرجى المحاولة مرة أخرى لاحقًا.',
                    'rental-unavailable' => 'هذا المنتج الإيجاري غير متاح للتواريخ المحددة.',
                    'select-hourly-duration' => 'اختر مدة زمنية لا تقل عن ساعة واحدة.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'عرض طلب الانسحاب',
        ],
        ...
        'lookup' => [
            ...
            'sent-notice' => 'إذا كان هناك طلب مطابق، فقد أرسلنا للتو رابط الانسحاب إلى ذلك العنوان. سيكون الرابط صالحاً لمدة 24 ساعة.',
            'legal-note' => 'يحقّ لك قانونياً بموجب التوجيه الأوروبي 2011/83/EU (وتعديلاته) الانسحاب من عقدك خلال 14 يوماً. وتظل سُبل الانسحاب الأخرى — بما في ذلك إرسال إقرار خطّي إلى خدمة العملاء — سارية المفعول.',
        ],

        'form' => [
            'page-title' => 'تأكيد طلب الانسحاب',
            'heading' => 'تأكيد الانسحاب من العقد',
            'legal-notice-title' => 'هذا إقرار مُلزِم قانونياً',
            'legal-effect' => 'بإرسالك هذا النموذج فإنك تمارس حقّك القانوني في الانسحاب من الطلب رقم ‎#:order_id. ويصبح الإقرار نافذاً قانونياً فور إرساله.',
            'order-summary' => 'الطلب',
            'order-total' => 'الإجمالي',
            'order-items' => 'العناصر',
            'placed-on' => 'تم في :date',
            'reason-label' => 'السبب',
            'reason-optional' => '(اختياري)',
            'reason-help' => 'لستَ مُلزَماً بذكر سبب. وأيّ نصّ تكتبه هنا سيُسجَّل في أدلة الانسحاب ويُرسَل إلى التاجر.',
            'reason-placeholder' => 'مثلاً: «غيّرتُ رأيي»، أو «المنتج لا يطابق الوصف»، أو اتركه فارغاً.',
            'submit' => 'إرسال طلب الانسحاب',
            'cancel' => 'إلغاء والعودة',
        ],

        'confirmation' => [
            'page-title' => 'إيصال الانسحاب',
            'heading' => 'تم استلام طلب الانسحاب',
            'heading-received' => 'تم استلام طلب الانسحاب',
            'heading-refunded' => 'تم إصدار المبلغ المستردّ',
            'heading-declined' => 'تم رفض طلب الانسحاب',
            'intro' => 'لقد سجّلنا إقرارك. وتُعدّ هذه الصفحة والبريد الإلكتروني الذي أرسلناه إليك للتو بمثابة تأكيد على وسيط دائم.',
            'intro-received' => 'لقد سجّلنا إقرارك. وتُعدّ هذه الصفحة والبريد الإلكتروني الذي أرسلناه إليك للتو بمثابة تأكيد على وسيط دائم.',
            'intro-refunded' => 'قام التاجر بمعالجة مبلغ الاسترداد. وسيصل المبلغ قريباً إلى وسيلة الدفع الأصلية.',
            'intro-declined' => 'اعترض التاجر على استحقاقك للاسترداد بموجب هذا الإقرار. راجع التفاصيل أدناه للاطلاع على السبب المُقدَّم وخياراتك المتبقية.',
            ...
            'status-refunded' => 'مُستردّ',
            'status-declined' => 'مرفوض',
            'print' => 'طباعة',
            'next-steps-title' => 'الخطوات التالية',
            'step-received' => 'تم استلام إقرارك وتسجيله.',
            'step-email' => 'تم إرسال بريد التأكيد إلى صندوق بريدك.',
            'step-refund' => 'يُصدَر الاسترداد خلال 14 يوماً.',
            'step-refund-done' => 'تم إصدار الاسترداد.',
            'step-declined' => 'تم رفض طلب الانسحاب من قِبَل التاجر.',
            'declined-reason-label' => 'السبب الذي قدّمه التاجر',
            'declined-notice' => 'تحتفظ بجميع وسائل الانتصاف القانونية الأخرى وفقاً لقوانين حماية المستهلك في الاتحاد الأوروبي. إذا كنت لا توافق على هذا القرار، يُرجى التواصل مع التاجر مباشرةً.',
            'refund-notice' => 'نُعيد المبلغ بنفس وسيلة الدفع التي استخدمتها في المعاملة الأصلية، ما لم تكن قد اتفقتَ معنا صراحةً على خلاف ذلك.',
            'email-sent' => 'تم إرسال بريد التأكيد.',
            'email-pending' => 'تعذّر علينا إرسال بريد التأكيد في الحال؛ سيقوم فريقنا بالمتابعة. يُرجى حفظ هذه الصفحة بوصفها إيصالك.',
            'durable-medium-notice' => 'هذه الصفحة هي إيصالك. يمكنك حفظها أو طباعتها.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'تم استلام طلب الانسحاب',
                'title-refunded' => 'تم إصدار الاسترداد',
                'title-declined' => 'تم رفض طلب الانسحاب',
                'greeting' => 'مرحباً،',
                'intro' => 'لقد تلقّينا إقرارك بالانسحاب من العقد الخاص بالطلب رقم ‎#:order_id. وفيما يلي الطابع الزمني للاستلام النافذ قانونياً.',
                'intro-received' => 'لقد تلقّينا إقرارك بالانسحاب من العقد الخاص بالطلب رقم ‎#:order_id. وفيما يلي الطابع الزمني للاستلام النافذ قانونياً.',
                'intro-refunded' => 'تم إصدار مبلغ الاسترداد الخاص بالطلب رقم ‎#:order_id. وسيصل المبلغ قريباً إلى وسيلة الدفع الأصلية.',
                'intro-declined' => 'اعترض التاجر على استحقاقك للاسترداد عن الطلب رقم ‎#:order_id بموجب هذا الإقرار. والسبب المُقدَّم مذكور أدناه.',
                ...
                'declined-reason' => 'سبب الرفض',
                'refund-notice' => 'حيثما كان الاسترداد مستحقاً، فإننا نُعيد المبلغ بنفس وسيلة الدفع التي استخدمتها في المعاملة الأصلية، خلال 14 يوماً من التاريخ المذكور أعلاه، ما لم تكن قد اتفقتَ معنا صراحةً على خلاف ذلك.',
