...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'invoice-reminder' => [
                'disregard-this-email' => 'إذا كنت قد دفعت بالفعل، فقط تجاهل هذا البريد الإلكتروني.',
                'please-make-payment'  => 'يرجى دفع مبلغ الفاتورة في أقرب وقت ممكن.',
                'thanks'               => 'شكرًا!',
                'overdue-invoice'      => 'الفاتورة :invoice متأخرة بمدة :time.',
            ],
