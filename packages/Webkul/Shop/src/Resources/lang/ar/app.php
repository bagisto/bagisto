...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'bagisto'              => 'بانر كي دبليو',
            'email'                => 'البريد الإلكتروني',
            'email-not-exist'      => 'لا يمكننا العثور على مستخدم بهذا البريد الإلكتروني',
            'footer'               => '© حقوق الطبع والنشر 2010 - :current_year، BannerKW (مسجل في الكويتد). جميع الحقوق محفوظة.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© حقوق النشر 2010 - :current_year ، BannerKW (مسجل في الكويتد). كل الحقوق محفوظة.',
                'locale'                 => 'اللغة',
