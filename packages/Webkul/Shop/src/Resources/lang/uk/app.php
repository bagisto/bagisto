...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'Для цієї події доступно лише :qty квитків.',
                        'sold-out' => 'Квитки на цю подію розпродані.',
                        'ticket-exceeds-available' => 'Доступно лише :qty квитків ":ticket".',
                        'ticket-sold-out' => 'Квитки ":ticket" розпродані.',
                    ],

                    'missing-options' => 'Варіанти відсутні для цього продукту.',
                    'inventory-warning' => 'Запитана кількість недоступна, будь ласка, спробуйте пізніше.',
                    'rental-unavailable' => 'Цей товар для оренди недоступний на обрані дати.',
                    'select-hourly-duration' => 'Виберіть тривалість не менше однієї години.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'Переглянути вашу відмову',
        ],
        ...
        'lookup' => [
            'page-title' => 'Відмова від договору',
            ...
            'sent-notice' => 'Якщо відповідне замовлення існує, ми щойно надіслали на цю адресу посилання для відмови. Воно дійсне протягом 24 годин.',
            'legal-note' => 'Згідно з Директивою ЄС 2011/83/ЄС (зі змінами) Ви маєте передбачене законом право відмовитися від договору протягом 14 днів. Інші форми відмови — зокрема письмова заява, надіслана до нашої служби підтримки клієнтів — залишаються чинними.',
        ],

        'form' => [
            'page-title' => 'Підтвердьте Вашу відмову',
            'heading' => 'Підтвердження відмови від договору',
            'legal-notice-title' => 'Це юридично обов’язкова заява',
            'legal-effect' => 'Надсилаючи цю форму, Ви реалізуєте своє встановлене законом право на відмову від замовлення №:order_id. Заява набуває юридичної сили з моменту її надсилання.',
            'order-summary' => 'Замовлення',
            'order-total' => 'Разом',
            'order-items' => 'Товари',
            'placed-on' => 'Оформлено :date',
            'reason-label' => 'Причина',
            'reason-optional' => '(необов’язково)',
            'reason-help' => 'Вказувати причину не обов’язково. Усе, що Ви напишете тут, буде внесено до матеріалів про відмову та передано продавцю.',
            'reason-placeholder' => 'Наприклад: «Передумав», «Товар не відповідає опису» або залиште порожнім.',
            'submit' => 'Надіслати відмову',
            'cancel' => 'Скасувати і повернутися',
        ],

        'confirmation' => [
            'page-title' => 'Підтвердження відмови',
            'heading' => 'Вашу відмову отримано',
            'heading-received' => 'Вашу відмову отримано',
            'heading-refunded' => 'Повернення коштів виконано',
            'heading-declined' => 'Вашу відмову відхилено',
            ...
            'intro-received' => 'Ми зафіксували Вашу заяву. Ця сторінка та лист, який ми щойно Вам надіслали, разом є підтвердженням на довговічному носії.',
            'intro-refunded' => 'Продавець обробив повернення коштів. Сума має невдовзі надійти на початковий спосіб оплати.',
            'intro-declined' => 'Продавець оспорює Ваше право на повернення за цією заявою. Нижче наведено зазначену причину та інформацію про подальші можливості.',
            'received-at' => 'Отримано',
            'reference' => 'Номер звернення',
            'copy-reference' => 'Скопіювати номер звернення',
            'reference-copied' => 'Номер звернення скопійовано до буфера обміну.',
            'order' => 'Замовлення',
            'email' => 'E-mail',
            'reason' => 'Причина',
            'status' => 'Статус',
            ...
            'print' => 'Друк',
            'next-steps-title' => 'Що далі',
            'step-received' => 'Вашу заяву отримано та зареєстровано.',
            'step-email' => 'Лист-підтвердження надіслано до Вашої поштової скриньки.',
            'step-refund' => 'Повернення коштів протягом 14 днів.',
            'step-refund-done' => 'Повернення коштів виконано.',
            'step-declined' => 'Відмову відхилено продавцем.',
            'declined-reason-label' => 'Причина, зазначена продавцем',
            'declined-notice' => 'За Вами зберігаються всі інші засоби правового захисту, передбачені законодавством ЄС про захист прав споживачів. Якщо Ви не згодні з цим рішенням, зверніться безпосередньо до продавця.',
            'refund-notice' => 'Ми повертаємо кошти тим самим способом оплати, який Ви використовували для початкової транзакції, якщо інше не було прямо погоджено.',
            'email-sent' => 'Лист-підтвердження надіслано.',
            'email-pending' => 'Ми не змогли надіслати лист-підтвердження одразу; наша команда продовжить роботу над цим. Будь ласка, збережіть цю сторінку як підтвердження.',
            'durable-medium-notice' => 'Ця сторінка є Вашим підтвердженням. Її можна зберегти або роздрукувати.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'Відмову отримано',
                'title-refunded' => 'Повернення коштів виконано',
                'title-declined' => 'Відмову відхилено',
                ...
                'intro-received' => 'Ми отримали Вашу заяву про відмову від договору щодо замовлення №:order_id. Юридично значущий час отримання зафіксовано нижче.',
                'intro-refunded' => 'Повернення коштів за замовленням №:order_id виконано. Сума має невдовзі надійти на початковий спосіб оплати.',
                'intro-declined' => 'Продавець оспорює Ваше право на повернення за замовленням №:order_id на підставі цієї заяви. Зазначена причина наведена нижче.',
                ...
                'declined-reason' => 'Причина відхилення',
                'refund-notice' => 'Якщо повернення належить, ми повертаємо кошти тим самим способом оплати, який Ви використовували для початкової транзакції, протягом 14 днів від зазначеної вище дати, якщо інше не було прямо погоджено.',
