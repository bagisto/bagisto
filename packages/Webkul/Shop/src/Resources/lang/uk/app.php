    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'payment' => [
                ...
                'Paytm' => [
                    'redirecting' => 'Через кілька секунд вас буде перенаправлено до Paytm.',
                    'cart-empty' => 'Ваш кошик порожній.',
                    'general-error' => 'Щось пішло не так. Будь ласка, спробуйте ще раз.',
                    'missing-cart-id' => 'Відсутній ідентифікатор кошика.',
                    'cart-not-found' => 'Кошик не знайдено.',
                    'checksum-failed' => 'Перевірка контрольної суми не вдалася.',
                    'payment-failed' => 'Платіж Paytm не вдався або був скасований. Будь ласка, спробуйте ще раз.',
                ],
            ],
