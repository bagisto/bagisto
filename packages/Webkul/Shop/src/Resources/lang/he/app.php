...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'רק :qty כרטיסים זמינים לאירוע זה.',
                        'sold-out' => 'הכרטיסים לאירוע זה אזלו.',
                        'ticket-exceeds-available' => 'רק :qty כרטיסי ":ticket" זמינים.',
                        'ticket-sold-out' => 'כרטיסי ":ticket" אזלו.',
                    ],

                    'missing-options' => 'אפשרויות חסרות עבור מוצר זה.',
                    'inventory-warning' => 'הכמות המבוקשת אינה זמינה, אנא נסה שוב מאוחר יותר.',
                    'rental-unavailable' => 'מוצר השכרה זה אינו זמין לתאריכים שנבחרו.',
                    'select-hourly-duration' => 'בחר משך זמן של שעה אחת לפחות.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            'withdraw' => 'ביטול חוזה',
            'view-existing' => 'הצגת בקשת הביטול שלך',
        ],
        ...
        'lookup' => [
            ...
            'sent-notice' => 'אם קיימת הזמנה תואמת, שלחנו זה עתה את קישור הביטול לכתובת הדוא"ל. הקישור יהיה תקף למשך 24 שעות.',
            'legal-note' => 'בהתאם לדירקטיבה האירופית 2011/83/EU (כפי שתוקנה), יש לך זכות סטטוטורית לבטל את החוזה תוך 14 ימים. דרכי ביטול נוספות — לרבות הצהרה בכתב אל שירות הלקוחות שלנו — נותרות בתוקף.',
        ],

        'form' => [
            'page-title' => 'אישור בקשת הביטול שלך',
            'heading' => 'אישור ביטול החוזה',
            'legal-notice-title' => 'זוהי הצהרה מחייבת מבחינה משפטית',
            'legal-effect' => 'בהגשת טופס זה אתה מממש את זכותך הסטטוטורית לבטל את הזמנה ‎#:order_id. ההצהרה תופסת תוקף משפטי ברגע ההגשה.',
            'order-summary' => 'הזמנה',
            'order-total' => 'סך הכל',
            'order-items' => 'פריטים',
            'placed-on' => 'בוצעה בתאריך :date',
            'reason-label' => 'סיבה',
            'reason-optional' => '(לא חובה)',
            'reason-help' => 'אינך מחויב למסור סיבה. כל מה שתכתוב כאן יתועד ברישומי הביטול ויישלח לסוחר.',
            'reason-placeholder' => 'לדוגמה: "שיניתי את דעתי", "הפריט אינו תואם לתיאור", או השאר ריק.',
            'submit' => 'הגשת הביטול',
            'cancel' => 'ביטול וחזרה',
        ],

        'confirmation' => [
            'page-title' => 'אישור ביטול',
            'heading' => 'בקשת הביטול שלך התקבלה',
            'heading-received' => 'בקשת הביטול שלך התקבלה',
            'heading-refunded' => 'ההחזר הכספי שלך בוצע',
            'heading-declined' => 'בקשת הביטול שלך נדחתה',
            'intro' => 'תיעדנו את הצהרתך. עמוד זה ודוא"ל האישור ששלחנו לך זה עתה משמשים שניהם כאישור על גבי אמצעי קבוע.',
            'intro-received' => 'תיעדנו את הצהרתך. עמוד זה ודוא"ל האישור ששלחנו לך זה עתה משמשים שניהם כאישור על גבי אמצעי קבוע.',
            'intro-refunded' => 'הסוחר עיבד את ההחזר הכספי שלך. ההחזר אמור להגיע בקרוב לאמצעי התשלום המקורי שלך.',
            'intro-declined' => 'הסוחר חולק על זכאותך להחזר כספי על פי הצהרה זו. עיין בפרטים שלהלן לקבלת הסיבה שניתנה ולאפשרויות הנותרות לך.',
            'received-at' => 'מועד קבלה',
            'reference' => 'מספר אסמכתא',
            'copy-reference' => 'העתקת מספר אסמכתא',
            'reference-copied' => 'מספר האסמכתא הועתק ללוח.',
            'order' => 'הזמנה',
            'email' => 'דוא"ל',
            'reason' => 'סיבה',
            'status' => 'סטטוס',
            ...
            'print' => 'הדפסה',
            'next-steps-title' => 'מה קורה בהמשך',
            'step-received' => 'הצהרתך התקבלה ותועדה.',
            'step-email' => 'דוא"ל אישור נשלח לתיבת הדואר שלך.',
            'step-refund' => 'ההחזר הכספי יבוצע תוך 14 ימים.',
            'step-refund-done' => 'ההחזר הכספי בוצע.',
            'step-declined' => 'בקשת הביטול נדחתה על ידי הסוחר.',
            'declined-reason-label' => 'הסיבה שניתנה על ידי הסוחר',
            'declined-notice' => 'יתר התרופות המשפטיות העומדות לרשותך לפי דיני הגנת הצרכן באיחוד האירופי שמורות לך. אם אינך מסכים עם החלטה זו, פנה ישירות לסוחר.',
            'refund-notice' => 'ההחזר יבוצע באותו אמצעי תשלום שבו השתמשת בעסקה המקורית, אלא אם הסכמת במפורש אחרת.',
            'email-sent' => 'דוא"ל האישור נשלח.',
            'email-pending' => 'לא הצלחנו לשלוח את דוא"ל האישור באופן מיידי; הצוות שלנו יבצע מעקב. אנא שמור עמוד זה כקבלה.',
            'durable-medium-notice' => 'עמוד זה הוא הקבלה שלך. ניתן לשמור או להדפיס אותו.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'בקשת ביטול התקבלה',
                'title-refunded' => 'בוצע החזר כספי',
                'title-declined' => 'בקשת הביטול נדחתה',
                'greeting' => 'שלום,',
                'intro' => 'קיבלנו את הצהרתך על ביטול החוזה עבור הזמנה ‎#:order_id. חותמת הזמן של הקבלה התקפה משפטית מתועדת להלן.',
                'intro-received' => 'קיבלנו את הצהרתך על ביטול החוזה עבור הזמנה ‎#:order_id. חותמת הזמן של הקבלה התקפה משפטית מתועדת להלן.',
                'intro-refunded' => 'ההחזר הכספי עבור הזמנה ‎#:order_id בוצע. ההחזר אמור להגיע בקרוב לאמצעי התשלום המקורי שלך.',
                'intro-declined' => 'הסוחר חולק על זכאותך להחזר כספי עבור הזמנה ‎#:order_id על פי הצהרה זו. הסיבה שניתנה מופיעה להלן.',
                ...
                'email' => 'דוא"ל',
                'reason' => 'סיבה שניתנה',
                'declined-reason' => 'סיבת הדחייה',
                'refund-notice' => 'במקרים שבהם מגיע החזר, אנו מבצעים אותו באותו אמצעי תשלום שבו השתמשת בעסקה המקורית, תוך 14 ימים מהתאריך המצוין לעיל, אלא אם הסכמת במפורש אחרת.',
