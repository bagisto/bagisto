...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'এই ইভেন্টের জন্য মাত্র :qty টিকেট উপলব্ধ।',
                        'sold-out' => 'এই ইভেন্টের টিকেট বিক্রি শেষ হয়ে গেছে।',
                        'ticket-exceeds-available' => 'শুধুমাত্র :qty ":ticket" টিকেট উপলব্ধ।',
                        'ticket-sold-out' => '":ticket" টিকেট বিক্রি শেষ।',
                    ],

                    'missing-options' => 'এই পণ্যের জন্য বিকল্পগুলি অনুপস্থিত।',
                    'inventory-warning' => 'অনুরোধকৃত পরিমাণ উপলব্ধ নেই, দয়া করে পরে আবার চেষ্টা করুন।',
                    'rental-unavailable' => 'এই ভাড়া পণ্যটি নির্বাচিত তারিখগুলির জন্য উপলব্ধ নেই।',
                    'select-hourly-duration' => 'কমপক্ষে এক ঘণ্টার সময়কাল নির্বাচন করুন।',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'আপনার প্রত্যাহার দেখুন',
        ],
        ...
        'lookup' => [
            'page-title' => 'চুক্তি থেকে প্রত্যাহার',
            ...
            'sent-notice' => 'যদি কোনো মিল থাকা অর্ডার বিদ্যমান থাকে, আমরা সেই ঠিকানায় একটি প্রত্যাহার লিঙ্ক ইমেল করেছি। এটি ২৪ ঘণ্টার জন্য বৈধ থাকবে।',
            'legal-note' => 'EU Directive 2011/83/EU (সংশোধিত) অনুযায়ী আপনার ১৪ দিনের মধ্যে চুক্তি থেকে প্রত্যাহারের আইনি অধিকার রয়েছে। প্রত্যাহারের অন্যান্য মাধ্যম — আমাদের গ্রাহক সেবায় লিখিত বিবৃতি প্রেরণ সহ — বৈধ থাকবে।',
        ],

        'form' => [
            'page-title' => 'আপনার প্রত্যাহার নিশ্চিত করুন',
            'heading' => 'চুক্তি থেকে প্রত্যাহার নিশ্চিত করুন',
            'legal-notice-title' => 'এটি একটি আইনত বাধ্যতামূলক ঘোষণা',
            'legal-effect' => 'এই ফর্ম জমা দিয়ে আপনি অর্ডার #:order_id এর জন্য আপনার আইনি প্রত্যাহারের অধিকার প্রয়োগ করছেন। জমা দেওয়ার মুহূর্ত থেকে ঘোষণাটি আইনত কার্যকর হবে।',
            'order-summary' => 'অর্ডার',
            'order-total' => 'মোট',
            'order-items' => 'আইটেম',
            'placed-on' => ':date তারিখে স্থাপিত',
            'reason-label' => 'কারণ',
            'reason-optional' => '(ঐচ্ছিক)',
            'reason-help' => 'কারণ দেওয়া বাধ্যতামূলক নয়। আপনি এখানে যা লিখবেন তা প্রত্যাহার প্রমাণে রেকর্ড করা হবে এবং বিক্রেতার কাছে পাঠানো হবে।',
            'reason-placeholder' => 'উদাহরণ: "মন পরিবর্তন করেছি", "আইটেম বর্ণনার মতো নয়", অথবা ফাঁকা রাখুন।',
            'submit' => 'প্রত্যাহার জমা দিন',
            'cancel' => 'বাতিল করে ফিরে যান',
        ],

        'confirmation' => [
            'page-title' => 'প্রত্যাহার রসিদ',
            'heading' => 'আপনার প্রত্যাহার গৃহীত হয়েছে',
            'heading-received' => 'আপনার প্রত্যাহার গৃহীত হয়েছে',
            'heading-refunded' => 'আপনার ফেরত জারি করা হয়েছে',
            'heading-declined' => 'আপনার প্রত্যাহার প্রত্যাখ্যাত হয়েছে',
            ...
            'intro-received' => 'আমরা আপনার ঘোষণা রেকর্ড করেছি। এই পৃষ্ঠা এবং আমরা যে ইমেলটি পাঠিয়েছি উভয়ই স্থায়ী মাধ্যমে নিশ্চিতকরণ হিসেবে কাজ করে।',
            'intro-refunded' => 'বিক্রেতা আপনার ফেরত প্রক্রিয়া করেছেন। প্রতিদান শীঘ্রই আপনার মূল পেমেন্ট পদ্ধতিতে পৌঁছাবে।',
            'intro-declined' => 'এই ঘোষণার অধীনে বিক্রেতা ফেরতের আপনার অধিকার বিতর্কিত করেছেন। প্রদত্ত কারণ এবং আপনার অবশিষ্ট বিকল্পের জন্য নীচের বিবরণ দেখুন।',
            'received-at' => 'গ্রহণের সময়',
            'reference' => 'রেফারেন্স',
            'copy-reference' => 'রেফারেন্স কপি করুন',
            'reference-copied' => 'রেফারেন্স ক্লিপবোর্ডে কপি করা হয়েছে।',
            'order' => 'অর্ডার',
            'email' => 'ইমেল',
            'reason' => 'কারণ',
            'status' => 'অবস্থা',
            ...
            'print' => 'প্রিন্ট',
            'next-steps-title' => 'এর পরে কী হবে',
            'step-received' => 'আপনার ঘোষণা গৃহীত ও রেকর্ড করা হয়েছে।',
            'step-email' => 'আপনার ইনবক্সে নিশ্চিতকরণ ইমেল পাঠানো হয়েছে।',
            'step-refund' => '১৪ দিনের মধ্যে ফেরত জারি করা হবে।',
            'step-refund-done' => 'ফেরত জারি করা হয়েছে।',
            'step-declined' => 'বিক্রেতা দ্বারা প্রত্যাহার প্রত্যাখ্যাত।',
            'declined-reason-label' => 'বিক্রেতা প্রদত্ত কারণ',
            'declined-notice' => 'EU ভোক্তা আইনের অধীনে আপনার অন্যান্য সমস্ত আইনি প্রতিকার বহাল রয়েছে। আপনি এই সিদ্ধান্তের সাথে দ্বিমত হলে, সরাসরি বিক্রেতার সাথে যোগাযোগ করুন।',
            'refund-notice' => 'অন্যথায় স্পষ্টভাবে সম্মত না হলে, আমরা মূল লেনদেনের জন্য আপনি যে পেমেন্ট পদ্ধতি ব্যবহার করেছেন সেই একই পদ্ধতিতে প্রতিদান করি।',
            'email-sent' => 'নিশ্চিতকরণ ইমেল পাঠানো হয়েছে।',
            'email-pending' => 'আমরা এই মুহূর্তে নিশ্চিতকরণ ইমেল পাঠাতে পারিনি; আমাদের দল এটি অনুসরণ করবে। অনুগ্রহ করে এই পৃষ্ঠাটি আপনার রসিদ হিসেবে সংরক্ষণ করুন।',
            'durable-medium-notice' => 'এই পৃষ্ঠাটি আপনার রসিদ। আপনি এটি সংরক্ষণ বা প্রিন্ট করতে পারেন।',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'প্রত্যাহার গৃহীত',
                'title-refunded' => 'ফেরত জারি করা হয়েছে',
                'title-declined' => 'প্রত্যাহার প্রত্যাখ্যাত',
                'greeting' => 'নমস্কার,',
                ...
                'intro-received' => 'আমরা অর্ডার #:order_id এর চুক্তি থেকে আপনার প্রত্যাহার ঘোষণা পেয়েছি। আইনত কার্যকর গ্রহণের সময় নীচে রেকর্ড করা হয়েছে।',
                'intro-refunded' => 'অর্ডার #:order_id এর জন্য আপনার ফেরত জারি করা হয়েছে। প্রতিদান শীঘ্রই আপনার মূল পেমেন্ট পদ্ধতিতে পৌঁছাবে।',
                'intro-declined' => 'এই ঘোষণার অধীনে অর্ডার #:order_id এর জন্য ফেরতের আপনার অধিকার বিক্রেতা বিতর্কিত করেছেন। প্রদত্ত কারণ নীচে রয়েছে।',
                ...
                'email' => 'ইমেল',
                'reason' => 'প্রদত্ত কারণ',
                'declined-reason' => 'প্রত্যাখ্যানের কারণ',
                'refund-notice' => 'যেখানে ফেরত প্রাপ্য, আমরা উপরের তারিখ থেকে ১৪ দিনের মধ্যে আপনি মূল লেনদেনের জন্য ব্যবহৃত একই পেমেন্ট পদ্ধতিতে প্রতিদান করি, অন্যথায় স্পষ্টভাবে সম্মত না হলে।',
