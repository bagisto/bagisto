        ...
        'account' => [
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'information' => [
                        'discount'                   => 'ডিসকাউন্ট',
                        'excl-tax'                   => 'ট্যাক্স ছাড়াই:',
                        'grand-total'                => 'সর্বমোট',
                        'info'                       => 'তথ্য',
                        'item-canceled'              => 'বাতিল করা হয়েছে (:qty_canceled)',
                        'item-invoice'               => 'চালান করা হয়েছে (:qty_invoiced)',
                        'item-ordered'               => 'অর্ডার করা হয়েছে (:qty_ordered)',
                        'item-refunded'              => 'ফেরত দেওয়া হয়েছে (:qty_refunded)',
                        'item-shipped'               => 'প্রেরণ করা হয়েছে (:qty_shipped)',
                        'item-status'                => 'আইটেমের অবস্থা',
                        'placed-on'                  => 'অর্ডার দেওয়া হয়েছে',
                        'price'                      => 'মূল্য',
                        'product-name'               => 'নাম',
                        'shipping-handling'          => 'শিপিং এবং হ্যান্ডলিং',
                        'shipping-handling-excl-tax' => 'শিপিং এবং হ্যান্ডলিং (ট্যাক্স ছাড়াই)',
                        'shipping-handling-incl-tax' => 'শিপিং এবং হ্যান্ডলিং (ট্যাক্স সহ)',
                        'sku'                        => 'এসকেইউ',
                        'subtotal'                   => 'উপমোট',
                        'subtotal-excl-tax'          => 'উপমোট (ট্যাক্স ছাড়াই)',
                        'subtotal-incl-tax'          => 'উপমোট (ট্যাক্স সহ)',
                        'tax'                        => 'ট্যাক্স',
