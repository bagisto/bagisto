...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'reminder' => [
                'already-paid'    => 'আপনি যদি ইতিমধ্যে অর্থ প্রদান করে থাকেন, তাহলে এই ইমেইলটি উপেক্ষা করুন।',
                'invoice-overdue' => 'আপনার চালান :invoice :time দ্বারা বিলম্বিত হয়েছে।',
                'make-payment'    => 'দয়া করে যত তাড়াতাড়ি সম্ভব আপনার অর্থ প্রদান করুন।',
