    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'payment' => [
                ...
                'Paytm' => [
                    'redirecting' => 'কয়েক সেকেন্ডের মধ্যে আপনাকে Paytm-এ পুনঃনির্দেশিত করা হবে।',
                    'cart-empty' => 'আপনার কার্ট খালি।',
                    'general-error' => 'কিছু ভুল হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।',
                    'missing-cart-id' => 'কার্ট আইডি অনুপস্থিত।',
                    'cart-not-found' => 'কার্ট পাওয়া যায়নি।',
                    'checksum-failed' => 'Checksum যাচাইকরণ ব্যর্থ হয়েছে।',
                    'payment-failed' => 'Paytm পেমেন্ট ব্যর্থ হয়েছে বা বাতিল হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।',
                ],
            ],
