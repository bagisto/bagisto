...
return [
    ...
    'home' => [
        ...
        'index' => [
            ...
            'hero-highlight'            => 'Best Deals',
            'hero-subtitle'             => 'Your online store in the RAM ecosystem',
            'hero-title'                => 'Discover the :highlight',
            'image-carousel'            => 'Image Carousel',
            'offer'                     => 'Get UPTO 40% OFF on your 1st order SHOP NOW',
            'product-carousel'          => 'Product Carousel',
            'promo-banner-subtitle'     => 'Discover exclusive products at the best prices',
            'promo-banner-title'        => 'Special Offers',
            'promo-gifts'               => 'Surprise Gifts',
            'promo-offers'              => 'Exclusive Offers',
            'promo-payments'            => 'Secure Payments',
            'promo-quality'             => 'Guaranteed Quality',
            'promo-shipping'            => 'Nationwide Shipping',
            'resend-verify-email'       => 'Resend Verification Email',
            'slide-categories-cta'      => 'Explore',
            'slide-categories-subtitle' => 'Find everything you need',
            'slide-categories-title'    => 'Categories',
            'slide-offers-cta'          => 'View Offers',
            'slide-offers-subtitle'     => 'Best prices on the market',
            'slide-offers-title'        => 'Incredible Offers',
