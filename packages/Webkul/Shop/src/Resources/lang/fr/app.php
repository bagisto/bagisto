...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'Seulement :qty billets sont disponibles pour cet événement.',
                        'sold-out' => 'Les billets pour cet événement sont épuisés.',
                        'ticket-exceeds-available' => 'Seulement :qty billets ":ticket" sont disponibles.',
                        'ticket-sold-out' => 'Les billets ":ticket" sont épuisés.',
                    ],
                    ...
                    'rental-unavailable' => 'Ce produit de location n\'est pas disponible pour les dates sélectionnées.',
                    'select-hourly-duration' => 'Sélectionnez une durée de créneau d\'une heure.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'Voir votre rétractation',
        ],
        ...
        'lookup' => [
            'page-title' => 'Se rétracter d’un contrat',
            ...
            'sent-notice' => 'Si une commande correspondante existe, nous venons d’envoyer par e-mail un lien de rétractation à cette adresse. Il sera valable pendant 24 heures.',
            'legal-note' => 'Vous disposez du droit légal, en vertu de la directive 2011/83/UE (telle que modifiée), de vous rétracter de votre contrat dans un délai de 14 jours. D’autres moyens de rétractation — y compris une déclaration écrite adressée à notre service client — restent valables.',
        ],

        'form' => [
            'page-title' => 'Confirmez votre rétractation',
            'heading' => 'Confirmer la rétractation du contrat',
            'legal-notice-title' => 'Il s’agit d’une déclaration juridiquement contraignante',
            'legal-effect' => 'En soumettant ce formulaire, vous exercez votre droit légal de rétractation pour la commande n° :order_id. La déclaration produit ses effets juridiques au moment de son envoi.',
            'order-summary' => 'Commande',
            'order-total' => 'Total',
            'order-items' => 'Articles',
            'placed-on' => 'Passée le :date',
            'reason-label' => 'Motif',
            'reason-optional' => '(facultatif)',
            'reason-help' => 'Vous n’êtes pas tenu d’indiquer un motif. Tout ce que vous écrirez ici sera consigné dans la preuve de rétractation et transmis au commerçant.',
            'reason-placeholder' => 'Par exemple : « J’ai changé d’avis », « Article non conforme à la description », ou laissez vide.',
            'submit' => 'Envoyer la rétractation',
            'cancel' => 'Annuler et revenir',
        ],

        'confirmation' => [
            'page-title' => 'Justificatif de rétractation',
            'heading' => 'Votre rétractation a été reçue',
            'heading-received' => 'Votre rétractation a été reçue',
            'heading-refunded' => 'Votre remboursement a été effectué',
            'heading-declined' => 'Votre rétractation a été refusée',
            ...
            'intro-received' => 'Nous avons enregistré votre déclaration. Cette page et l’e-mail que nous venons de vous envoyer servent tous deux de confirmation sur un support durable.',
            'intro-refunded' => 'Le commerçant a traité votre remboursement. Le montant devrait arriver prochainement sur votre moyen de paiement initial.',
            'intro-declined' => 'Le commerçant a contesté votre droit à un remboursement au titre de cette déclaration. Consultez ci-dessous le motif indiqué et vos recours possibles.',
            ...
            'print' => 'Imprimer',
            'next-steps-title' => 'Et maintenant ?',
            'step-received' => 'Votre déclaration a été reçue et enregistrée.',
            'step-email' => 'E-mail de confirmation envoyé dans votre boîte de réception.',
            'step-refund' => 'Remboursement effectué dans un délai de 14 jours.',
            'step-refund-done' => 'Le remboursement a été effectué.',
            'step-declined' => 'Rétractation refusée par le commerçant.',
            'declined-reason-label' => 'Motif indiqué par le commerçant',
            'declined-notice' => 'Vous conservez tous les autres recours légaux prévus par le droit de la consommation de l’UE. Si vous n’êtes pas d’accord avec cette décision, contactez directement le commerçant.',
            'refund-notice' => 'Nous procédons au remboursement en utilisant le même moyen de paiement que celui utilisé pour la transaction initiale, sauf accord exprès contraire de votre part.',
            'email-sent' => 'L’e-mail de confirmation a été envoyé.',
            'email-pending' => 'Nous n’avons pas pu envoyer l’e-mail de confirmation immédiatement ; notre équipe assurera le suivi. Veuillez conserver cette page comme justificatif.',
            'durable-medium-notice' => 'Cette page constitue votre justificatif. Vous pouvez la sauvegarder ou l’imprimer.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'Rétractation reçue',
                'title-refunded' => 'Remboursement effectué',
                'title-declined' => 'Rétractation refusée',
                'greeting' => 'Bonjour,',
                ...
                'intro-received' => 'Nous avons reçu votre déclaration de rétractation du contrat pour la commande n° :order_id. L’horodatage de réception, juridiquement opposable, est consigné ci-dessous.',
                'intro-refunded' => 'Votre remboursement pour la commande n° :order_id a été effectué. Le montant devrait arriver prochainement sur votre moyen de paiement initial.',
                'intro-declined' => 'Le commerçant a contesté votre droit à un remboursement pour la commande n° :order_id au titre de cette déclaration. Le motif indiqué figure ci-dessous.',
                ...
                'declined-reason' => 'Motif du refus',
                'refund-notice' => 'Lorsqu’un remboursement est dû, nous l’effectuons en utilisant le même moyen de paiement que celui utilisé pour la transaction initiale, dans un délai de 14 jours à compter de la date ci-dessus, sauf accord exprès contraire de votre part.',
