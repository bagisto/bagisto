    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'payment' => [
                ...
                'Paytm' => [
                    'redirecting' => 'Через несколько секунд вы будете перенаправлены на Paytm.',
                    'cart-empty' => 'Ваша корзина пуста.',
                    'general-error' => 'Что-то пошло не так. Пожалуйста, попробуйте снова.',
                    'missing-cart-id' => 'Отсутствует идентификатор корзины.',
                    'cart-not-found' => 'Корзина не найдена.',
                    'checksum-failed' => 'Проверка контрольной суммы не удалась.',
                    'payment-failed' => 'Платеж Paytm не выполнен или отменен. Пожалуйста, попробуйте снова.',
                ],
            ],
