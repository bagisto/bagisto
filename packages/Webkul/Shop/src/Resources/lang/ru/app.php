...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'invoice-reminder' => [
                'disregard-this-email' => 'Если вы уже заплатили, просто проигнорируйте это письмо.',
                'please-make-payment'  => 'Пожалуйста, совершите оплату как можно скорее.',
                'thanks'               => 'Спасибо!',
                'overdue-invoice'      => 'Ваш счёт :invoice просрочен на :time.',
            ],
