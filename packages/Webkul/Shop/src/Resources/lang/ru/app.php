    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'webmcp' => [
                ...
                'view-category' => 'Откройте страницу категории, чтобы просмотреть её товары по названию категории.',
                'view-category-query' => 'Название или слаг категории для открытия.',
