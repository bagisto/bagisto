...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'reminder' => [
                'already-paid'    => 'Если вы уже оплатили, просто проигнорируйте это письмо.',
                'invoice-overdue' => 'Ваш счет :invoice просрочен на :time.',
                'make-payment'    => 'Пожалуйста, произведите оплату как можно скорее.',
