...
return [
            ...
            'cart' => [
                ...
                'integrity' => [
                    'event' => [
                        ...
                        'exceeds-available' => 'මෙම උත්සවය සඳහා :qty ටිකට්පත් පමණක් තිබේ.',
                        'sold-out' => 'මෙම උත්සවය සඳහා ටිකට්පත් අලෙවි අවසන්.',
                        'ticket-exceeds-available' => '":ticket" ටිකට්පත් :qty ක් පමණක් තිබේ.',
                        'ticket-sold-out' => '":ticket" ටිකට්පත් අලෙවි අවසන්.',
                    ],

                    'missing-options' => 'මෙම නිෂ්පාදනය සඳහා විකල්ප අතුරුදහන් වී ඇත.',
                    'inventory-warning' => 'අයදුම් කළ ප්‍රමාණය ලබාගත නොහැක, කරුණාකර පසුව නැවත උත්සාහ කරන්න.',
                    'rental-unavailable' => 'මෙම කුලී නිෂ්පාදනය තෝරාගත් දිනයන් සඳහා නොමැත.',
                    'select-hourly-duration' => 'අවම වශයෙන් පැයක කාල සීමාවක් තෝරන්න.',
                ],
    ...
    'eu-withdrawal' => [
        'button' => [
            ...
            'view-existing' => 'ඔබේ ඉවත් වීම බලන්න',
        ],
        ...
        'lookup' => [
            'page-title' => 'ගිවිසුමෙන් ඉවත් වන්න',
            ...
            'order-number' => 'ඇණවුම් අංකය',
            'email' => 'ඊමේල් ලිපිනය',
            'submit' => 'මට ඉවත් වීමේ සබැඳිය එවන්න',
            'sent-notice' => 'ගැළපෙන ඇණවුමක් පවතී නම්, අපි දැන් එම ලිපිනයට ඉවත් වීමේ සබැඳියක් ඊමේල් කර ඇත. එය පැය 24ක් සඳහා වලංගු වේ.',
            'legal-note' => 'EU Directive 2011/83/EU (සංශෝධිත) යටතේ ඔබට දින 14ක් ඇතුළත ඔබේ ගිවිසුමෙන් ඉවත් වීමට ව්‍යවස්ථාපිත අයිතිය ඇත. අපගේ පාරිභෝගික සේවාවට යවන ලිඛිත ප්‍රකාශය ඇතුළු ඉවත් වීමේ වෙනත් මාර්ග ද වලංගුව පවතී.',
        ],

        'form' => [
            'page-title' => 'ඔබේ ඉවත් වීම තහවුරු කරන්න',
            'heading' => 'ගිවිසුමෙන් ඉවත් වීම තහවුරු කරන්න',
            'legal-notice-title' => 'මෙය නීත්‍යනුකූලව බැඳී සිටින ප්‍රකාශයකි',
            'legal-effect' => 'මෙම පෝරමය ඉදිරිපත් කිරීමෙන් ඔබ ඇණවුම #:order_id සඳහා ඔබේ ව්‍යවස්ථාපිත ඉවත් වීමේ අයිතිය ක්‍රියාත්මක කරයි. ඔබ එය ඉදිරිපත් කරන මොහොතේ ප්‍රකාශය නීත්‍යනුකූලව ක්‍රියාත්මක වේ.',
            'order-summary' => 'ඇණවුම',
            'order-total' => 'එකතුව',
            'order-items' => 'අයිතම',
            'placed-on' => ':date දින තබන ලදී',
            'reason-label' => 'හේතුව',
            'reason-optional' => '(විකල්ප)',
            'reason-help' => 'හේතුවක් ලබා දීම අවශ්‍ය නොවේ. ඔබ මෙහි ලියන ඕනෑම දෙයක් ඉවත් වීමේ සාක්ෂි මත වාර්තා වී වෙළෙන්දාට යවනු ලැබේ.',
            'reason-placeholder' => 'උදාහරණයක්: "මගේ අදහස වෙනස් කළා", "අයිතමය විස්තරයේ ආකාරයට නැත", හෝ හිස්ව තබන්න.',
            'submit' => 'ඉවත් වීම ඉදිරිපත් කරන්න',
            'cancel' => 'අවලංගු කර ආපසු යන්න',
        ],

        'confirmation' => [
            'page-title' => 'ඉවත් වීමේ රිසිට්පත',
            'heading' => 'ඔබේ ඉවත් වීම ලැබී ඇත',
            'heading-received' => 'ඔබේ ඉවත් වීම ලැබී ඇත',
            'heading-refunded' => 'ඔබේ ආපසු ගෙවීම නිකුත් කර ඇත',
            'heading-declined' => 'ඔබේ ඉවත් වීම ප්‍රතික්ෂේප කර ඇත',
            'intro' => 'අපි ඔබේ ප්‍රකාශය වාර්තා කර ඇත. මෙම පිටුව සහ අපි ඔබට යැවූ ඊමේල් යන දෙකම කල් පවතින මාධ්‍යයක තහවුරුව ලෙස ක්‍රියා කරයි.',
            'intro-received' => 'අපි ඔබේ ප්‍රකාශය වාර්තා කර ඇත. මෙම පිටුව සහ අපි ඔබට යැවූ ඊමේල් යන දෙකම කල් පවතින මාධ්‍යයක තහවුරුව ලෙස ක්‍රියා කරයි.',
            'intro-refunded' => 'වෙළෙන්දා ඔබේ ආපසු ගෙවීම සකස් කර ඇත. ප්‍රතිපූරණය ඉක්මනින් ඔබේ මුල් ගෙවීමේ ක්‍රමයට ලැබෙනු ඇත.',
            'intro-declined' => 'වෙළෙන්දා මෙම ප්‍රකාශය යටතේ ආපසු ගෙවීමක් ලැබීමේ ඔබේ අයිතියට විරෝධය පළ කර ඇත. දුන් හේතුව සහ ඔබට ඉතිරිව ඇති විකල්ප සඳහා පහත විස්තර බලන්න.',
            'received-at' => 'ලැබුණු වේලාව',
            'reference' => 'යොමුව',
            'copy-reference' => 'යොමුව පිටපත් කරන්න',
            'reference-copied' => 'යොමුව පසුරු පුවරුවට පිටපත් කරන ලදී.',
            'order' => 'ඇණවුම',
            'email' => 'ඊමේල්',
            'reason' => 'හේතුව',
            'status' => 'තත්ත්වය',
            'status-received' => 'ලැබුණා',
            'status-refunded' => 'ආපසු ගෙවා ඇත',
            'status-declined' => 'ප්‍රතික්ෂේපිතයි',
            'print' => 'මුද්‍රණය කරන්න',
            'next-steps-title' => 'ඊළඟට කුමක්ද',
            'step-received' => 'ඔබේ ප්‍රකාශය ලැබී වාර්තා කර ඇත.',
            'step-email' => 'ඔබේ එන ලිපි කුටියට තහවුරු ඊමේල් යවන ලදී.',
            'step-refund' => 'දින 14ක් ඇතුළත ආපසු ගෙවීම නිකුත් කෙරේ.',
            'step-refund-done' => 'ආපසු ගෙවීම නිකුත් කර ඇත.',
            'step-declined' => 'වෙළෙන්දා විසින් ඉවත් වීම ප්‍රතික්ෂේප කරන ලදී.',
            'declined-reason-label' => 'වෙළෙන්දා දුන් හේතුව',
            'declined-notice' => 'EU පාරිභෝගික නීතිය යටතේ ඔබට අන් සියලු නීතිමය පිළිසරණ රඳවා ගත හැකිය. ඔබ මෙම තීරණය සමඟ එකඟ නොවන්නේ නම්, කෙලින්ම වෙළෙන්දා හා සම්බන්ධ වන්න.',
            'refund-notice' => 'ඔබ පැහැදිලිව වෙනත් අන්දමින් එකඟ වී නොමැති නම්, මුල් ගනුදෙනුවට ඔබ භාවිතා කළ එම ගෙවීමේ ක්‍රමයම භාවිතා කරමින් අපි ප්‍රතිපූරණය කරමු.',
            'email-sent' => 'තහවුරු ඊමේල් යවා ඇත.',
            'email-pending' => 'අපට වහාම තහවුරු ඊමේල් යැවීමට නොහැකි විය; අපගේ කණ්ඩායම ඉදිරියට යයි. කරුණාකර මෙම පිටුව ඔබේ රිසිට්පත ලෙස සුරකින්න.',
            'durable-medium-notice' => 'මෙම පිටුව ඔබේ රිසිට්පතයි. ඔබට එය සුරකින්න හෝ මුද්‍රණය කළ හැකිය.',
        ],
        ...
        'emails' => [
            'confirmation' => [
                ...
                'title-received' => 'ඉවත් වීම ලැබුණා',
                'title-refunded' => 'ආපසු ගෙවීම නිකුත් කරන ලදී',
                'title-declined' => 'ඉවත් වීම ප්‍රතික්ෂේප කරන ලදී',
                'greeting' => 'ආයුබෝවන්,',
                ...
                'intro-received' => 'ඇණවුම #:order_id සඳහා ගිවිසුමෙන් ඉවත් වීමේ ඔබේ ප්‍රකාශය අපට ලැබී ඇත. නීත්‍යනුකූලව ක්‍රියාත්මක වන ලැබීමේ වේලා මුද්‍රාව පහත වාර්තා කර ඇත.',
                'intro-refunded' => 'ඇණවුම #:order_id සඳහා ඔබේ ආපසු ගෙවීම නිකුත් කර ඇත. ප්‍රතිපූරණය ඉක්මනින් ඔබේ මුල් ගෙවීමේ ක්‍රමයට ලැබෙනු ඇත.',
                'intro-declined' => 'වෙළෙන්දා මෙම ප්‍රකාශය යටතේ ඇණවුම #:order_id සඳහා ආපසු ගෙවීමක් ලැබීමේ ඔබේ අයිතියට විරෝධය පළ කර ඇත. දුන් හේතුව පහත දැක්වේ.',
                ...
                'email' => 'ඊමේල්',
                'reason' => 'දුන් හේතුව',
                'declined-reason' => 'ප්‍රතික්ෂේපය සඳහා හේතුව',
                'refund-notice' => 'ආපසු ගෙවීමක් ගෙවිය යුතු තැන, ඔබ පැහැදිලිව වෙනත් අන්දමින් එකඟ වී නොමැති නම්, ඉහත දින සිට දින 14ක් ඇතුළත මුල් ගනුදෙනුවට ඔබ භාවිතා කළ එම ගෙවීමේ ක්‍රමයම භාවිතා කරමින් අපි ප්‍රතිපූරණය කරමු.',
