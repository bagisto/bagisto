...
return [
        ...
        'layouts' => [
            'header' => [
                ...
                'mobile' => [
                    'currencies' => 'මුදල්',
                    'locales'    => 'පිටු මාධ්‍ය',
                    'login'      => 'ලියාපදිංචි වීම හෝ පිවිසීම',
                ],
            ],
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'reminder' => [
                'already-paid'    => 'ඔබ දැනටමත් ගෙවා ඇත්නම්, කරුණාකර මෙම ඊමේල් නොසලකා හරින්න.',
                'invoice-overdue' => 'ඔබගේ ඉන්වොයිසිය :invoice :time කාලය පුරා ගෙවීම් නොකළේය.',
                'make-payment'    => 'කරුණාකර ඔබගේ ගෙවීම ඉක්මනින් සිදු කරන්න.',
