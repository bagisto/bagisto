...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Derechos de autor 2010 - :currentYear, Webkul Software (Registrado en India). Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer'           => '© Derechos de autor 2010 - :currentYear, Webkul Software (Registrada en India). Todos los derechos reservados.',
            'password'         => 'Contraseña',
        ...
        'account' => [
            ...
            'addresses' => [
                ...
                'default-delete'   => 'La dirección predeterminada no puede ser cambiada.',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'minimum-order-message'     => 'El monto mínimo de la orden es :amount',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'same-billing-address' => 'La dirección es la misma que la de facturación',
                    'street-address'       => 'Dirección',
                    'state'                => 'Estado',
