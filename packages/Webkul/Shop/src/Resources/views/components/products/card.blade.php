...
@pushOnce('scripts')
    ...
    >
        <!-- Grid Card -->
        <div
            class="1180:transtion-all w-full 1180:relative 1180:grid 1180:content-start 1180:overflow-hidden 1180:duration-300"
            v-if="mode != 'list'"
        >
            <div class="relative overflow-hidden border border-[#D7D7D7] rounded-[4px]">
...
{{--                </div>--}}
            ...
            <div class="product-info flex mt-4">
                <div class="grid gap-2 pr-5">
                    {!! view_render_event('bagisto.shop.components.products.card.name.before') !!}
                    <p class="break-all text-[16px] text-heading leading-[24px] font-semibold max-md:mb-1.5 max-md:max-w-56 max-md:whitespace-break-spaces max-md:leading-6 max-sm:max-w-[192px] max-sm:text-sm">
                    ...
                    <div
                        class="flex items-center gap-2.5 text-[16px] font-semibold max-sm:text-sm max-sm:leading-6"
                ...
                <div class="button-action mt-1">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        ...
                        <button
                            class="rounded-full border border-line w-10 h-10 flex items-center justify-center"
                            :disabled="! product.is_saleable || isAddingToCart"
                            @click="addToCart()"
                        >
{{--                            @lang('shop::app.components.products.card.add-to-cart')--}}
                            <span class="icon-cart text-2xl -mt-[2px]"></span>
                        </button>
