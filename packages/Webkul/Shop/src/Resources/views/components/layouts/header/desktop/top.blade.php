<div class="flex justify-between items-center w-full py-[11px] px-16 border border-t-0 border-b border-l-0 border-r-0">
    <!-- Currency Switcher -->
    <x-shop::dropdown>
        <!-- Dropdown Toggler -->
        <x-slot:toggle>
...
@pushOnce('scripts')
    ...
    <script type="text/x-template" id="v-locale-switcher-template">
        <div class="grid gap-1 mt-2.5 pb-2.5">
            <span
                class="flex items-center gap-2.5 px-5 py-2 text-[16px] cursor-pointer hover:bg-gray-100"
