...
<header class="shadow-gray sticky top-0 z-10 bg-white dark:bg-ram-card/70 dark:backdrop-blur-xl dark:border-b dark:border-ram-border shadow-sm max-lg:shadow-none">
    <v-header-switcher>
