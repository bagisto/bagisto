            ...
            <div class="grid gap-[10px]">
                ...
                >
                    ...
                    <x-shop::form.control-group.control
                        ...
                        class="bg-[#F1EADF] w-[420px] max-w-full placeholder:text-gray[900] border-[2px] border-[#E9DECC] rounded-[12px] block px-[20px] py-[20px] text-gray-900 text-xs font-medium pr-[110px] max-1060:w-full"
