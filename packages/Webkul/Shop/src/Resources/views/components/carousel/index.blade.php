...
@pushOnce('scripts')
    <script type="text/x-template" id="v-carousel-template">
        <div class="w-full relative m-auto">
            ...
            <span
                class="icon-arrow-left text-[24px] font-bold text-white w-auto -mt-[22px] p-3 absolute top-1/2 left-2.5 bg-[rgba(0,0,0,0.8)] transition-all opacity-30 rounded-full hover:opacity-100 cursor-pointer"
                role="button"
            ...
            <span
                class="icon-arrow-right text-[24px] font-bold text-white w-auto -mt-[22px] p-3 absolute top-1/2 right-2.5 bg-[rgba(0,0,0,0.8)] transition-all opacity-30 rounded-full hover:opacity-100 cursor-pointer"
                role="button"
