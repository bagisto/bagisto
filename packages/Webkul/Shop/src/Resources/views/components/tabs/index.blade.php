        ...
        <div>
            ...
            >
                <button
                    ...
                    role="tab"
                    v-for="tab in tabs"
                    class="cursor-pointer rounded px-8 py-5 text-xl font-medium text-zinc-600 max-md:px-4 max-md:py-3 max-md:text-sm max-sm:px-2.5 max-sm:py-2.5 focus-visible:ring-2 focus-visible:ring-navyBlue focus-visible:ring-offset-2 focus-visible:outline-hidden"
