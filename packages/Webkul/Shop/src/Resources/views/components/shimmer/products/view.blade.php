    ...
    <div class="flex mt-[48px] gap-[40px] max-1180:flex-wrap max-lg:mt-0 max-sm:gap-y-[25px]">
        ...
        <div class="max-w-[590px] relative max-1180:px-[20px]">
            <div class="flex justify-between gap-[15px]">
                <h1 class="w-[50%] h-[46px] shimmer"></h1>

                <div class="w-[46px] h-[46px] rounded-full shimmer">
                </div>
            </div>
            ...
            <div class="mt-[20px]">
                ...
                <div class="flex items-center space-x-3">
                    <span class="w-[32px] h-[32px] rounded-full shimmer"></span>
                    <span class="w-[32px] h-[32px] rounded-full shimmer"></span>
                    <span class="w-[32px] h-[32px] rounded-full shimmer"></span>
                    <span class="w-[32px] h-[32px] rounded-full shimmer"></span>
                    <span class="w-[32px] h-[32px] rounded-full shimmer"></span>
            ...
            <div class="mt-[20px]">
                ...
                <div class="flex flex-wrap gap-[12px]">
                    <span class="w-[60px] h-[60px] rounded-full shimmer"></span>
                    <span class="w-[60px] h-[60px] rounded-full shimmer"></span>
                    <span class="w-[60px] h-[60px] rounded-full shimmer"></span>
                    <span class="w-[60px] h-[60px] rounded-full shimmer"></span>
                    <span class="w-[60px] h-[60px] rounded-full shimmer"></span>
            ...
            <div class="flex gap-[35px] mt-[40px] items-center max-sm:flex-wrap">
                <div class=" w-[80px] h-[24px] shimmer"></div>

                <div class="flex gap-[25px] max-sm:flex-wrap items-center">
                    <div class="w-[80px] h-[24px] shimmer"></div>
                    
                    <div class="flex gap-[15px]">
                        <span class="w-[40px] h-[40px] rounded-full shimmer"></span>
                        <span class="w-[40px] h-[40px] rounded-full shimmer"></span>
                        <span class="w-[40px] h-[40px] rounded-full shimmer"></span>
                        <span class="w-[40px] h-[40px] rounded-full shimmer"></span>
                    </div>
