...
<div class="flex items-center justify-between gap-[15px] max-sm:flex-wrap">
    <div class="w-[245px] h-[45px] shimmer"></div>

    <div class="w-[187px] h-[46px] rounded-[12px] shimmer"></div>
</div>
    ...
    <div class="flex gap-y-[18px] max-w-[365px] mt-[10px] flex-wrap">
        @for ($i = 5; $i >= 1; $i--)
            <div class="flex gap-x-[25px] items-center max-sm:flex-wrap">
                <div class="w-[55px] h-[24px] shimmer"></div>

                <div class="w-[275px] h-[16px] shimmer rounded-[2px]"></div>
            </div>
        @endfor
    </div>
</div>
