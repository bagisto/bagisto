    ...
    <div>
        <div class="flex flex-wrap gap-[30px] mt-[30px]">
            <div class="relative max-w-[218px] select-none max-sm:max-w-full max-sm:flex-auto ">
                <input type="radio" id="flat-rate-shipping" name="shipping" value="" class="hidden peer">
                <span class="w-[24px] h-[24px] shimmer  rounded-full absolute right-[20px] top-[20px]"></span>
