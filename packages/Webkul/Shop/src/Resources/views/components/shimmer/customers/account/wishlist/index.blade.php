            ...
            <div class="grid gap-y-[25px] flex-1">
                ...
                <div class="flex justify-between gap-x-[10px] pb-[18px] border-b-[1px] border-[#E9E9E9]">
                    <div class="flex gap-x-[20px]">
                        <div class="">
                            <div class="shimmer w-[110px] h-[110px] bg-[#E9E9E9] rounded-[12px]"></div>
                        </div>

                        <div class="grid gap-y-[10px]">
                            <div class="shimmer w-[200px] h-[21px] bg-[#E9E9E9]"></div>
                            <div class="flex gap-x-[10px] gap-y-[6px] flex-wrap">
                                <div class="grid gap-[8px]">
                                </div>
                            </div>

                            <div class="shimmer w-[100px] h-[21px] bg-[#E9E9E9]"></div>
                            
                            <div class="hidden gap-[10px] place-content-start max-sm:grid">
                                <div class="shimmer w-[100px] h-[27px] bg-[#E9E9E9]"></div>

                                <div class="shimmer w-[100px] h-[24px] bg-[#E9E9E9]"></div>
                            </div>

                            <div class="flex gap-[20px] flex-wrap">
                                <div class="shimmer w-[110px] h-[40px] rounded-[54px] bg-[#E9E9E9]"></div>
                                <div class="shimmer w-[158px] h-[40px] rounded-[18px] bg-[#E9E9E9]"></div>
                            </div>
                        </div>
                    </div>
