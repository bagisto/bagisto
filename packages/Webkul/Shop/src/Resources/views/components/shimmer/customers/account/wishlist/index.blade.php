            ...
            <div class="grid flex-1 gap-y-6">
                ...
                <div class="flex justify-between gap-x-2.5 border-b border-zinc-200 pb-5">
                    <div class="flex gap-x-5 max-md:w-full">
                        <div class="">
                            <div class="shimmer h-27.5 w-27.5 rounded-xl max-md:h-20 max-md:w-20"></div>
                        </div>

                        <div class="grid w-full gap-y-2.5 max-md:gap-y-0">
                            <div class="flex justify-between">
                                <div class="shimmer h-6 w-50 max-md:h-5"></div>

                                <div class="shimmer hidden h-6 w-6 max-md:block"></div>
                            </div>


                            <div class="shimmer h-5.25 w-25 max-md:hidden"></div>
                            ...
                            <div class="flex flex-wrap gap-5 max-md:mt-2.5 max-md:flex-nowrap">
                                <div class="shimmer h-10 w-27.5 rounded-[54px] max-md:h-8.5 max-md:w-20"></div>

                                <div class="shimmer h-10 w-39.5 rounded-2xl max-md:h-8.5 max-md:w-28"></div>
                            </div>
                        </div>
                    </div>

                    <div class="grid place-content-start gap-2.5 max-md:hidden">
                        <div class="shimmer h-6.75 w-25"></div>
