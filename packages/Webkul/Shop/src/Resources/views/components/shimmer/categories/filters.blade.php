<div class="panel-side grid grid-cols-[1fr] gap-[20px] max-w-[400px] min-w-[342px] max-h-[1320px] overflow-y-auto overflow-x-hidden journal-scroll pr-[26px] max-xl:min-w-[270px]">
