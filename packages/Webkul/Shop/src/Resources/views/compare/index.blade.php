                        ...
                        <template v-for="attribute in comparableAttributes">
                            ...
                            >
                                ...
                                <div class="flex gap-3 border-zinc-200 max-sm:gap-0 max-sm:border-0 ltr:border-l-[1px] rtl:border-r-[1px]">
                                    ...
                                    >
                                        <span
                                            class="icon-cancel absolute top-5 z-[1] flex h-6 w-6 cursor-pointer items-center justify-center rounded-xl border border-[#E3E3E3] bg-white text-2xl max-sm:top-10 max-sm:h-6 max-sm:w-6 max-sm:rounded-full max-sm:text-sm ltr:right-10 max-sm:ltr:right-4 rtl:left-10 max-sm:rtl:left-4"
