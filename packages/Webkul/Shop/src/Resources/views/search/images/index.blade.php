<v-image-search>
    <button
        type="button"
        class="icon-camera absolute top-2.5 flex items-center text-xl max-sm:top-2 ltr:right-3 ltr:pr-3 max-sm:ltr:right-1.5 rtl:left-3 rtl:pl-3 max-sm:rtl:left-1.5"
