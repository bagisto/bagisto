                ...
                <div class="flex gap-[40px] items-start md:mt-[40px] max-lg:gap-[20px]">
                    ...
                    <div class="flex-1">
                        ...
                        <button
                            ...
                            class="secondary-button block mx-auto w-max py-[13px] mt-[60px] px-[74.5px] rounded-[18px] text-base text-center"
                        >
                            <!-- Spinner -->
                            <svg class="animate-spin h-5 w-5 text-navyBlue" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle
                                    class="opacity-25"
                                    cx="12"
                                    cy="12"
