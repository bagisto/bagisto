        ...
        <form method="post" action="{{ route('shop.customer.profile.store') }}" @submit.prevent="onSubmit">
            <div class="edit-form">
                ...
                <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'numeric|max:15|min:6'" class="control" name="phone" value="{{ old('phone') ?? $customer->phone }}" data-vv-as="&quot;{{ __('shop::app.customer.account.profile.phone') }}&quot;">
