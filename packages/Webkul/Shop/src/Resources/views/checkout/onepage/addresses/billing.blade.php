<div>
    <template v-if="! forms.billing.isNew">
        <template v-if="forms.billing.isEdit">
                ...
                <x-slot:content class="!p-0 mt-8">
                    <div>
                        <a 
                            ...
                            @click="forms.billing.isEdit = ! forms.billing.isEdit"
                        >
                        ...
                        <form @submit="handleSubmit($event, handleBillingAddressForm)">
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    v-model="forms.billing.editAddress.company_name"
                            ...
                            <div class="grid grid-cols-2 gap-x-5">
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        rules="required"
                                        v-model="forms.billing.editAddress.first_name"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        rules="required"
                                        v-model="forms.billing.editAddress.last_name"
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    v-model="forms.billing.editAddress.email"
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    v-model="forms.billing.editAddress.address1[0]"
                                ...
                                @if (core()->getConfigData('customer.address.information.street_lines') > 1)
                                    @for ($i = 1; $i < core()->getConfigData('customer.address.information.street_lines'); $i++)
                                        <x-shop::form.control-group.control
                                            ...
                                            v-model="forms.billing.editAddress.address1[{{ $i }}]"
                                            :label="trans('shop::app.checkout.onepage.addresses.billing.street-address')"
                                            :placeholder="trans('shop::app.checkout.onepage.addresses.billing.street-address')"
                                        />
                                    @endfor
                            ...
                            <div class="grid grid-cols-2 gap-x-5">
                                <x-shop::form.control-group class="!mb-4">
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        v-model="forms.billing.editAddress.country"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        v-model="forms.billing.editAddress.state"
                            ...
                            <div class="grid grid-cols-2 gap-x-5">
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        name="billing[city]"
                                        rules="required"
                                        v-model="forms.billing.editAddress.city"
                                ...
                                <x-shop::form.control-group>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        v-model="forms.billing.editAddress.postcode"
                            ...
                            <x-shop::form.control-group>
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    v-model="forms.billing.editAddress.phone"
                        ...
                        <div class="grid gap-5 grid-cols-2 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-sm:grid-cols-1 max-sm:mt-4">
                            ...
                            >
                                ...
                                <span
                                    ...
                                    @click="editNewBillingAddressForm(address)"
                                >
                                </span>
