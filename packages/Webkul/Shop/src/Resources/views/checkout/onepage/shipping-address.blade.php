...
<div v-if="! address.shipping.isNew && availableAddresses.length > 0 && ! address.shipping.isShowShippingForm" class="mt-[30px]">
...
<div v-if="! address.shipping.isNew && address.shipping.isShowShippingForm" class="mt-[30px]">
    <x-shop::accordion>
        <x-slot:header>
            <div class="flex justify-between items-center">
                <h2 class="text-[26px] font-medium max-sm:text-[20px]">@lang('Shipping Address')</h2>
