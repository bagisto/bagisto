<!-- Header -->
<h1 class="text-2xl font-medium max-sm:py-5 max-sm:text-xl">
...
<div class="mt-10 grid border-b border-zinc-200 max-sm:mt-0">
    ...
    >
        ...
        <div>
            ...
            <p class="mt-2.5 flex flex-col text-lg font-medium max-sm:mt-1 max-sm:text-sm max-sm:font-normal">
