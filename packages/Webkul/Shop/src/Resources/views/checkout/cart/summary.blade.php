<div class="w-[418px] max-w-full max-sm:w-full">
    ...
    <div class="mt-6 grid gap-4 max-sm:gap-2.5">
        ...
        <a
            ...
            class="primary-button mt-4 place-self-end rounded-2xl px-11 py-3 max-sm:my-3.5 max-sm:mt-4 max-sm:w-full max-sm:max-w-full max-sm:py-3.5 max-sm:text-sm"
        >
