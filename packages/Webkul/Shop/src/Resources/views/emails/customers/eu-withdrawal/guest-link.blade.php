@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26;">
            @lang('shop::app.eu-withdrawal.emails.guest-link.title')
        </span> <br>
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            @lang('shop::app.eu-withdrawal.emails.guest-link.intro', ['order_id' => $orderIncrementId])
        </p>
    </div>
    ...
    <div style="margin-bottom: 40px;">
        ...
        >
            @lang('shop::app.eu-withdrawal.emails.guest-link.button')
        </a>
    </div>

    <p style="font-size: 13px;color: #8A94A6;line-height: 20px;margin-bottom: 8px;">
        @lang('shop::app.eu-withdrawal.emails.guest-link.expiry')
    </p>
