@php
    $statusIntroKey = 'shop::app.eu-withdrawal.emails.confirmation.intro-'.$withdrawal->status;
    $statusIntroKey = trans()->has($statusIntroKey) ? $statusIntroKey : 'shop::app.eu-withdrawal.emails.confirmation.intro';

    $titleKey = 'shop::app.eu-withdrawal.emails.confirmation.title-'.$withdrawal->status;
    $titleKey = trans()->has($titleKey) ? $titleKey : 'shop::app.eu-withdrawal.emails.confirmation.title';
@endphp
...
@component('shop::emails.layout')
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26;">
        @lang('shop::app.eu-withdrawal.emails.confirmation.summary')
    </div>
    ...
    >
        <tr>
            <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #121A26;width: 180px;vertical-align: top;white-space: nowrap;">
                @lang('shop::app.eu-withdrawal.emails.confirmation.reference')
            </td>
        ...
        <tr>
            <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #121A26;width: 180px;vertical-align: top;white-space: nowrap;">
                @lang('shop::app.eu-withdrawal.emails.confirmation.received-at')
            </td>
        ...
        <tr>
            <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #121A26;width: 180px;vertical-align: top;white-space: nowrap;">
                @lang('shop::app.eu-withdrawal.emails.confirmation.order')
            </td>
        ...
        <tr>
            <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #121A26;width: 180px;vertical-align: top;white-space: nowrap;">
                @lang('shop::app.eu-withdrawal.emails.confirmation.email')
            </td>
        ...
        @if ($withdrawal->reason_text)
            <tr>
                <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #121A26;width: 180px;vertical-align: top;white-space: nowrap;">
                    @lang('shop::app.eu-withdrawal.emails.confirmation.reason')
                </td>
        ...
        @if ($withdrawal->status === 'declined' && $withdrawal->declined_reason)
            <tr>
                <td style="padding: 8px 12px 8px 0;font-size: 14px;font-weight: 600;color: #B91C1C;width: 180px;vertical-align: top;white-space: nowrap;">
                    @lang('shop::app.eu-withdrawal.emails.confirmation.declined-reason')
                </td>
    ...
    <p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 24px;">
        @lang('shop::app.eu-withdrawal.emails.confirmation.refund-notice')
    </p>

    <p style="font-size: 13px;color: #8A94A6;line-height: 20px;margin-bottom: 0;">
        @lang('shop::app.eu-withdrawal.emails.confirmation.footer')
    </p>
@endcomponent
