...
beforeEach(function () {
    ...
    foreach ([$this->logoPath, $this->bannerPath] as $path) {
        Storage::put($path, (string) image_manager()->create(400, 300)->fill('cc6633')->toPng());
    }
...
it('should link every category image to its stored file on a disk that is not local', function () {
    ...
    expect(categoryOn($channel, $this->category)['logo'])->toBe([
        'small_image_url' => 'https://cdn.example.com/'.$this->logoPath,
        'medium_image_url' => 'https://cdn.example.com/'.$this->logoPath,
        'large_image_url' => 'https://cdn.example.com/'.$this->logoPath,
        'category_card_image_url' => 'https://cdn.example.com/'.$this->logoPath,
        'original_image_url' => 'https://cdn.example.com/'.$this->logoPath,
        'alt' => 'Summer logo',
    ]);
});
