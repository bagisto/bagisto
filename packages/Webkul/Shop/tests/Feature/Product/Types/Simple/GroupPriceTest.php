...
/**
 * Create a customer group price and re-index the product so the price index
 * reflects the new group price.
 */
function setGroupPrice(Product $product, int $customerGroupId, string $valueType, float $value, int $qty = 1): void
{
...
it('should apply fixed group price for guest customer', function () {
    ...
    setGroupPrice($product, customerGroupId: 1, valueType: 'fixed', value: 700);
...
it('should apply fixed group price for general customer', function () {
    ...
    setGroupPrice($product, customerGroupId: 2, valueType: 'fixed', value: 600);
...
it('should apply fixed group price for wholesale customer', function () {
    ...
    setGroupPrice($product, customerGroupId: 3, valueType: 'fixed', value: 500);
...
it('should apply percentage group discount for guest customer', function () {
    ...
    setGroupPrice($product, customerGroupId: 1, valueType: 'discount', value: 20);
...
it('should apply percentage group discount for general customer', function () {
    ...
    setGroupPrice($product, customerGroupId: 2, valueType: 'discount', value: 30);
...
it('should apply percentage group discount for wholesale customer', function () {
    ...
    setGroupPrice($product, 3, 'discount', 40);
