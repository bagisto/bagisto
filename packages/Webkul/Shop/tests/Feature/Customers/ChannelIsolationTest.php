...
it('should redirect a logged-in customer to their assigned channel when they land on another channel', function () {
...
it('should sign out a customer of another channel when both channels share a hostname', function () {
...
it('should answer a json request from a customer of another channel with unauthorized rather than a redirect', function () {
    $channel = Channel::factory()->create(['hostname' => core()->getCurrentChannel()->hostname]);
...
it('should allow a logged-in customer whose channel matches the current channel', function () {
...
it('should sign out a customer whose account was deactivated while signed in', function () {
