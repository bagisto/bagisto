...
it('should store the billing address for non stockable items for guest user', function () {
    ...
    postJson(route('shop.checkout.onepage.addresses.store'), [
        ...
        ->assertOk()
        ->assertJsonPath('data.payment_methods.0.method', 'stripe')
        ->assertJsonPath('data.payment_methods.0.method_title', 'Stripe')
        ->assertJsonPath('data.payment_methods.0.description', 'Stripe')
        ->assertJsonPath('data.payment_methods.0.sort', 1)
        ->assertJsonPath('data.payment_methods.1.method', 'razorpay')
        ->assertJsonPath('data.payment_methods.1.method_title', 'Razorpay')
        ->assertJsonPath('data.payment_methods.1.description', 'Razorpay')
        ->assertJsonPath('data.payment_methods.1.sort', 2)
        ->assertJsonPath('data.payment_methods.2.method', 'payu')
        ->assertJsonPath('data.payment_methods.2.method_title', 'PayU')
        ->assertJsonPath('data.payment_methods.2.description', 'PayU')
        ->assertJsonPath('data.payment_methods.2.sort', 3)
        ->assertJsonPath('data.payment_methods.3.method', 'paypal_smart_button')
        ->assertJsonPath('data.payment_methods.3.method_title', 'PayPal Smart Button')
        ->assertJsonPath('data.payment_methods.3.description', 'PayPal')
        ->assertJsonPath('data.payment_methods.3.sort', 4)
        ->assertJsonPath('data.payment_methods.4.method', 'paypal_standard')
        ->assertJsonPath('data.payment_methods.4.method_title', 'PayPal Standard')
        ->assertJsonPath('data.payment_methods.4.description', 'PayPal Standard')
        ->assertJsonPath('data.payment_methods.4.sort', 5)
        ->assertJsonPath('data.payment_methods.5.method', 'moneytransfer')
        ->assertJsonPath('data.payment_methods.5.method_title', 'Money Transfer')
        ->assertJsonPath('data.payment_methods.5.description', 'Money Transfer')
        ->assertJsonPath('data.payment_methods.5.sort', 7);
...
it('should store the shipping method for guest user', function () {
    ...
    postJson(route('shop.checkout.onepage.shipping_methods.store'), [
        ...
        ->assertJsonPath('payment_methods.4.method', 'paypal_standard')
        ->assertJsonPath('payment_methods.4.method_title', 'PayPal Standard')
        ->assertJsonPath('payment_methods.4.description', 'PayPal Standard')
        ->assertJsonPath('payment_methods.4.sort', 5)
        ->assertJsonPath('payment_methods.5.method', 'cashondelivery')
        ->assertJsonPath('payment_methods.5.method_title', 'Cash On Delivery')
        ->assertJsonPath('payment_methods.5.description', 'Cash On Delivery')
        ->assertJsonPath('payment_methods.5.sort', 6)
        ->assertJsonPath('payment_methods.6.method', 'moneytransfer')
        ->assertJsonPath('payment_methods.6.method_title', 'Money Transfer')
        ->assertJsonPath('payment_methods.6.description', 'Money Transfer')
...
it('should not return the cash on delivery payment method if product is downloadable', function () {
    ...
    postJson(route('shop.checkout.onepage.addresses.store'), [
        ...
        ->assertOk()
        ->assertJsonPath('redirect', false)
        ->assertJsonCount(6, 'data.payment_methods')
