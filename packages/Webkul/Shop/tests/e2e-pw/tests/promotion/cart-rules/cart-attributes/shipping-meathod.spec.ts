...
test.describe("cart rules", () => {
    test.describe("cart attribute conditions", () => {
        test("should apply coupon when shipping meathod condition is -> is equal to (fixed)", async ({
            page,
        }) => {
        ...
        test("should apply coupon when shipping meathod condition is -> is equal to (percentage)", async ({
            page,
        }) => {
            await createRuleAndVerifyCoupon({
                page,
        ...
        test("should apply coupon when shipping meathod condition is -> is not equal to (fixed)", async ({
            page,
        }) => {
            await createRuleAndVerifyCoupon({
                page,
        ...
        test("should apply coupon when shipping meathod condition is -> is not equal to (percentage)", async ({
            page,
        }) => {
            await createRuleAndVerifyCoupon({
                page,
