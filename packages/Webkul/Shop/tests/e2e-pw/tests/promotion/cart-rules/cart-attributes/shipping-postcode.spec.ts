...
test.describe("cart rules", () => {
    test.describe("cart attribute conditions", () => {
        test("should apply coupon when shipping postcode condition is -> is equal to", async ({
            page,
        }) => {
        ...
        test("should apply coupon when shipping postcode condition is -> is not equal to", async ({
            page,
        }) => {
            const createRules = new CreateRules(page);
            await createRules.adminlogin();
