...
return [
    'response' => [
        'provide-credentials' => 'Geef alstublieft geldige PhonePe-referenties op.',
        'cart-not-found' => 'Geen actief winkelwagen gevonden. Voeg alstublieft items toe aan uw winkelwagen voordat u naar betaling gaat.',
        'phonepe-payment-reference-missing' => 'PhonePe-betalingsverwijzing ontbreekt.',
