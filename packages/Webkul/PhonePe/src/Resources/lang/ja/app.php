...
return [
    'response' => [
        'provide-credentials' => 'PhonePeの有効な認証情報を入力してください。',
        'cart-not-found' => 'アクティブなカートが見つかりません。 支払いに進む前に、カートに商品を追加してください。',
        'phonepe-payment-reference-missing' => 'PhonePe支払い参照が見つかりません。',
