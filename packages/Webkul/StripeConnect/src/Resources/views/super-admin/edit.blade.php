...
@section('content-wrapper')
    <div class="content">
        <form method="POST" action="{{ route('admin.stripe.update-details') }}" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="title" v-validate="'required'" value="{{ $stripe_owner->title }}" data-vv-as="&quot;Title&quot;">
                        <span class="control-error" v-if="errors.has('title')">@{{ errors.first('title') }}</span>
                    </div>

                    <div class="control-group" :class="[errors.has('description') ? 'has-error' : '']">
                        <label for="description" class="required">Description</label>
                        <textarea type="text" class="control" name="description" v-validate="'required'" data-vv-as="&quot;description&quot;">{{ $stripe_owner->description }}</textarea>
                    ...
                    <div class="control-group" :class="[errors.has('enable_on_checkout') ? 'has-error' : '']">
                        ...
                        <select name="enable_on_checkout" class="control" v-validate="'required'" data-vv-as="&quot;Is Active&quot;" value="{{ $stripe_owner->enable_on_checkout }}">
                    ...
                    <div class="control-group" :class="[errors.has('enable_testing') ? 'has-error' : '']">
                        ...
                        <select name="enable_testing" class="control" v-validate="'required'" data-vv-as="&quot;Enable Testing&quot;" value="{{ $stripe_owner->enable_testing }}">
                            <option value="0">Yes</option>
                            <option value="1">No</option>
                        </select>
                    ...
                    <div class="control-group" :class="[errors.has('test_publishable_key') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="test_publishable_key" v-validate="'required'" value="{{ $stripe_owner->test_publishable_key }}" data-vv-as="&quot;Test Publishable Key&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('test_secret_key') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="test_secret_key" v-validate="'required'" value="{{ $stripe_owner->test_secret_key }}" data-vv-as="&quot;Test secret Key&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('live_publishable_key') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="live_publishable_key" v-validate="'required'" value="{{ $stripe_owner->live_publishable_key }}" data-vv-as="&quot;live Publishable Key&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('live_secret_key') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="live_secret_key" v-validate="'required'" value="{{ $stripe_owner->live_secret_key }}" data-vv-as="&quot;live secret Key&quot;">
