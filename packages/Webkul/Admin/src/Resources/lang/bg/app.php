...
return [
    ...
    'sales' => [
        'orders' => [
            'index' => [
                'create-btn' => 'Добави поръчка',
                'title'      => 'Поръчки',

                'search-customer' => [
                    'create-btn'  => 'Добави клиент',
        ...
        'refunds' => [
            ...
            'create' => [
                'adjustment-fee'              => 'Такса за корекция',
                'adjustment-refund'           => 'Такса за връщане',
                'amount-per-unit'             => ':amount на единица x :qty количество',
                'create-success'              => 'Връщането на продукт е създадено успешно.',
                'creation-error'              => 'Създаването на връщане на продукт не е разрешено.',
                'discount-amount'             => 'Сума на остъпката',
                'grand-total'                 => 'Обща сума',
                'invalid-qty'                 => 'Недостатъчно количество за фактуриране на продуктите.',
                'invalid-refund-amount-error' => 'Сумата на връщането на продуктите трябва да е различен от нула',
                'item-canceled'               => 'Отказани (:qty_canceled)',
                'item-invoice'                => 'Фактурирани (:qty_invoiced)',
                'item-ordered'                => 'Поръчани (:qty_ordered)',
                ...
                'per-unit'                    => 'За единица',
                'price'                       => 'Цена',
                'qty-to-refund'               => 'Количество за връщане',
                'refund-btn'                  => 'Връщане',
                'refund-limit-error'          => 'Сумата за връщане :amount не може да продължи.',
                'refund-shipping'             => 'Връщане на доставка',
                'sku'                         => 'SKU номер - :sku',
                'subtotal'                    => 'Сума',
                'tax-amount'                  => 'Данъчна сума',
                'title'                       => 'Добави връщане',
                'update-totals-btn'           => 'Обнови сумите',
            ],
        ],
        ...
        'invoices' => [
            ...
            'view' => [
                ...
                'customer'                       => 'Клиент',
                'discount'                       => 'Сума на остъпката - :discount',
                'email'                          => 'Имейл',
                'grand-total'                    => 'Обща сума',
                'invoice-items'                  => 'Продукти на фактурата',
                ...
                'qty'                            => 'Количество - :qty',
                'send-btn'                       => 'Изпрати',
                'send-duplicate-invoice'         => 'Изпрати копие на фактурата',
                'send'                           => 'Изпрати',
                ...
                'sub-total'                      => 'Сума - :sub_total',
                'summary-discount'               => 'Сума на остъпката',
            ...
            'create' => [
                'amount-per-unit'    => ':amount на единица x :qty количество',
                'create-invoice'     => 'Добави фактура',
                'create-success'     => 'Фактурата е създадена успешно.',
                'create-transaction' => 'Добави на транзакция',
                'creation-error'     => 'Създаването на фактура за поръчка не е разрешено.',
                'invalid-qty'        => 'Недостатъчно количество за фактуриране на продуктите.',
                'invoice'            => 'Фактура',
            ...
            'invoice-pdf' => [
                'bank-details'               => 'Данни за Банката',
                'bill-to'                    => 'Плати на',
                'contact-number'             => 'Телефонен номер',
                'contact'                    => 'Контакти',
                'date'                       => 'Дата на фактуриране',
                'discount'                   => 'Отстъпка',
                'excl-tax'                   => 'без ДДС:',
                'grand-total'                => 'Обща сума',
                'invoice-id'                 => 'Фактура №',
        ...
        'transactions' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'amount'                     => 'Сума',
                    'create-transaction'         => 'Добави транзакция',
                    'invoice-id'                 => 'Фактура №',
                    'invoice-missing'            => 'Липсваща фактура',
                    'payment-method'             => 'Метод на плащане',
                    ...
                    'transaction-saved'          => 'Транзакцията е запазена успешно.',
                ],
    ...
    'catalog' => [
        'products' => [
            'index' => [
                'already-taken' => 'Името :name вече се използва.',
                'create-btn'    => 'Добави продукт',
                'title'         => 'Продукти',
                ...
                'datagrid' => [
                    ...
                    'id'                     => '№',
                    'image'                  => 'Изображение',
                    'mass-delete-success'    => 'Избраните продукти бяха изтрити успешно',
                    'mass-update-success'    => 'Избраните продукти бяха обновени успешно',
                    'name'                   => 'Име',
                    'out-of-stock'           => 'Извън наличност',
                    'price'                  => 'Цена',
                    'product-image'          => 'Изображение на продукта',
        ...
        'customers' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'male'                  => 'Мъж',
                    'other'                 => 'Друго',
                    'save-btn'              => 'Запази клиент',
                    'select-customer-group' => 'Избери клиентска група',
            ...
            'view' => [
                ...
                'customer'                    => 'Клиент',
                'date-of-birth'               => 'Рожденна дата - :dob',
                ...
                'datagrid' => [
                    ...
                    'reviews' => [
                        ...
                        'id'            => '№',
                        'invoice-date'  => 'Дата на фактуриране',
                        'pending'       => 'В очакване',
            ...
            'events' => [
                'index' => [
                    ...
                    'create' => [
                        ...
                        'general'        => 'Общи',
                        'name'           => 'Име',
                        'save-btn'       => 'Запази събитие',
                        'success'        => 'Events Created Successfully',
                        'title'          => 'Добави събития',
                    ],
    ...
    'settings' => [
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'name'                    => 'Име',
                'root-category'           => 'Главна категория',
                ...
                'select-theme'            => 'Избери тема',
                'seo'                     => 'Home page SEO',
                'seo-description'         => 'Мета описание',
                'seo-keywords'            => 'Мета кл. думи',
