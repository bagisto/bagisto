...
return [
    ...
    'command-palette' => [
        'placeholder' => 'Buscar menús, ajustes, páginas y acciones...',
        'esc' => 'ESC',
        'loading' => 'Cargando...',
        'no-results' => 'Sin resultados',
        'no-results-hint' => 'Pruebe con un menú, una página, un ajuste o una acción.',
        'navigate' => 'Navegar',
        'select' => 'Abrir',
        'close' => 'Cerrar',

        'all' => 'Todos los :resource',
        'back' => 'Atrás',
        'context-placeholder' => 'Buscar en :context...',

        'start-typing' => 'Escriba para buscar',
        'record-actions' => [
            'view' => 'Ver',
            'edit' => 'Editar',
            'duplicate' => 'Duplicar',
        ...
        'index' => [
            'about' => [
                ...
                'general' => [
                    ...
                    'drivers' => [
                        'apc' => 'APC',
                        'array' => 'Matriz (en memoria)',
                        'beanstalkd' => 'Beanstalkd',
                        'cookie' => 'Cookie',
                        'custom' => 'Personalizado',
                        'daily' => 'Archivos diarios',
                        'database' => 'Base de datos',
                        'dynamodb' => 'DynamoDB',
            ...
            'sales' => [
                ...
                'checkout' => [
                    ...
                    'info' => 'Compra como invitado, página del carrito y minicarrito.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Mostrar el minicarrito, el contador de artículos que muestra y el texto de oferta que contiene.',
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'omnibus' => [
                        'title' => 'Divulgación de precios Omnibus',
                        'title-info' => 'Registra instantáneas de precio diarias y muestra el precio más bajo de los 30 días anteriores a cada descuento, tal como exige la Directiva Omnibus de la UE.',
                        'enable' => 'Habilitar divulgación Omnibus',
                    ],
                ],
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-types' => [
                            ...
                            'api-key' => 'Clave API',
                            'cloud-api-key' => 'Elastic Cloud con clave API',
                            'cloud-basic' => 'Elastic Cloud con usuario y contraseña',
                        ],
            ...
            'file-management' => [
                ...
                'info' => 'Elija dónde se almacenan los archivos subidos y configure el servicio de almacenamiento.',

                'general' => [
                    'title' => 'General',
                    'info' => 'El almacenamiento que toda la tienda utiliza para los archivos subidos.',

                    'settings' => [
                        'title' => 'Configuración',
                        'info' => 'Elija el almacenamiento en el que se guardan los archivos y desde el que se sirven.',
                        'default-driver' => 'Controlador de almacenamiento predeterminado',
                        'default-driver-info' => 'Los archivos subidos a partir de ahora se guardarán aquí. Los archivos ya subidos permanecen en el almacenamiento anterior: cópielos antes de cambiar o no se encontrarán.',

                        'drivers' => [
                            'local' => 'Archivo (almacenamiento local)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Credenciales para Amazon S3 o cualquier servicio compatible con su API.',

                    'settings' => [
                        'title' => 'Configuración',
                        'info' => 'Se utiliza cuando el controlador de almacenamiento predeterminado es Amazon S3.',
                        'key' => 'ID de clave de acceso',
                        'key-info' => 'El ID de clave de acceso de la cuenta a la que pertenece el bucket.',
                        'secret' => 'Clave de acceso secreta',
                        'secret-info' => 'El secreto asociado al ID de clave de acceso.',
                        'region' => 'Región',
                        'region-info' => 'La región en la que se creó el bucket, por ejemplo us-east-1.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'El nombre del bucket en el que se almacenan los archivos.',
                        'url' => 'URL',
                        'url-info' => 'La dirección desde la que se sirven los archivos. Déjelo vacío para usar la dirección que proporciona el servicio.',
                        'endpoint' => 'Endpoint',
                        'endpoint-info' => 'Solo es necesario para un servicio distinto de Amazon S3, como uno autoalojado. Déjelo vacío para Amazon S3.',
                        'use-path-style-endpoint' => 'Usar endpoint por ruta',
                        'use-path-style-endpoint-info' => 'Actívelo para un servicio autoalojado que direcciona los buckets como una ruta en lugar de un subdominio.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Credenciales para el almacenamiento de objetos Cloudflare R2.',

                    'settings' => [
                        'title' => 'Configuración',
                        'info' => 'Se utiliza cuando el controlador de almacenamiento predeterminado es Cloudflare R2.',
                        'account-id' => 'ID de cuenta',
                        'account-id-info' => 'La cuenta de Cloudflare a la que pertenece el bucket. La dirección de R2 se construye a partir de ella, por lo que no se necesita ningún endpoint.',
                        'key' => 'ID de clave de acceso',
                        'key-info' => 'El ID de clave de acceso de un token de API de R2.',
                        'secret' => 'Clave de acceso secreta',
                        'secret-info' => 'El secreto asociado al ID de clave de acceso.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'El nombre del bucket de R2 en el que se almacenan los archivos.',
                        'url' => 'URL pública',
                        'url-info' => 'La dirección desde la que se sirven los archivos, ya sea la dirección pública del bucket o un dominio propio. Un bucket de R2 es privado hasta que se establece una, sin ella los archivos no serán accesibles.',
                    ],
                ],
            ],
    ...
    'components' => [
        ...
        'date-range-picker' => [
            'presets' => [
                'last-month' => 'Mes Anterior',
                'last-six-months' => 'Últimos 6 Meses',
                'last-thirty-days' => 'Últimos 30 Días',
                'last-three-months' => 'Últimos 3 Meses',
                'this-month' => 'Este Mes',
                'this-week' => 'Esta Semana',
                'this-year' => 'Este Año',
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'Desistimientos UE',
        ],
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Activar',
                'enabled-info' => 'Cuando está activado, los clientes de este canal ven un botón «Desistir del contrato» en las páginas de detalle del pedido y un formulario público de búsqueda en /withdraw. Actívelo solo en canales que vendan a consumidores de la UE.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Prueba',
            'evidence-note' => 'Inmutable — capturado en el envío',
            'status' => 'Estado',
            ...
            'timeline' => 'Cronología',
            'timeline-received' => 'Declaración recibida',
            'timeline-received-desc' => 'El cliente envió una solicitud de desistimiento del contrato.',
            'timeline-email' => 'Correo de confirmación',
            'timeline-email-pending' => 'Aún no enviado',
            'timeline-initial-email' => 'Correo de confirmación inicial',
            'timeline-initial-email-desc-sent' => 'Correo de confirmación entregado al cliente.',
            'timeline-initial-email-desc-error' => 'No se pudo enviar el correo de confirmación inicial.',
            'timeline-initial-email-desc-pending' => 'El correo de confirmación inicial aún no se ha enviado.',
            'timeline-final-email' => 'Correo de confirmación final',
            'timeline-final-email-pending' => 'Aún no enviado',
            'timeline-final-email-desc-sent' => 'Correo de resultado entregado al cliente.',
            'timeline-final-email-desc-pending' => 'El correo de confirmación final aún no se ha enviado.',
            'timeline-declined' => 'Desistimiento rechazado',
            'timeline-declined-desc' => 'Desistimiento rechazado por :name.',
            'timeline-declined-desc-system' => 'Desistimiento rechazado.',
            'timeline-declined-reason-label' => 'Motivo indicado:',
            ...
            'timeline-refunded-note-label' => 'Nota del administrador:',
            'timeline-resolution' => 'Resolución pendiente',
            'timeline-resolution-desc' => 'A la espera de revisión y decisión del administrador.',
            'timeline-resolution-pending' => 'A la espera de acción del administrador',

            'confirmation-sent-at' => 'Confirmación enviada el',
            'confirmation-error' => 'Error de confirmación',
            'declined-at' => 'Rechazado el',
            'refunded-at' => 'Reembolsado el',

            'actions' => 'Acciones',
            'actions-note' => 'Los reembolsos se procesan manualmente con las herramientas existentes de Bagisto de pedido / reembolso / RMA. Use estas acciones para registrar el resultado en la prueba del desistimiento.',
            'resend-confirmation' => 'Reenviar correo de confirmación',
            'mark-refunded' => 'Marcar como reembolsado',
            'refund-note-label' => 'Referencia del reembolso (opcional)',
            'refund-note-placeholder' => 'p. ej., Reembolso n.º 1234',
            'decline' => 'Rechazar desistimiento',
            'decline-reason-label' => 'Motivo del rechazo',
            'decline-reason-placeholder' => 'Explique por qué se cuestiona el derecho',
            'mark-refunded-confirm-msg' => '¿Marcar este desistimiento como reembolsado? Se borrará cualquier registro previo de rechazo.',
            'decline-confirm-msg' => '¿Rechazar este desistimiento? El motivo será visible para el cliente.',
            'resend-confirmation-confirm-msg' => '¿Reenviar el correo de confirmación al cliente?',
            'send-final-confirmation' => 'Enviar correo de confirmación final',
            'send-final-confirmation-confirm-msg' => '¿Enviar al cliente el correo con el estado final?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'Canal',
            'status' => 'Estado',
            'confirmation-sent-at' => 'Confirmación enviada',
            'view' => 'Ver',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'Se ha reenviado el correo de confirmación.',
            'confirmation-failed' => 'No se pudo enviar el correo de confirmación. Consulte la cronología para más detalles.',
        ],
    ],
];
