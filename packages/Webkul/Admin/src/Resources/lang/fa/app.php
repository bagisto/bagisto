    ...
    'configuration' => [
        'index' => [
            ...
            'file-management' => [
                ...
                'info' => 'محل ذخیره‌سازی فایل‌های بارگذاری‌شده را انتخاب و سرویس ذخیره‌سازی را پیکربندی کنید.',

                'general' => [
                    'title' => 'عمومی',
                    'info' => 'فضای ذخیره‌سازی که کل فروشگاه برای فایل‌های بارگذاری‌شده استفاده می‌کند.',

                    'settings' => [
                        'title' => 'تنظیمات',
                        'info' => 'فضای ذخیره‌سازی که فایل‌ها در آن ذخیره و از آن ارائه می‌شوند را انتخاب کنید.',
                        'default-driver' => 'درایور ذخیره‌سازی پیش‌فرض',
                        'default-driver-info' => 'فایل‌هایی که از این پس بارگذاری می‌شوند اینجا ذخیره خواهند شد. فایل‌های بارگذاری‌شده قبلی در فضای پیشین باقی می‌مانند، بنابراین پیش از تغییر آن‌ها را کپی کنید وگرنه یافت نخواهند شد.',

                        'drivers' => [
                            'local' => 'فایل (ذخیره‌سازی محلی)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'اطلاعات دسترسی برای Amazon S3 یا هر سرویسی که از همان API پشتیبانی می‌کند.',

                    'settings' => [
                        'title' => 'تنظیمات',
                        'info' => 'زمانی استفاده می‌شود که درایور ذخیره‌سازی پیش‌فرض روی Amazon S3 تنظیم شده باشد.',
                        'key' => 'شناسه کلید دسترسی',
                        'key-info' => 'شناسه کلید دسترسی حسابی که باکت به آن تعلق دارد.',
                        'secret' => 'کلید دسترسی محرمانه',
                        'secret-info' => 'کلید محرمانه متناظر با شناسه کلید دسترسی.',
                        'region' => 'منطقه',
                        'region-info' => 'منطقه‌ای که باکت در آن ایجاد شده است، برای مثال us-east-1.',
                        'bucket' => 'باکت',
                        'bucket-info' => 'نام باکتی که فایل‌ها در آن ذخیره می‌شوند.',
                        'url' => 'نشانی',
                        'url-info' => 'نشانی‌ای که فایل‌ها از آن ارائه می‌شوند. برای استفاده از نشانی خود سرویس، خالی بگذارید.',
                        'endpoint' => 'نقطه پایانی',
                        'endpoint-info' => 'تنها برای سرویسی غیر از Amazon S3 لازم است، مثلاً سرویسی که خودتان میزبانی می‌کنید. برای Amazon S3 خالی بگذارید.',
                        'use-path-style-endpoint' => 'استفاده از نقطه پایانی مبتنی بر مسیر',
                        'use-path-style-endpoint-info' => 'برای سرویسی که خودتان میزبانی می‌کنید و باکت‌ها را به جای زیردامنه به صورت مسیر آدرس‌دهی می‌کند، فعال کنید.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'اطلاعات دسترسی برای ذخیره‌سازی شیء Cloudflare R2.',

                    'settings' => [
                        'title' => 'تنظیمات',
                        'info' => 'زمانی استفاده می‌شود که درایور ذخیره‌سازی پیش‌فرض روی Cloudflare R2 تنظیم شده باشد.',
                        'account-id' => 'شناسه حساب',
                        'account-id-info' => 'حساب Cloudflare که باکت به آن تعلق دارد. نشانی R2 از روی آن ساخته می‌شود، بنابراین نیازی به نقطه پایانی نیست.',
                        'key' => 'شناسه کلید دسترسی',
                        'key-info' => 'شناسه کلید دسترسی یک توکن API مربوط به R2.',
                        'secret' => 'کلید دسترسی محرمانه',
                        'secret-info' => 'کلید محرمانه متناظر با شناسه کلید دسترسی.',
                        'bucket' => 'باکت',
                        'bucket-info' => 'نام باکت R2 که فایل‌ها در آن ذخیره می‌شوند.',
                        'url' => 'نشانی عمومی',
                        'url-info' => 'نشانی‌ای که فایل‌ها از آن ارائه می‌شوند، یا نشانی عمومی باکت یا یک دامنه اختصاصی. باکت R2 تا زمانی که نشانی تعیین نشود خصوصی است و بدون آن فایل‌ها در دسترس نخواهند بود.',
                    ],
                ],
            ],
