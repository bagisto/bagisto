        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'کلید API',
                    'api_publishable_key'            => 'کلید قابل انتشار API',
                    'api_test_key'                   => 'کلید مخفی آزمایشی API',
                    'api_test_publishable_key'       => 'کلید قابل انتشار آزمایشی API',
                    'applicable-production'          => 'در صورت انتخاب حالت تولید اعمال می‌شود',
                    'applicable-sandbox'             => 'در صورت انتخاب حالت آزمایشی اعمال می‌شود',
                    'application_fee'                => 'پرداخت‌کننده کارمزد برنامه',
                    ...
                    'paid'                           => 'پرداخت شده',
                    'payment-method-info'            => 'گزینه پرداخت استرایپ برای کسب‌وکارهای آنلاین که به مشتریان امکان پرداخت با کارت اعتباری/دبیت را می‌دهد و به رشد کسب‌وکار شما کمک می‌کند',
                    ...
                    'sort-order'                     => 'ترتیب مرتب سازی',
                    'statement_descriptor'           => 'توضیح صورت‌حساب',
                    'status'                         => 'وضعیت',
                    'stripePayment'                  => 'پرداخت استرایپ',
                    'stripe_refund'                  => 'بازپرداخت استرایپ',
                    'title'                          => 'عنوان',
