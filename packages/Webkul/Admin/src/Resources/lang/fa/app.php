...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'enter_code'            => 'برای ادامه، کد ۶ رقمی برنامه احراز هویت خود را وارد کنید.',
            'code_label'            => 'کد تأیید',
            'code_placeholder'      => 'کد ۶ رقمی را وارد کنید',
            'back'                  => 'بازگشت',
            'verify_code'           => 'تأیید کد',
            'disabled_message'      => 'احراز هویت دو مرحله‌ای در حال حاضر توسط مدیر غیرفعال شده است.',
        ],
    ],
    ...
    'account' => [
        ...
        'setup' => [
            ...
            'scan_qr'          => 'این کد QR را در برنامه Google Authenticator خود اسکن کرده و سپس کد ۶ رقمی زیر را وارد کنید.',
            'code_label'       => 'کد تأیید',
            'code_placeholder' => 'کد ۶ رقمی را وارد کنید',
            'back'             => 'بازگشت',
