        ...
        'index' => [
            ...
            'customer' => [
                ...
                'social-login' => [
                    ...
                    'info'  => 'پیکربندی ورود با استفاده از شبکه‌های اجتماعی',

                    'google-details' => [
                        'title'      => 'جزئیات گوگل',
                        'title-info' => 'مشخصات احراز هویت گوگل خود را برای فعال‌سازی ورود از طریق گوگل پیکربندی کنید.',

                        'client-id' => [
                            'title'      => 'شناسه مشتری (Client ID)',
                            'title-info' => 'شناسه منحصربه‌فردی که هنگام ایجاد برنامه احراز هویت از گوگل دریافت می‌کنید.',
                        ],

                        'client-secret' => [
                            'title'      => 'کلید محرمانه مشتری (Client Secret)',
                            'title-info' => 'کلید محرمانه‌ای که با کلاینت گوگل شما مرتبط است. این اطلاعات را محرمانه نگه دارید.',
                        ],

                        'redirect' => [
                            'title'      => 'URL بازگشت',
                            'title-info' => 'آدرس بازگشتی که کاربران پس از ورود از طریق گوگل به آن منتقل می‌شوند. باید با آدرس ثبت‌شده در کنسول گوگل مطابقت داشته باشد.',
                        ],
                    ],

                    'facebook-details' => [
                        'title'      => 'جزئیات فیس‌بوک',
                        'title-info' => 'مشخصات احراز هویت فیس‌بوک خود را برای فعال‌سازی ورود از طریق فیس‌بوک پیکربندی کنید.',

                        'client-id' => [
                            'title'      => 'شناسه مشتری (Client ID)',
                            'title-info' => 'شناسه برنامه‌ای که از فیس‌بوک دریافت می‌کنید زمانی که اپلیکیشن را در کنسول توسعه‌دهندگان فیس‌بوک ایجاد می‌کنید.',
                        ],

                        'client-secret' => [
                            'title'      => 'کلید محرمانه مشتری (Client Secret)',
                            'title-info' => 'کلید مخفی مربوط به برنامه فیس‌بوک شما. این اطلاعات را به صورت ایمن و خصوصی نگه دارید.',
                        ],

                        'redirect' => [
                            'title'      => 'URL بازگشت',
                            'title-info' => 'آدرس بازگشتی که کاربران پس از احراز هویت در فیس‌بوک به آن هدایت می‌شوند. باید با آدرسی که در تنظیمات برنامه فیس‌بوک وارد شده مطابقت داشته باشد.',
                        ],
                    ],

                    'github-details' => [
                        'title'      => 'جزئیات گیت‌هاب',
                        'title-info' => 'مشخصات احراز هویت گیت‌هاب خود را برای فعال‌سازی ورود از طریق گیت‌هاب پیکربندی کنید.',

                        'client-id' => [
                            'title'      => 'شناسه مشتری (Client ID)',
                            'title-info' => 'شناسه منحصربه‌فردی که از گیت‌هاب هنگام ایجاد برنامه احراز هویت دریافت می‌کنید.',
                        ],

                        'client-secret' => [
                            'title'      => 'کلید محرمانه مشتری (Client Secret)',
                            'title-info' => 'کلید مخفی مرتبط با کلاینت گیت‌هاب شما. آن را محرمانه نگه دارید.',
                        ],

                        'redirect' => [
                            'title'      => 'URL بازگشت',
                            'title-info' => 'آدرس بازگشتی که کاربران پس از ورود از طریق گیت‌هاب به آن هدایت می‌شوند. باید با آدرس ثبت‌شده در کنسول گیت‌هاب مطابقت داشته باشد.',
                        ],
                    ],

                    'linkedin-openid-details' => [
                        'title'      => 'جزئیات لینکدین',
                        'title-info' => 'مشخصات احراز هویت لینکدین خود را برای فعال‌سازی ورود از طریق لینکدین پیکربندی کنید.',

                        'client-id' => [
                            'title'      => 'شناسه مشتری (Client ID)',
                            'title-info' => 'شناسه منحصربه‌فردی که هنگام ایجاد برنامه احراز هویت از لینکدین دریافت می‌کنید.',
                        ],

                        'client-secret' => [
                            'title'      => 'کلید محرمانه مشتری (Client Secret)',
                            'title-info' => 'کلید مخفی مرتبط با کلاینت لینکدین شما. آن را محرمانه نگه دارید.',
                        ],

                        'redirect' => [
                            'title'      => 'URL بازگشت',
                            'title-info' => 'آدرس بازگشتی که کاربران پس از ورود از طریق لینکدین به آن هدایت می‌شوند. باید با آدرس ثبت‌شده در کنسول لینکدین مطابقت داشته باشد.',
                        ],
                    ],

                    'twitter-details' => [
                        'title'      => 'جزئیات توییتر',
                        'title-info' => 'مشخصات احراز هویت توییتر خود را برای فعال‌سازی ورود از طریق توییتر پیکربندی کنید.',

                        'client-id' => [
                            'title'      => 'شناسه مشتری (Client ID)',
                            'title-info' => 'شناسه منحصربه‌فردی که از توییتر هنگام ایجاد برنامه احراز هویت دریافت می‌کنید.',
                        ],

                        'client-secret' => [
                            'title'      => 'کلید محرمانه مشتری (Client Secret)',
                            'title-info' => 'کلید مخفی مرتبط با کلاینت توییتر شما. آن را محرمانه نگه دارید.',
                        ],

                        'redirect' => [
                            'title'      => 'URL بازگشت',
                            'title-info' => 'آدرس بازگشتی که کاربران پس از ورود از طریق توییتر به آن هدایت می‌شوند. باید با آدرس ثبت‌شده در کنسول توییتر مطابقت داشته باشد.',
                        ],
                    ],
                ],
            ],
