        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'speculation-rules' => [
                        'info'  => 'تنظیمات را برای فعال یا غیرفعال کردن منطق گمانه‌زنی خودکار پیکربندی کنید.',
                        'title' => 'قوانین گمانه‌زنی',

                        'settings' => [
                            'eagerness'              => 'سطح اشتیاق',
                            'eager'                  => 'مشتاق',
                            'moderate'               => 'متوسط',
                            'conservative'           => 'محافظه‌کار',
                            'eagerness-info'         => 'تعیین می‌کند قوانین گمانه‌زنی با چه شدت اعمال شوند. گزینه‌ها: مشتاق (حداکثر)، متوسط (پیش‌فرض)، محافظه‌کار (حداقل).',
                            'ignore-url-params'      => 'نادیده گرفتن پارامترهای URL',
                            'ignore-url-params-info' => 'پارامترهای URL که باید نادیده گرفته شوند را وارد کنید. از | برای جدا کردن استفاده کنید.',
                            'ignore-urls'            => 'نادیده گرفتن URLها',
                            'ignore-urls-info'       => 'URLهایی را وارد کنید که باید از منطق گمانه‌زنی حذف شوند. با | جدا کنید.',
                            'info'                   => 'وضعیت قوانین گمانه‌زنی را تنظیم کنید.',
                            'title'                  => 'فعال‌سازی قوانین گمانه‌زنی',
                        ],
                    ],
