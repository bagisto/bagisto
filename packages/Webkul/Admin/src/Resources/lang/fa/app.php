            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'api-key' => 'کلید API',
                        'api-key-info' => 'به جای نام کاربری و گذرواژه به کار می‌رود. تنظیم آن اتصال را به احراز هویت با کلید API می‌برد.',
                        'cloud-id' => 'شناسهٔ ابر',
                        'cloud-id-info' => 'برای Elastic Cloud. تنظیم آن اتصال را به Elastic Cloud می‌برد و با کلید API همراه می‌شود.',
