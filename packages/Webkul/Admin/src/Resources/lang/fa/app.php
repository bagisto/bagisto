...
return [
                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'پسوندها را با کاما جدا کنید، مانند jpg, png, pdf. صفحات وب، تصاویر SVG، فایل‌های XML و اسکریپت هرگز پذیرفته نمی‌شوند، حتی اگر در اینجا فهرست شده باشند.',
                                'title' => 'گزینه',
                                'type' => 'نوع',
                                'yes' => 'بله',
                            ],
    ...
    'settings' => [
        ...
        'exchange-rates' => [
            'index' => [
                ...
                'update-rates-error' => 'نرخ‌های ارز به‌روزرسانی نشد. یا سرویس نرخ ارز در دسترس نیست، یا کلید API آن تنظیم نشده است.',
    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    'title' => 'تسویه حساب',
                    'info' => 'تسویه به‌عنوان مهمان، صفحهٔ سبد خرید و سبد کوچک.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'نمایش سبد کوچک، شمارندهٔ کالاهای آن و متن پیشنهادی درون آن.',
            ...
            'search-engines' => [
                ...
                'info' => 'موتوری را که جست‌وجوی محصول را اجرا می‌کند انتخاب و پیکربندی کنید.',
                ...
                'test-connection' => [
                    ...
                    'statuses' => [
                        'available' => ':engine در دسترس است',
                        'unreachable' => ':engine پاسخ نداد',
                        'unauthorized' => ':engine اطلاعات ورود را رد کرد',
                        'incompatible' => 'میزبان پاسخ داد اما کارساز پشتیبانی‌شدهٔ :engine نیست',
                        'misconfigured' => 'اتصال :engine پیکربندی نشده است',
                    ],
                ],

                'general' => [
                    'title' => 'عمومی',
                    'info' => 'موتوری که جست‌وجوی محصول روی آن اجرا می‌شود.',

                    'settings' => [
                        'title' => 'تنظیمات',
                        'info' => 'یک موتور جست‌وجوی بیرونی را فعال کنید و جای استفادهٔ آن را انتخاب کنید.',
                        'enabled' => 'فعال‌سازی موتور جست‌وجوی بیرونی',
                        'enabled-info' => 'برای جست‌وجو در پایگاه داده در همه‌جا، صرف‌نظر از تنظیمات زیر، این را خاموش کنید.',
                        'engine' => 'موتور جست‌وجوی پیش‌فرض',
                        'engine-info' => 'موتوری که هرجا حالت جست‌وجو روی «استفاده از پیش‌فرض» بماند به کار می‌رود.',
                        'inherit' => 'استفاده از پیش‌فرض',
                    ],

                    'products' => [
                        'title' => 'محصولات',
                        'info' => 'هر سوی فروشگاه با کدام موتور محصولات را جست‌وجو می‌کند.',
                        'admin-mode' => 'حالت جست‌وجوی پنل مدیریت',
                        'admin-mode-info' => 'موتور پشت جست‌وجوی فراگیر، جدول‌های داده و دیگر جست‌وجوهای پنل مدیریت.',
                        'storefront-mode' => 'حالت جست‌وجوی فروشگاه',
                        'storefront-mode-info' => 'موتور پشت صفحه‌های دسته‌بندی، صفحهٔ جست‌وجو و دیگر جست‌وجوهای فروشگاه.',
                    ],
                ],

                'elastic' => [
                    'info' => 'وضعیت اتصال و محدودیت‌های پرس‌وجو برای Elasticsearch.',

                    'settings' => [
                        'title' => 'تنظیمات',
                        'info' => 'زمانی به کار می‌رود که حالت جست‌وجو روی Elasticsearch تنظیم شده باشد.',
                        'auth-type' => 'احراز هویت',
                        'auth-type-info' => 'اینکه چگونه به خوشه دسترسی پیدا می‌شود و وارد آن می‌شوید. فقط فیلدهای لازم نمایش داده می‌شوند.',

                        'auth-types' => [
                            'none' => 'بدون احراز هویت',
                            'basic' => 'نام کاربری و رمز عبور',
                            'api-key' => 'کلید API',
                            'cloud-api-key' => 'Elastic Cloud با کلید API',
                            'cloud-basic' => 'Elastic Cloud با نام کاربری و رمز عبور',
                        ],

                        'hosts' => 'میزبان‌ها',
                        'hosts-info' => 'جایی که خوشه در دسترس است، مانند http://localhost:9200. چند میزبان را با ویرگول جدا کنید. برای استفاده از پروندهٔ محیط خالی بگذارید.',
                        'username' => 'نام کاربری',
                        'username-info' => 'در احراز هویت پایه به کار می‌رود. اگر خوشه نیازی ندارد خالی بگذارید.',
                        'password' => 'گذرواژه',
                        'password-info' => 'گذرواژهٔ متناظر با نام کاربری.',
                        'api-key' => 'کلید API',
                        'api-key-info' => 'کلیدی که با آن به خوشه وارد می‌شوید.',
                        'cloud-id' => 'شناسهٔ ابر',
                        'cloud-id-info' => 'شناسه Cloud ID استقرار Elastic Cloud.',
                        'index-prefix' => 'پیشوند نمایه',
                        'index-prefix-info' => 'پیش از هر نام نمایه افزوده می‌شود تا چند فروشگاه یک خوشه را به اشتراک بگذارند.',
                        'min-query-length' => 'کمترین طول پرس‌وجو',
                        'min-query-length-info' => 'کوتاه‌ترین عبارت جست‌وجویی که جعبهٔ جست‌وجوی فروشگاه می‌پذیرد.',
                        'max-query-length' => 'بیشترین طول پرس‌وجو',
                        'max-query-length-info' => 'بلندترین عبارت جست‌وجویی که جعبهٔ جست‌وجوی فروشگاه می‌پذیرد.',
                        'connection' => 'اتصال',
                    ],
                ],
            ],
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'انصراف از قرارداد (اتحادیه اروپا)',
        ],
        ...
        'acl' => [
            ...
            'view' => 'مشاهده',
            'decline' => 'رد کردن',
            'mark-refunded' => 'علامت‌گذاری به‌عنوان بازپرداخت‌شده',
            'resend-confirmation' => 'ارسال مجدد تأییدیه',
        ],
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'فعال‌سازی',
                'enabled-info' => 'هنگامی که فعال باشد، مشتریان این کانال در صفحه جزئیات سفارش دکمه «انصراف از قرارداد» و یک فرم عمومی جست‌وجوی ‎/withdraw را مشاهده می‌کنند. فقط در کانال‌هایی که به مصرف‌کنندگان اتحادیه اروپا فروش دارند فعال کنید.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'مدارک',
            'evidence-note' => 'تغییرناپذیر — در زمان ثبت ضبط شده است',
            'status' => 'وضعیت',
            ...
            'timeline' => 'سیر زمانی',
            'timeline-received' => 'اعلامیه دریافت شد',
            'timeline-received-desc' => 'مشتری درخواست انصراف از قرارداد را ثبت کرده است.',
            'timeline-email' => 'ایمیل تأییدیه',
            'timeline-email-pending' => 'هنوز ارسال نشده است',
            'timeline-initial-email' => 'ایمیل تأییدیه اولیه',
            'timeline-initial-email-desc-sent' => 'ایمیل تأییدیه به مشتری تحویل شد.',
            'timeline-initial-email-desc-error' => 'ارسال ایمیل تأییدیه اولیه با خطا مواجه شد.',
            'timeline-initial-email-desc-pending' => 'ایمیل تأییدیه اولیه هنوز ارسال نشده است.',
            'timeline-final-email' => 'ایمیل تأییدیه نهایی',
            'timeline-final-email-pending' => 'هنوز ارسال نشده است',
            'timeline-final-email-desc-sent' => 'ایمیل نتیجه نهایی به مشتری تحویل شد.',
            'timeline-final-email-desc-pending' => 'ایمیل تأییدیه نهایی هنوز ارسال نشده است.',
            'timeline-declined' => 'رد شده توسط مدیر',
            'timeline-declined-desc' => 'انصراف توسط :name رد شد.',
            'timeline-declined-desc-system' => 'درخواست انصراف رد شد.',
            'timeline-declined-reason-label' => 'دلیل ارائه‌شده:',
            'timeline-refunded' => 'علامت‌گذاری بازپرداخت توسط مدیر',
            'timeline-refunded-desc' => 'بازپرداخت توسط :name صادر شد.',
            'timeline-refunded-desc-system' => 'بازپرداخت صادر شد.',
            'timeline-refunded-note-label' => 'یادداشت مدیر:',
            'timeline-resolution' => 'تصمیم‌گیری',
            'timeline-resolution-desc' => 'در انتظار بررسی و تصمیم مدیر.',
            'timeline-resolution-pending' => 'در انتظار اقدام مدیر',

            'confirmation-sent-at' => 'زمان ارسال تأییدیه',
            'confirmation-error' => 'خطای تأییدیه',
            'declined-at' => 'زمان رد',
            'refunded-at' => 'زمان بازپرداخت',

            'actions' => 'اقدامات',
            'actions-note' => 'بازپرداخت‌ها به‌صورت دستی از طریق ابزارهای سفارش / بازپرداخت / RMA موجود در باگیستو پردازش می‌شوند. از این اقدامات برای ثبت نتیجه در مدارک انصراف استفاده کنید.',
            'resend-confirmation' => 'ارسال مجدد ایمیل تأییدیه',
            'mark-refunded' => 'علامت‌گذاری به‌عنوان بازپرداخت‌شده',
            'refund-note-label' => 'شماره مرجع بازپرداخت (اختیاری)',
            'refund-note-placeholder' => 'مثلاً: بازپرداخت شماره ۱۲۳۴',
            'decline' => 'رد درخواست انصراف',
            'decline-reason-label' => 'دلیل رد',
            'decline-reason-placeholder' => 'دلیل رد استحقاق را توضیح دهید',
            'mark-refunded-confirm-msg' => 'این درخواست انصراف به‌عنوان بازپرداخت‌شده علامت‌گذاری شود؟ هرگونه سابقه رد قبلی پاک خواهد شد.',
            'decline-confirm-msg' => 'این درخواست انصراف رد شود؟ دلیل برای مشتری قابل مشاهده خواهد بود.',
            'resend-confirmation-confirm-msg' => 'ایمیل تأییدیه دوباره به مشتری ارسال شود؟',
            'send-final-confirmation' => 'ارسال ایمیل تأییدیه نهایی',
            'send-final-confirmation-confirm-msg' => 'ایمیل وضعیت نهایی برای مشتری ارسال شود؟',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'کانال',
            'status' => 'وضعیت',
            'confirmation-sent-at' => 'تأییدیه ارسال شد',
            'view' => 'مشاهده',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'ایمیل تأییدیه دوباره ارسال شد.',
            'confirmation-failed' => 'ارسال ایمیل تأییدیه ممکن نشد. برای جزئیات به سیر زمانی مراجعه کنید.',
        ],
    ],
];
