    ...
    'eu_withdrawal' => [
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'فعال‌سازی دکمه انصراف از قرارداد',
            ...
            'notifications' => [
                'title' => 'اعلان‌ها',
                'info' => 'بازنویسی آدرس فرستنده ایمیل برای تأییدیه‌های انصراف.',
                'sender_email' => 'ایمیل فرستنده',
                'sender_email_info' => 'اختیاری. در صورت خالی بودن، از فرستنده پیش‌فرض سیستم استفاده می‌شود.',
            ],
        ],
