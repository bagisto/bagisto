        ...
        'index' => [
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'product-view-page' => [
                        'allow-overlapping-booking-time-slots' => 'Дозволити перекриття часових слотів бронювання',
                        'allow-no-of-up-sells-products'        => 'Дозволена кількість товарів для додаткових продажів',
                        'allow-no-of-related-products'         => 'Дозволена кількість пов’язаних товарів',
                        'title'                                => 'Налаштування сторінки перегляду товару',
                        'title-info'                           => 'Налаштування сторінки перегляду товару включає регулювання макета й елементів на сторінці відображення товару, покращення користувацького досвіду та подання інформації, а також управління перекриттям часових слотів бронювання для визначення, чи вони дозволені чи заборонені.',
                    ],
