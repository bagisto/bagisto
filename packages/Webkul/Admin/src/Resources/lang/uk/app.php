            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'api-key' => 'Ключ API',
                        'api-key-info' => 'Використовується замість імені користувача та пароля. Його зазначення перемикає підключення на автентифікацію за ключем API.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Для Elastic Cloud. Його зазначення перемикає підключення на Elastic Cloud у парі з ключем API.',
