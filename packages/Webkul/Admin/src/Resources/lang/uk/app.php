...
return [
                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'Розділяйте розширення комами, наприклад jpg, png, pdf. Вебсторінки, зображення SVG, файли XML і скрипти ніколи не приймаються, навіть якщо вони вказані тут.',
                                'title' => 'Опція',
                                'type' => 'Тип',
                                'yes' => 'Так',
                            ],
    ...
    'settings' => [
        ...
        'exchange-rates' => [
            'index' => [
                ...
                'update-rates-error' => 'Не вдалося оновити курси валют. Або сервіс курсів валют недоступний, або його API-ключ не налаштовано.',
        ...
        'index' => [
            'about' => [
                ...
                'general' => [
                    ...
                    'statuses' => [
                        ...
                        'misconfigured' => 'Налаштовано неправильно',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'title' => 'Назва',
                    'webhook-secret' => 'Секрет підпису вебхука',
                    'webhook-secret-info' => 'Секрет підпису вебхука, доданого в панелі Stripe для адреси магазину з /stripe/webhook у кінці, з подіями: checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. Лише для робочого режиму.',
                    'webhook-test-secret' => 'Тестовий секрет підпису вебхука',
                    'webhook-test-secret-info' => 'Секрет підпису вебхука, доданого в панелі Stripe для адреси магазину з /stripe/webhook у кінці, з подіями: checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. Лише для тестового режиму.',
                ],
                ...
                'checkout' => [
                    ...
                    'info' => 'Оформлення без реєстрації, сторінка кошика та міні-кошик.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Показувати міні-кошик, лічильник товарів у ньому та текст пропозиції всередині.',
            ...
            'search-engines' => [
                'title' => 'Пошукові рушії',
                'info' => 'Виберіть рушій, що забезпечує пошук товарів, і налаштуйте його.',
                ...
                'test-connection' => [
                    ...
                    'statuses' => [
                        'available' => ':engine доступний',
                        'unreachable' => ':engine не відповів',
                        'unauthorized' => ':engine відхилив облікові дані',
                        'incompatible' => 'Вузол відповів, але не є підтримуваним сервером :engine',
                        'misconfigured' => 'Підключення до :engine не налаштовано',
                    ],
                ],

                'general' => [
                    'title' => 'Загальні',
                    'info' => 'Рушій, на якому працює пошук товарів.',

                    'settings' => [
                        'title' => 'Налаштування',
                        'info' => 'Увімкніть зовнішній пошуковий рушій і виберіть, де він використовується.',
                        'enabled' => 'Увімкнути зовнішній пошуковий рушій',
                        'enabled-info' => 'Вимкніть, щоб усюди шукати в базі даних, незалежно від налаштувань нижче.',
                        'engine' => 'Пошуковий рушій за замовчуванням',
                        'engine-info' => 'Рушій, що застосовується всюди, де режим пошуку залишено на «Використовувати за замовчуванням».',
                        'inherit' => 'Використовувати за замовчуванням',
                    ],

                    'products' => [
                        'title' => 'Товари',
                        'info' => 'Яким рушієм кожна сторона магазину шукає товари.',
                        'admin-mode' => 'Режим пошуку в панелі адміністратора',
                        'admin-mode-info' => 'Рушій, що забезпечує мега-пошук, таблиці даних та решту пошуку в панелі адміністратора.',
                        'storefront-mode' => 'Режим пошуку в магазині',
                        'storefront-mode-info' => 'Рушій, що забезпечує сторінки категорій, сторінку пошуку та решту пошуку в магазині.',
                    ],
                ],

                'elastic' => [
                    'info' => 'Стан підключення та обмеження запитів для Elasticsearch.',

                    'settings' => [
                        'title' => 'Налаштування',
                        'info' => 'Використовується, коли режим пошуку встановлено на Elasticsearch.',
                        'auth-type' => 'Автентифікація',
                        'auth-type-info' => 'Як виконується підключення до кластера та вхід. Показано лише потрібні поля.',

                        'auth-types' => [
                            'none' => 'Без автентифікації',
                            'basic' => 'Ім’я користувача та пароль',
                            'api-key' => 'Ключ API',
                            'cloud-api-key' => 'Elastic Cloud із ключем API',
                            'cloud-basic' => 'Elastic Cloud з ім’ям користувача та паролем',
                        ],

                        'hosts' => 'Хости',
                        'hosts-info' => 'Де доступний кластер, наприклад http://localhost:9200. Кілька хостів розділяйте комою. Залиште порожнім, щоб використати файл середовища.',
                        'username' => 'Ім\'я користувача',
                        'username-info' => 'Використовується за базової автентифікації. Залиште порожнім, якщо кластер її не вимагає.',
                        'password' => 'Пароль',
                        'password-info' => 'Пароль, пов\'язаний з ім\'ям користувача.',
                        'api-key' => 'Ключ API',
                        'api-key-info' => 'Ключ, яким виконується вхід у кластер.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Cloud ID розгортання Elastic Cloud.',
                        'index-prefix' => 'Префікс індексу',
                        'index-prefix-info' => 'Додається перед кожною назвою індексу, щоб кілька магазинів могли використовувати один кластер.',
                        'min-query-length' => 'Мінімальна довжина запиту',
                        'min-query-length-info' => 'Найкоротший пошуковий запит, який приймає поле пошуку магазину.',
                        'max-query-length' => 'Максимальна довжина запиту',
                        'max-query-length-info' => 'Найдовший пошуковий запит, який приймає поле пошуку магазину.',
            ...
            'file-management' => [
                ...
                'info' => 'Виберіть, де зберігаються завантажені файли, і налаштуйте службу зберігання.',

                'general' => [
                    'title' => 'Загальні',
                    'info' => 'Сховище, яке весь магазин використовує для завантажених файлів.',

                    'settings' => [
                        'title' => 'Налаштування',
                        'info' => 'Виберіть сховище, у яке зберігаються файли та з якого вони віддаються.',
                        'default-driver' => 'Драйвер сховища за замовчуванням',
                        'default-driver-info' => 'Файли, завантажені відтепер, зберігатимуться тут. Раніше завантажені файли залишаються в попередньому сховищі, тож скопіюйте їх перед перемиканням, інакше їх не буде знайдено.',

                        'drivers' => [
                            'local' => 'Файл (локальне сховище)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Облікові дані для Amazon S3 або будь-якої служби, сумісної з його API.',

                    'settings' => [
                        'title' => 'Налаштування',
                        'info' => 'Використовуються, коли драйвером сховища за замовчуванням є Amazon S3.',
                        'key' => 'Ідентифікатор ключа доступу',
                        'key-info' => 'Ідентифікатор ключа доступу облікового запису, якому належить бакет.',
                        'secret' => 'Секретний ключ доступу',
                        'secret-info' => 'Секрет, що відповідає ідентифікатору ключа доступу.',
                        'region' => 'Регіон',
                        'region-info' => 'Регіон, у якому створено бакет, наприклад us-east-1.',
                        'bucket' => 'Бакет',
                        'bucket-info' => 'Назва бакета, у якому зберігаються файли.',
                        'url' => 'URL',
                        'url-info' => 'Адреса, з якої віддаються файли. Залиште порожнім, щоб використати адресу, яку надає служба.',
                        'endpoint' => 'Кінцева точка',
                        'endpoint-info' => 'Потрібна лише для служби, відмінної від Amazon S3, наприклад розміщеної на власному сервері. Для Amazon S3 залиште порожнім.',
                        'use-path-style-endpoint' => 'Використовувати кінцеву точку зі шляхом',
                        'use-path-style-endpoint-info' => 'Увімкніть для власної служби, яка адресує бакети як шлях, а не як піддомен.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Облікові дані для об\'єктного сховища Cloudflare R2.',

                    'settings' => [
                        'title' => 'Налаштування',
                        'info' => 'Використовуються, коли драйвером сховища за замовчуванням є Cloudflare R2.',
                        'account-id' => 'Ідентифікатор облікового запису',
                        'account-id-info' => 'Обліковий запис Cloudflare, якому належить бакет. Адреса R2 будується на його основі, тому кінцева точка не потрібна.',
                        'key' => 'Ідентифікатор ключа доступу',
                        'key-info' => 'Ідентифікатор ключа доступу токена API R2.',
                        'secret' => 'Секретний ключ доступу',
                        'secret-info' => 'Секрет, що відповідає ідентифікатору ключа доступу.',
                        'bucket' => 'Бакет',
                        'bucket-info' => 'Назва бакета R2, у якому зберігаються файли.',
                        'url' => 'Публічна URL-адреса',
                        'url-info' => 'Адреса, з якої віддаються файли: публічна адреса бакета або власний домен. Бакет R2 залишається приватним, доки адресу не встановлено, без неї файли будуть недоступні.',
                    ],
                ],
            ],
    ...
    'components' => [
        ...
        'datagrid' => [
            'index' => [
                'action-error' => 'Щось пішло не так',
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'Відмови від договору (ЄС)',
        ],
        ...
        'acl' => [
            ...
            'view' => 'Перегляд',
            'decline' => 'Відхилити',
            'mark-refunded' => 'Позначити як повернено',
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Увімкнути',
                'enabled-info' => 'Коли увімкнено, клієнти цього каналу бачать кнопку «Відмовитися від договору» на сторінках з деталями замовлення та публічну форму пошуку за адресою /withdraw. Вмикайте лише на каналах, що продають споживачам у ЄС.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Доказ',
            'evidence-note' => 'Незмінний — зафіксовано в момент подання',
            'status' => 'Статус',
            ...
            'timeline' => 'Хронологія',
            'timeline-received' => 'Заяву отримано',
            'timeline-received-desc' => 'Клієнт подав заяву про відмову від договору.',
            'timeline-email' => 'Лист-підтвердження',
            'timeline-email-pending' => 'Ще не надіслано',
            'timeline-initial-email' => 'Перший лист-підтвердження',
            'timeline-initial-email-desc-sent' => 'Лист-підтвердження доставлено клієнту.',
            'timeline-initial-email-desc-error' => 'Не вдалося надіслати перший лист-підтвердження.',
            'timeline-initial-email-desc-pending' => 'Перший лист-підтвердження ще не надіслано.',
            'timeline-final-email' => 'Підсумковий лист-підтвердження',
            'timeline-final-email-pending' => 'Ще не надіслано',
            'timeline-final-email-desc-sent' => 'Підсумковий лист доставлено клієнту.',
            'timeline-final-email-desc-pending' => 'Підсумковий лист-підтвердження ще не надіслано.',
            'timeline-declined' => 'Відхилено адміністратором',
            'timeline-declined-desc' => 'Відмову відхилено: :name.',
            'timeline-declined-desc-system' => 'Відмову відхилено.',
            'timeline-declined-reason-label' => 'Зазначена причина:',
            'timeline-refunded' => 'Позначено як повернено адміністратором',
            'timeline-refunded-desc' => 'Повернення оформлено: :name.',
            'timeline-refunded-desc-system' => 'Повернення оформлено.',
            'timeline-refunded-note-label' => 'Примітка адміністратора:',
            'timeline-resolution' => 'Розгляд',
            'timeline-resolution-desc' => 'Очікує розгляду та рішення адміністратора.',
            'timeline-resolution-pending' => 'Очікує дії адміністратора',

            'confirmation-sent-at' => 'Підтвердження надіслано',
            'confirmation-error' => 'Помилка підтвердження',
            'declined-at' => 'Відхилено',
            'refunded-at' => 'Повернено',

            'actions' => 'Дії',
            'actions-note' => 'Повернення обробляються вручну за допомогою наявних інструментів Bagisto: замовлень, повернень та RMA. Скористайтеся цими діями, щоб зафіксувати результат у матеріалах про відмову від договору.',
            'resend-confirmation' => 'Надіслати лист-підтвердження повторно',
            'mark-refunded' => 'Позначити як повернено',
            'refund-note-label' => 'Номер повернення (необов’язково)',
            'refund-note-placeholder' => 'напр., Повернення №1234',
            'decline' => 'Відхилити відмову',
            'decline-reason-label' => 'Причина відхилення',
            'decline-reason-placeholder' => 'Поясніть, чому право оспорюється',
            'mark-refunded-confirm-msg' => 'Позначити цю відмову як повернену? Попередній запис про відхилення буде видалено.',
            'decline-confirm-msg' => 'Відхилити цю відмову? Причина буде видимою для клієнта.',
            'resend-confirmation-confirm-msg' => 'Надіслати клієнту лист-підтвердження повторно?',
            'send-final-confirmation' => 'Надіслати підсумковий лист-підтвердження',
            'send-final-confirmation-confirm-msg' => 'Надіслати клієнту підсумковий лист зі статусом?',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'Лист-підтвердження надіслано повторно.',
            'confirmation-failed' => 'Не вдалося надіслати лист-підтвердження. Подробиці див. у хронології.',
        ],
    ],
];
