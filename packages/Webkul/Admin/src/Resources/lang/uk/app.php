...
return [
    ...
    'dashboard' => [
        'index' => [
            ...
            'product-info'                => 'Додати пов язані продукти на льоту.',
            'revenue'                     => 'Дохід :total',
    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'per-unit'              => 'За одиницю',
                'quantity'              => 'Кількість',
                'qty-to-invoiced'       => 'Кількість для виставлення рахунка',
                'refunded'              => 'Повернуто',
        ...
        'invoices' => [
            ...
            'create'   => [
                'creation-error' => 'Створення рахунку замовлення не допускається.',
                'create-success' => 'Рахунок створено успішно',
                'invalid-qty'    => 'Ми виявили недійсну кількість для елементів рахунку.',
                'product-error'  => 'Рахунок не може бути створено без продуктів.',
            ],
    ...
    'catalog' => [
        'products' => [
            ...
            'edit' => [
                ...
                'links' => [
                    'related-products' => [
                        'empty-info' => 'Додати пов’язані товари на ходу.',
                        'info'       => 'Покупцеві, який переглядає товар, також пропонуються пов’язані товари.',
                        'title'      => 'Пов’язані товари',
                    ],

                    'up-sells' => [
                        'empty-info' => 'Додати товари для збільшення продажів на ходу.',
                    ...
                    'cross-sells' => [
                        'empty-info' => 'Додати товари для перекресних продажів на ходу.',
        ...
        'categories' => [
            ...
            'delete-category-root' => 'Кореневу категорію :name неможливо видалити.',
            'delete-failed'        => 'Не вдалося видалити категорію :name',
        ],
    ...
    'customers' => [
        'customers' => [
            ...
            'view' => [
                ...
                'delete-confirmation'    => 'Ви впевнені, що хочете видалити цей обліковий запис?',
            ],
        ],
    ...
    'settings' => [
        ...
        'users' => [
            'index' => [
                ...
                'cannot-change'      => 'Не вдається змінити користувача',
                'delete-failed'      => 'Видалення користувача не вдалося.',
                'delete-success'     => 'Користувача успішно видалено.',
                'incorrect-password' => 'Неправильний пароль',
                'last-delete-error'  => 'Не вдалося видалити останнього користувача',
                'login-error'        => 'Перевірте ваші дані для входу і спробуйте ще раз.',
        ...
        'themes' => [
            ...
            'create' => [
                ...
                'product-carousel-description'   => 'Елегантний динамічний та адаптивний карусель продуктів.',
                'category-carousel-description'  => 'Привабливий адаптивний карусель категорій для відображення динамічних категорій.',
                'static-content-description'     => 'Покращуйте залучення аудиторії інформативними статичними матеріалами.',
                'footer-link-description'        => 'Навігація за допомогою посилань у підвалі для безшовного дослідження інформації на веб-сайті.',
            ...
            'update-success' => 'Тему оновлено успішно',
            'delete-success' => 'Тему видалено успішно',
        ],
    ],
    ...
    'configuration' => [
        'index' => [
            'delete'                       => 'Видалити',
            'enable-at-least-one-shipping' => 'Увімкніть принаймні один метод доставки.',
            'enable-at-least-one-payment'  => 'Увімкніть принаймні один метод оплати.',
            'save-btn'                     => 'Зберегти налаштування',
            'save-message'                 => 'Налаштування успішно збережено',
            'title'                        => 'Налаштування',

            'general' => [
                'info'  => 'Встановити параметри одиниць.',
                'title' => 'Загальні',
                ...
                'general' => [
                    ...
                    'unit-options' => [
                        ...
                        'title-info'        => 'Розмір, колір, матеріал, настроювання, збільшення задоволеності клієнтів і настроювання покупок.',
                        'weight-unit'       => 'Одиниця ваги',
                    ],
                ],

                'content' => [
                    'info'  => 'Встановити параметри порівняння, параметри бажань, параметри пошуку за зображенням, нижню панель, переключатель нижньої панелі та настроювання власних скриптів.',
                    'title' => 'Зміст',

                    'settings' => [
                        'compare-options'     => 'Параметри порівняння',
                        'image-search-option' => 'Параметр пошуку зображення',
                        'title'               => 'Налаштування',
                        'title-info'          => 'Налаштування вказують на конфігуровані вибори, які контролюють, як система, програма або пристрій поводяться, адаптовані до вимог і вимог користувача.',
                        'wishlist-options'    => 'Параметри бажань',
                    ],
                    ...
                    'custom-scripts' => [
                        ...
                        'title-info'        => 'Власні сценарії - це персоналізовані фрагменти коду, створені для додавання конкретних функцій або можливостей до програмного забезпечення, які підвищують його можливості.',
                    ],
                ],

                'design' => [
                    'info'  => 'Встановити логотип і значок фавікону.',
                    'title' => 'Дизайн',
                    ...
                    'admin-logo' => [
                        ...
                        'title-info'      => 'Логотип адміністратора - це характерне зображення або емблема, яка представляє інтерфейс адміністрування системи або веб-сайту, часто настроюється.',
                    ],
                ],
            ],
            ...
            'catalog' => [
                ...
                'inventory' => [
                    'title'              => 'Облік',
                    'info'               => 'Встановіть умови попередніх замовлень',
                    'stock-options'      => 'Параметри залишків',
                    'stock-options-info' => 'Параметри залишків - це інвестиційні контракти, які надають право купувати або продавати акції компанії за попередньо визначеною ціною, впливаючи на потенційний прибуток.',
                    'allow-back-orders'  => 'Дозволити попередні замовлення',
                ],

                'products' => [
                    'title'                              => 'Товари',
                    'info'                               => 'Встановіть опції гостьового замовлення, головної сторінки, сторінки перегляду товару, сторінки кошика, магазину, відгуків та обміну в соціальних мережах.',
                    'guest-checkout'                     => 'Гостьове замовлення',
                    'guest-checkout-info'                => 'Гостьове оформлення дозволяє клієнтам купувати товари без створення облікового запису, спрощуючи процес покупки для зручності та швидших трансакцій.',
                    'allow-guest-checkout'               => 'Дозволити гостьове оформлення',
                    'allow-guest-checkout-hint'          => 'Підказка: якщо включено, цю опцію можна налаштувати окремо для кожного товару.',
                    'attribute'                          => 'Атрибут',
                    'homepage'                           => 'Налаштування головної сторінки',
                    'homepage-info'                      => 'Налаштування головної сторінки включає в себе налаштування макету, вмісту та дизайну головної сторінки веб-сайту для ефективного представлення необхідної інформації.',
                    'allow-no-of-new-products'           => 'Дозволена кількість нових товарів на головній сторінці',
                    'allow-no-of-featured-products'      => 'Дозволена кількість популярних товарів на головній сторінці',
                    'allow-no-of-related-products'       => 'Дозволена кількість схожих товарів',
                    'allow-no-of-up-sells-products'      => 'Дозволена кількість товарів для збільшення продажів',
                    'allow-no-of-cross-sells-products'   => 'Дозволена кількість товарів для перепродажу',
                    'product-view-page'                  => 'Налаштування сторінки перегляду товару',
                    'product-view-page-info'             => 'Налаштування сторінки перегляду товару передбачає налаштування макету та елементів на сторінці відображення товару, покращуючи взаємодію користувача та подання інформації.',
                    'cart-view-page'                     => 'Налаштування сторінки кошика',
                    'cart-view-page-info'                => 'Налаштування сторінки кошика передбачає розташування товарів, деталей та опцій на сторінці кошика для поліпшення взаємодії користувача та процесу покупок.',
                    'storefront'                         => 'Магазин',
                    'storefront-info'                    => 'Магазин - це інтерфейс для клієнтів онлайн-магазину, де представлені товари, категорії та навігація для безперебійного досвіду покупок.',
                    ...
                    'cache-small-image'                  => 'Зображення маленького розміру',
                    'cache-small-image-info'             => 'Зображення маленького розміру призначені для відображення на сторінці товару.',
                    'width'                              => 'Ширина',
                    'height'                             => 'Висота',
                    'cache-medium-image'                 => 'Зображення середнього розміру',
                    'cache-medium-image-info'            => 'Зображення середнього розміру - це міжнародні оптимальні розміри зображень, які відображаються на сторінці товару.',
                    'cache-large-image'                  => 'Зображення великого розміру',
                    'cache-large-image-info'             => 'Зображення великого розміру - це великі зображення з високим роздільним здатністю для показу товарів або графіки.',
                    'review'                             => 'Відгук',
                    'review-info'                        => 'Оцінка або аналіз чогось, часто із зазначенням думок та відгуків.',
                    'allow-guest-review'                 => 'Дозволити гостьові відгуки',
                    'attribute-info'                     => 'Характеристика або властивість, яка визначає об\'єкт і впливає на його поведінку, вигляд або функцію.',
                    'image-upload-size'                  => 'Дозволений розмір завантажуваних зображень (в Кб)',
                    'file-upload-size'                   => 'Дозволений розмір завантажуваних файлів (в Кб)',
                    'comma-separated'                    => 'Розділяються комами',
                ],

                'rich-snippets' => [
                    'title'                     => 'Багатофункціональні витяжки',
                    'info'                      => 'Встановіть параметри для товарів та категорій.',
                    'products'                  => 'Товари',
                    'rich-snippet-product-info' => 'Товари, доступні для покупки або використання, які пропонуються бізнесом або продавцем.',
                    'enable'                    => 'Увімкнути',
                    ...
                    'categories'                => 'Категорії',
                    'categories-info'           => '"Категорії" відносяться до груп або класифікацій, які допомагають організовувати схожі товари або предмети разом для полегшення перегляду та навігації.',
            ...
            'customer' => [
                ...
                'address' => [
                    'title'              => 'Адреса',
                    'info'               => 'Налаштування країни, області, поштового індексу та вулиці.',
                    'requirements'       => 'Вимоги',
                    'requirements-info'  => 'Вимоги - це умови, функції або специфікації, необхідні для успішного виконання, досягнення чи задоволення чогось.',
                    'country'            => 'Країна',
                    'state'              => 'Область',
                    'zip'                => 'Поштовий індекс',
                    'city'               => 'Місто',
                    'information'        => 'Інформація',
                    'information-info'   => '"Лінії в адресі вулиці" вказують на окремі сегменти адреси, часто розділені комами, надаючи інформацію про розташування, таку як номер будинку, вулиця, місто та інше.',
                    'street-lines'       => 'Лінії в адресі вулиці',
                ],

                'settings' => [
                    'title'                   => 'Налаштування',
                    'settings-info'           => 'Налаштування списку бажань, підписки на новини, підтвердження електронної пошти та соціального входу.',
                    'wishlist'                => 'Список бажань',
                    'wishlist-info'           => '"Список бажань" - це персональна колекція бажаних товарів, яка дозволяє користувачам зберігати товари для подальшої референції чи можливої покупки.',
                    'wishlist-share'          => 'Увімкнути обмін',
                    'newsletter'              => 'Підписка на новини',
                    'newsletter-info'         => '"Інформація про новини" містить оновлення, пропозиції чи контент, що регулярно надсилається через електронну пошту підписникам, щоб інформувати та залучати їх.',
                    'newsletter-subscription' => 'Дозволити підписку на новини',
                    'email'                   => 'Підтвердження електронної пошти',
                    'email-info'              => '"Підтвердження електронної пошти" підтверджує достовірність електронної адреси, часто за допомогою відправлення посилання для підтвердження, покращуючи безпеку облікового запису та надійність комунікації.',
            ...
            'email' => [
                ...
                'email-settings' => [
                    ...
                    'info'                   => 'Налаштування імені відправника електронної пошти, адреси електронної пошти магазину, імені адміністратора та адреси електронної пошти адміністратора.',
                    ...
                    'shop-email-from-tip'    => 'Адреса електронної пошти цього каналу для відправлення електронної пошти вашим клієнтам',
                    'admin-name'             => 'Ім\'я адміністратора',
                    'admin-name-tip'         => 'Це ім "я буде відображатися в усіх адміністративних листах"',
                    'admin-email'            => 'Адреса електронної пошти адміністратора',
                    'admin-email-tip'        => 'Адреса електронної пошти адміністратора для цього каналу для отримання листів',
                    'admin-page-limit'       => 'Кількість товарів за замовчуванням (Адміністратор)',
                ],

                'notifications' => [
                    'title'                                            => 'Сповіщення',
                    'info'                                             => '"Сповіщення" - це повідомлення або сповіщення, яке інформує користувачів про події, оновлення чи дії, покращуючи залученість та свідомість користувача.',
                    'verification'                                     => 'Надсилати лист з підтвердженням після реєстрації клієнта',
                    'registration'                                     => 'Надсилати лист з підтвердженням після реєстрації клієнта',
                    'customer-registration-confirmation-mail-to-admin' => 'Надсилати лист з підтвердженням реєстрації клієнта адміністратору після реєстрації',
                    'customer'                                         => 'Надсилати облікові дані клієнта після реєстрації',
                    'new-order'                                        => 'Надсилати лист з підтвердженням клієнту після розміщення нового замовлення',
                    'new-admin'                                        => 'Надсилати лист з підтвердженням адміністратору після розміщення нового замовлення',
                    'new-invoice'                                      => 'Надсилати лист з повідомленням клієнту після створення нового рахунка',
                    'new-refund'                                       => 'Надсилати лист з повідомленням клієнту після створення повернення коштів',
                    'new-shipment'                                     => 'Надсилати лист з повідомленням клієнту після створення відправлення',
                    'new-inventory-source'                             => 'Надсилати лист з повідомленням інвентарному джерелу після створення відправлення',
                    'cancel-order'                                     => 'Надсилати лист з повідомленням про скасування замовлення',
                ],
            ],
            ...
            'sales' => [
                ...
                'shipping' => [
                    'title'          => 'Доставка',
                    'info'           => 'Налаштування інформації про доставку.',
                    'origin'         => 'Місце походження',
                    'origin-info'    => 'Місце походження доставки - це місце, де товари або продукти походять перед транспортуванням на їхню кінцеву точку призначення.',
                    'country'        => 'Країна',
                    'state'          => 'Область',
                    'zip'            => 'Поштовий індекс',
                    'city'           => 'Місто',
                ...
                'shipping-methods' => [
                    'page-title'                => 'Способи доставки',
                    'info'                      => 'Налаштування інформації про способи доставки',
                    'free-shipping'             => 'Безкоштовна доставка',
                    'free-shipping-info'        => '"Безкоштовна доставка" - це спосіб доставки, при якому вартість доставки відміняється, і продавець покриває витрати на доставку товарів покупцю.',
                    'flat-rate-shipping'        => 'Доставка за фіксованою ставкою',
                    'flat-rate-shipping-info'   => 'Доставка за фіксованою ставкою - це спосіб доставки, при якому стягується фіксована плата за доставку, незалежно від ваги, розміру чи відстані пакета. Це спрощує вартість доставки і може бути вигідним для обох сторін - покупця і продавця.',
                    'title'                     => 'Назва',
                    'description'               => 'Опис',
                    'rate'                      => 'Ставка',
                    'status'                    => 'Статус',
                ...
                'payment-methods' => [
                    ...
                    'info'                           => 'Налаштування інформації про способи оплати',
                    'cash-on-delivery'               => 'Оплата при отриманні',
                    'cash-on-delivery-info'          => 'Спосіб оплати, при якому клієнти сплачують готівкою при отриманні товарів або послуг на порозі свого дому.',
                    'description'                    => 'Опис',
                    'title'                          => 'Назва',
                    'instructions'                   => 'Інструкції',
                    'generate-invoice'               => 'Автоматично створювати рахунок після розміщення замовлення',
                    'set-invoice-status'             => 'Встановити статус рахунку після його створення на',
                    'generate-invoice-applicable'    => 'Застосовується, якщо автоматичне створення рахунку включено',
                    'status'                         => 'Статус',
                    'sort-order'                     => 'Порядок сортування',
                    ...
                    'money-transfer-info'            => 'Передача коштів від однієї особи чи рахунку іншій, часто електронно, за різними цілями, такими як транзакції чи перекази.',
                    'mailing-address'                => 'Адреса для надсилання чеку',
                    'paypal-standard'                => 'PayPal Standard',
                    'paypal-standard-info'           => 'PayPal Standard - це базовий варіант платежів PayPal для онлайн-бізнесів, який дозволяє клієнтам платити за допомогою свого облікового запису PayPal чи кредитних/дебетових карт.',
                    'paypal-smart-button'            => 'PayPal',
                    'paypal-smart-button-info'       => 'PayPal Smart Button: Спрощує онлайн-платежі за допомогою налаштовуваних кнопок для безпечних та багатоканальних транзакцій на веб-сайтах та додатках.',
                    'client-id'                      => 'Ідентифікатор клієнта',
                    'client-id-info'                 => 'Використовуйте "sb" для тестування.',
                    'client-secret'                  => 'Секрет клієнта',
                    'client-secret-info'             => 'Додайте секретний ключ сюди',
                ...
                'order-settings' => [
                    ...
                    'info'                          => 'Налаштування номерів замовлення та мінімальних замовлень.',
                    'order-number'                  => 'Налаштування номерів замовлення',
                    'order-number-info'             => 'Унікальний ідентифікатор, призначений певному замовленню клієнта, який допомагає в слідкуванні, спілкуванні та посиланні на протязі всього процесу покупки.',
                    ...
                    'order-number-generator-class'  => 'Генератор номера замовлення',
                    'minimum-order'                 => 'Налаштування мінімального замовлення',
                    'minimum-order-info'            => 'Налаштовані критерії, що визначають мінімальну необхідну кількість або вартість для обробки замовлення чи отримання певних переваг.',
                    'minimum-order-amount'          => 'Мінімальна сума замовлення',
                ],

                'invoice-settings' => [
                    'title'                            => 'Налаштування рахунку-фактури',
                    'info'                             => 'Налаштування номера рахунку-фактури, умов оплати, дизайну рахунку-фактури та нагадувань про рахунок-фактуру.',
                    'invoice-number'                   => 'Налаштування номерів рахунку-фактури',
                    'invoice-number-info'              => 'Конфігурація правил чи параметрів для генерації та призначення унікальних ідентифікаційних номерів рахунків-фактур для організаційних та слідкових цілей.',
                    'invoice-number-prefix'            => 'Префікс номера рахунку-фактури',
                    'invoice-number-length'            => 'Довжина номера рахунку-фактури',
                    'invoice-number-suffix'            => 'Суфікс номера рахунку-фактури',
                    'invoice-number-generator-class'   => 'Генератор номера рахунку-фактури',
                    'payment-terms'                    => 'Умови оплати',
                    'payment-terms-info'               => 'Узгоджені умови, які визначають, коли і як оплата за товари чи послуги повинна бути здійснена покупцем продавцю.',
                    'due-duration'                     => 'Тривалість сплати',
                    'due-duration-day'                 => ':due-duration день',
                    'due-duration-days'                => ':due-duration днів',
                    'invoice-slip-design'              => 'Дизайн рахунку-фактури',
                    'invoice-slip-design-info'         => 'Візуальне оформлення та форматування рахунку-фактури, включаючи брендування компанії, розбиття на позиції, ціни та деталі оплати для професійного представлення.',
                    'logo'                             => 'Логотип',
                    'default'                          => 'За замовчуванням',
                    'invoice-reminders'                => 'Нагадування про рахунок-фактуру',
                    'invoice-reminders-info'           => 'Автоматизовані повідомлення чи комунікації, надсилані клієнтам для нагадування їм про надходження або прострочення платежів за рахунками-фактурами.',
