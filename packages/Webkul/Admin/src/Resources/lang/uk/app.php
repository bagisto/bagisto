    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp-settings' => [
                    'info' => 'Налаштуйте параметри SMTP для надсилання електронних листів для цього каналу.',
                    'smtp-enable' => 'Увімкнути власний SMTP',
                    'smtp-enable-info' => 'Увімкніть або вимкніть використання власних налаштувань SMTP для надсилання електронних листів з цього каналу.',
                    'smtp-encryption' => 'Шифрування',
                    'smtp-encryption-info' => 'Оберіть метод шифрування для захисту електронної пошти. Доступні варіанти: TLS, SSL або Немає.',
                    'smtp-host' => 'SMTP-хост',
                    'smtp-host-info' => 'Адреса SMTP-сервера, що використовується для надсилання електронних листів. Це може бути IP-адреса або доменне ім’я.',
                    'smtp-password' => 'Пароль SMTP',
                    'smtp-password-info' => 'Пароль, пов’язаний з ім’ям користувача SMTP для автентифікації на поштовому сервері.',
                    'smtp-port' => 'SMTP-порт',
                    'smtp-port-info' => 'Номер порту, що використовується для SMTP-з’єднання. Типові порти: 25, 465 (SSL) і 587 (TLS).',
                    'smtp-username' => 'Ім’я користувача SMTP',
                    'smtp-username-info' => 'Ім’я користувача для автентифікації на SMTP-сервері, зазвичай це електронна адреса або спеціальне ім’я користувача, надане поштовим сервісом.',
