        ...
        'index' => [
            ...
            'gdpr' => [
                ...
                'cookie' => [
                    ...
                    'center'       => 'центр',
                    'description'  => 'опис',
                    'enable'       => 'увімкнути сповіщення про cookie',
                    'identifier'   => 'ідентифікатор статичного блоку',
                    'info'         => 'налаштування повідомлення cookie',
                    'position'     => 'позиція відображення блоку cookie',
                    'title'        => 'налаштування повідомлення cookie',
