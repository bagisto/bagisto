...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'disabled_message' => 'Двофакторна автентифікація наразі вимкнена адміністратором.',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'Ключ API',
                    'api_publishable_key'            => 'Публічний ключ API',
                    'api_test_key'                   => 'Тестовий секретний ключ API',
                    'api_test_publishable_key'       => 'Тестовий публічний ключ API',
                    'applicable-production'          => 'Застосовується, якщо вибрано режим виробництва',
                    'applicable-sandbox'             => 'Застосовується, якщо вибрано тестовий режим',
                    'application_fee'                => 'Платник комісії за додаток',
                    ...
                    'paid'                           => 'Оплачено',
                    'payment-method-info'            => 'Опція оплати Stripe для онлайн-бізнесу, що дозволяє клієнтам оплачувати картками.',
                    ...
                    'sort-order'                     => 'Порядок сортування',
                    'statement_descriptor'           => 'Опис виписки',
                    'status'                         => 'Статус',
                    'stripePayment'                  => 'Оплата через Stripe',
                    'stripe_refund'                  => 'Повернення через Stripe',
                    'title'                          => 'Назва',
                ],
