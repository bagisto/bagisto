        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'speculation-rules' => [
                        'info'  => 'Налаштуйте параметри для увімкнення або вимкнення автоматичної логіки спекуляцій.',
                        'title' => 'Правила Спекуляцій',

                        'settings' => [
                            'eagerness'              => 'Рівень Захопленості',
                            'eager'                  => 'Захоплений',
                            'moderate'               => 'Помірний',
                            'conservative'           => 'Консервативний',
                            'eagerness-info'         => 'Контролює, наскільки агресивно застосовуються правила спекуляцій. Варіанти: eager (максимум), moderate (за замовчуванням), conservative (мінімум).',
                            'ignore-url-params'      => 'Ігнорувати Параметри URL',
                            'ignore-url-params-info' => 'Вкажіть параметри URL, які потрібно ігнорувати в правилах спекуляцій. Використовуйте символ вертикальної риски (|) для розділення кількох параметрів.',
                            'ignore-urls'            => 'Ігнорувати URL',
                            'ignore-urls-info'       => 'Введіть URL-адреси, які слід виключити з логіки спекуляцій. Розділяйте кілька URL-адрес вертикальною рискою (|).',
                            'info'                   => 'Встановіть статус правил спекуляцій.',
                            'title'                  => 'Увімкнути Правила Спекуляцій',
                        ],
                    ],
