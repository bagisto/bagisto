...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'enter_code'            => 'Введіть 6-значний код із вашого додатку автентифікації, щоб продовжити.',
    ...
    'account' => [
        ...
        'messages' => [
            'enabled_success'  => 'Двофакторна автентифікація успішно увімкнена.',
            'invalid_code'     => 'Невірний код підтвердження.',
            'disabled_success' => 'Двофакторна автентифікація вимкнена.',
            'verified_success' => 'Двофакторна автентифікація успішно підтверджена.',
            'email_failed'     => 'Неможливо надіслати резервні коди',
        ],
        ...
        'setup' => [
            ...
            'code_placeholder' => 'Введіть 6-значний код',
            'back'             => 'Назад',
            'verify_enable'    => 'Перевірити & Увімкнути',
        ],
    ],
