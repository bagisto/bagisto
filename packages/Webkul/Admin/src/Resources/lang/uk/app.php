        ...
        'index' => [
            ...
            'general' => [
                'general' => [
                    ...
                    'unit-options'      => 'Параметри одиниць',
                    'unit-options-info' => 'Розмір, колір, матеріал, налаштування, покращення задоволеності клієнтів та налаштування покупок.',
                    'weight-unit'       => 'Одиниця ваги',
                ],
    
                'content' => [
                    'title'               => 'Зміст',
                    'info'                => 'Встановіть параметри порівняння, опції списку бажань, опції пошуку зображень, нижній колонтитул, перемикач нижнього колонтитула та користувацькі скрипти.',
                    'custom-scripts'      => 'Користувацькі скрипти',
                ...
                'design' => [
                    ...
                    'admin-logo-info' => 'Логотип адміністратора - це відмітне зображення або емблема, яка представляє інтерфейс адміністрації системи або веб-сайту, часто налаштовується.',
            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    ...
                    'type'                      => 'Тип',
                    'flat-rate-shipping'        => 'Доставка за фіксованою ставкою',
                    'flat-rate-shipping-info'   => 'Інформація про доставку за фіксованою ставкою',
                ],
