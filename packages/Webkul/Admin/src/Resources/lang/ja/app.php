...
return [
    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'ミニカートと、そこに表示する件数、オファー文を設定します。',
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-types' => [
                            ...
                            'basic' => 'ユーザー名とパスワード',
                            'api-key' => 'API キー',
                            'cloud-api-key' => 'API キーを使用する Elastic Cloud',
                            'cloud-basic' => 'ユーザー名とパスワードを使用する Elastic Cloud',
                        ],
            ...
            'file-management' => [
                'title' => 'ファイル管理',
                'info' => 'アップロードしたファイルの保存先を選び、ストレージサービスを設定します。',

                'general' => [
                    'title' => '一般',
                    'info' => 'ストア全体がアップロードファイルに使用するストレージです。',

                    'settings' => [
                        'title' => '設定',
                        'info' => 'ファイルの保存先と配信元となるストレージを選択します。',
                        'default-driver' => '既定のストレージドライバー',
                        'default-driver-info' => '今後アップロードされるファイルはここに保存されます。すでにアップロード済みのファイルは以前のストレージに残るため、切り替える前にコピーしてください。コピーしないと見つからなくなります。',

                        'drivers' => [
                            'local' => 'ファイル（ローカルストレージ）',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Amazon S3、またはその API に対応したサービスの認証情報です。',

                    'settings' => [
                        'title' => '設定',
                        'info' => '既定のストレージドライバーが Amazon S3 の場合に使用されます。',
                        'key' => 'アクセスキー ID',
                        'key-info' => 'バケットが属するアカウントのアクセスキー ID です。',
                        'secret' => 'シークレットアクセスキー',
                        'secret-info' => 'アクセスキー ID に対応するシークレットです。',
                        'region' => 'リージョン',
                        'region-info' => 'バケットを作成したリージョンです。例: us-east-1。',
                        'bucket' => 'バケット',
                        'bucket-info' => 'ファイルを保存するバケットの名前です。',
                        'url' => 'URL',
                        'url-info' => 'ファイルを配信するアドレスです。空欄にすると、サービスが提供するアドレスを使用します。',
                        'endpoint' => 'エンドポイント',
                        'endpoint-info' => 'セルフホスト型など、Amazon S3 以外のサービスの場合にのみ必要です。Amazon S3 では空欄のままにしてください。',
                        'use-path-style-endpoint' => 'パス形式のエンドポイントを使用',
                        'use-path-style-endpoint-info' => 'バケットをサブドメインではなくパスで指定するセルフホスト型サービスの場合に有効にします。',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Cloudflare R2 オブジェクトストレージの認証情報です。',

                    'settings' => [
                        'title' => '設定',
                        'info' => '既定のストレージドライバーが Cloudflare R2 の場合に使用されます。',
                        'account-id' => 'アカウント ID',
                        'account-id-info' => 'バケットが属する Cloudflare アカウントです。R2 のアドレスはここから組み立てられるため、エンドポイントは不要です。',
                        'key' => 'アクセスキー ID',
                        'key-info' => 'R2 API トークンのアクセスキー ID です。',
                        'secret' => 'シークレットアクセスキー',
                        'secret-info' => 'アクセスキー ID に対応するシークレットです。',
                        'bucket' => 'バケット',
                        'bucket-info' => 'ファイルを保存する R2 バケットの名前です。',
                        'url' => '公開 URL',
                        'url-info' => 'ファイルを配信するアドレスで、バケットの公開アドレスまたは独自ドメインです。R2 バケットは設定するまで非公開のため、指定しないとファイルにアクセスできません。',
                    ],
                ],
            ],
    ...
    'eu-withdrawal' => [
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => '有効化',
                'enabled-info' => '有効にすると、このチャネルの顧客は注文詳細ページに「契約を撤回する」ボタンと、公開の /withdraw 検索フォームが表示されます。EU内の消費者に販売するチャネルでのみ有効にしてください。',
            ],
        ],
        ...
        'view' => [
            ...
            'timeline' => 'タイムライン',
            'timeline-received' => '宣言を受領',
            'timeline-received-desc' => 'お客様が契約撤回の申請を送信しました。',
            'timeline-email' => '確認メール',
            'timeline-email-pending' => '未送信',
            'timeline-initial-email' => '初回確認メール',
            'timeline-initial-email-desc-sent' => '確認メールをお客様に送信しました。',
            'timeline-initial-email-desc-error' => '初回確認メールの送信に失敗しました。',
            'timeline-initial-email-desc-pending' => '初回確認メールはまだ送信されていません。',
            'timeline-final-email' => '最終確認メール',
            'timeline-final-email-pending' => '未送信',
            'timeline-final-email-desc-sent' => '結果通知メールをお客様に送信しました。',
            'timeline-final-email-desc-pending' => '最終確認メールはまだ送信されていません。',
            'timeline-declined' => '管理者により却下',
            'timeline-declined-desc' => ':name により契約撤回が却下されました。',
            'timeline-declined-desc-system' => '契約撤回が却下されました。',
            'timeline-declined-reason-label' => '理由：',
            'timeline-refunded' => '管理者により返金済み',
            'timeline-refunded-desc' => ':name により返金が行われました。',
            'timeline-refunded-desc-system' => '返金が行われました。',
            'timeline-refunded-note-label' => '管理者メモ：',
            'timeline-resolution' => '対応',
            'timeline-resolution-desc' => '管理者の確認と判断を待っています。',
            'timeline-resolution-pending' => '管理者の対応待ち',

            'confirmation-sent-at' => '確認送信日時',
            'confirmation-error' => '確認メールエラー',
            'declined-at' => '却下日時',
            'refunded-at' => '返金日時',

            'actions' => 'アクション',
            'actions-note' => '返金処理は、Bagisto既存の注文／返金／RMA機能で手動で行います。これらのアクションは、契約撤回のエビデンスに結果を記録するために使用します。',
            'resend-confirmation' => '確認メールを再送',
            'mark-refunded' => '返金済みにする',
            'refund-note-label' => '返金参照番号（任意）',
            'refund-note-placeholder' => '例：返金 #1234',
            'decline' => '契約撤回を却下',
            'decline-reason-label' => '却下の理由',
            'decline-reason-placeholder' => '請求権が争われる理由を説明してください',
            'mark-refunded-confirm-msg' => 'この契約撤回を返金済みにしますか？以前の却下記録はクリアされます。',
            'decline-confirm-msg' => 'この契約撤回を却下しますか？理由はお客様に表示されます。',
            'resend-confirmation-confirm-msg' => 'お客様に確認メールを再送しますか？',
            'send-final-confirmation' => '最終確認メールを送信',
            'send-final-confirmation-confirm-msg' => '最終ステータスメールをお客様に送信しますか？',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => '確認メールを再送しました。',
            'confirmation-failed' => '確認メールを送信できませんでした。詳細はタイムラインをご確認ください。',
        ],
    ],
];
