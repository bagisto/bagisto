        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'APIキー',
                    'api_publishable_key'            => '公開可能APIキー',
                    'api_test_key'                   => 'テスト用シークレットキー',
                    'api_test_publishable_key'       => 'テスト用公開APIキー',
                    'applicable-production'          => '本番モードが選択されている場合に適用されます',
                    'applicable-sandbox'             => 'テストモードが選択されている場合に適用されます',
                    'application_fee'                => 'アプリケーション手数料の支払者',
                    ...
                    'page-title'                     => '支払い方法',
                    'paid'                           => '支払済み',
                    'payment-method-info'            => 'オンラインビジネス向けのStripe決済オプションで、顧客がクレジット/デビットカードで支払うことができ、ビジネスの成長を支援します',
                    ...
                    'sort-order'                     => '並べ替え順',
                    'statement_descriptor'           => '明細書記述子',
                    'status'                         => 'ステータス',
                    'stripePayment'                  => 'Stripe決済',
                    'stripe_refund'                  => 'Stripe返金',
                    'title'                          => 'タイトル',
                ],
