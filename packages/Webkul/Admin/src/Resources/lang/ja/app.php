    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'taxes' => [
                    'title'      => '税金',
                    'title-info' => '税金とは、商品、サービス、または取引に課せられる義務的な料金であり、売り手が徴収し当局に納付するものです。',

                    'categories' => [
                        'title'      => '税金カテゴリ',
                        'title-info' => '税金カテゴリは、販売税、付加価値税、消費税などの異なる種類の税金の分類であり、製品やサービスに税率を適用するために使用されます。',
                    ...
                    'calculation' => [
                        'title'            => '計算設定',
                        'title-info'       => '商品やサービスの費用に関する詳細情報を含みます。ベース価格、割引、税金、追加料金など。',
                        'based-on'         => '計算基準',
                        'shipping-address' => '配送先住所',
                        'billing-address'  => '請求先住所',
                        'shipping-origin'  => '出荷元',
                    ...
                    'default-destination-calculation' => [
                        ...
                        'title'             => 'デフォルトの宛先計算',
                        'title-info'        => '事前に定義された要素や設定に基づいて、標準または初期の宛先を自動的に決定すること。',
                    ],
