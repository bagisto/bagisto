        ...
        'index' => [
            ...
            'general' => [
                ...
                'general' => [
                    ...
                    'unit-options' => [
                        'info'        => 'ユニットオプションを設定します。',
                        'title'       => 'ユニットオプション',
                        'title-info'  => 'サイズ、色、素材、カスタマイズ、顧客満足度の向上、購入のカスタマイズ。',
                        'weight-unit' => '重量単位',
                    ],
                ...
                'design' => [
                    ...
                    'admin-logo' => [
                        ...
                        'logo-image' => 'ロゴ画像',
                        'title'      => '管理者ロゴ',
                        'title-info' => '管理者ロゴは、システムやウェブサイトの管理インターフェースを表す特徴的な画像またはエンブレムであり、カスタマイズ可能なことがよくあります。',
                    ],
                ],
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'social-share' => [
                        'title-info'                  => 'Facebook、Twitter、Instagramなどのソーシャルメディアプラットフォームで友達とウェブサイトのコンテンツを共有すること。',
                        'title'                       => 'ソーシャルシェア',
                ...
                'rich-snippets' => [
                    ...
                    'products' => [
                        ...
                        'show-weight'     => '重量を表示する',
                        'title'           => '製品',
                        'title-info'      => 'ビジネスまたは販売者が提供する、購入または使用可能なアイテム。',
                    ],
                ...
                'inventory' => [
                    ...
                    'product-stock-options' => [
                        ...
                        'title'                   => '製品の在庫オプション',
                        'title-info'              => 'バックオーダーを許可し、最小および最大のカート数量を設定し、在庫切れのしきい値を定義するための製品の在庫オプションを構成します。',
                    ],
                ],
            ],
