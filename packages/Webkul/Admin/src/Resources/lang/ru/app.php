...
return [
                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'Разделяйте расширения запятыми, например jpg, png, pdf. Веб-страницы, изображения SVG, файлы XML и скрипты никогда не принимаются, даже если они указаны здесь.',
                                'title' => 'Опция',
                                'type' => 'Тип',
                                'yes' => 'Да',
                            ],
    ...
    'settings' => [
        ...
        'exchange-rates' => [
            'index' => [
                ...
                'update-rates-error' => 'Не удалось обновить обменные курсы. Либо сервис обменных курсов недоступен, либо его API-ключ не настроен.',
    ...
    'command-palette' => [
        'placeholder' => 'Поиск меню, настроек, страниц и действий...',
        'esc' => 'ESC',
        'loading' => 'Загрузка...',
        'no-results' => 'Ничего не найдено',
        'no-results-hint' => 'Попробуйте найти меню, страницу, настройку или действие.',
        'navigate' => 'Навигация',
        'select' => 'Открыть',
        'close' => 'Закрыть',
        ...
        'all' => 'Все :resource',
        'back' => 'Назад',
        'context-placeholder' => 'Поиск в :context...',

        'start-typing' => 'Введите для поиска',
        'record-actions' => [
            'view' => 'Просмотр',
            'edit' => 'Изменить',
        ...
        'actions' => [
            ...
            'create-page' => 'Создать CMS-страницу',
            'create-user' => 'Создать пользователя',
            'import-products' => 'Импортировать товары',
        ],
    ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    ...
                    'info' => 'Оформление без регистрации, страница корзины и мини-корзина.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Показывать мини-корзину, счётчик товаров в ней и текст предложения внутри.',
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'omnibus' => [
                        'title' => 'Раскрытие цен Omnibus',
                        'title-info' => 'Ежедневно фиксирует снимки цен и отображает самую низкую цену за 30 дней до каждой скидки, как того требует директива Omnibus ЕС.',
                        'enable' => 'Включить раскрытие Omnibus',
                    ],
                ],
            ...
            'search-engines' => [
                ...
                'info' => 'Выберите движок, обеспечивающий поиск товаров, и настройте его.',
                ...
                'test-connection' => [
                    ...
                    'statuses' => [
                        'available' => ':engine доступен',
                        'unreachable' => ':engine не ответил',
                        'unauthorized' => ':engine отклонил учётные данные',
                        'incompatible' => 'Узел ответил, но не является поддерживаемым сервером :engine',
                        'misconfigured' => 'Подключение к :engine не настроено',
                    ],
                ],

                'general' => [
                    'title' => 'Общие',
                    'info' => 'Движок, на котором работает поиск товаров.',

                    'settings' => [
                        'title' => 'Настройки',
                        'info' => 'Включите внешний поисковый движок и выберите, где он используется.',
                        'enabled' => 'Включить внешний поисковый движок',
                        'enabled-info' => 'Выключите, чтобы везде искать по базе данных, независимо от настроек ниже.',
                        'engine' => 'Поисковый движок по умолчанию',
                        'engine-info' => 'Движок, применяемый везде, где режим поиска оставлен на «Использовать по умолчанию».',
                        'inherit' => 'Использовать по умолчанию',
                    ],

                    'products' => [
                        'title' => 'Товары',
                        'info' => 'Каким движком каждая сторона магазина ищет товары.',
                        'admin-mode' => 'Режим поиска в панели администратора',
                        'admin-mode-info' => 'Движок, обеспечивающий мега-поиск, таблицы данных и остальной поиск в панели администратора.',
                        'storefront-mode' => 'Режим поиска в магазине',
                        'storefront-mode-info' => 'Движок, обеспечивающий страницы категорий, страницу поиска и остальной поиск в магазине.',
                    ],
                ],

                'elastic' => [
                    'info' => 'Состояние подключения и ограничения запросов для Elasticsearch.',

                    'settings' => [
                        'title' => 'Настройки',
                        'info' => 'Используется, когда режим поиска установлен на Elasticsearch.',
                        'auth-type' => 'Аутентификация',
                        'auth-type-info' => 'Как выполняется подключение к кластеру и вход. Показываются только нужные поля.',

                        'auth-types' => [
                            'none' => 'Без аутентификации',
                            'basic' => 'Имя пользователя и пароль',
                            'api-key' => 'Ключ API',
                            'cloud-api-key' => 'Elastic Cloud с ключом API',
                            'cloud-basic' => 'Elastic Cloud с именем пользователя и паролем',
                        ],

                        'hosts' => 'Хосты',
                        'hosts-info' => 'Где доступен кластер, например http://localhost:9200. Несколько хостов разделяйте запятой. Оставьте пустым, чтобы использовать файл окружения.',
                        'username' => 'Имя пользователя',
                        'username-info' => 'Используется при базовой аутентификации. Оставьте пустым, если кластер её не требует.',
                        'password' => 'Пароль',
                        'password-info' => 'Пароль, связанный с именем пользователя.',
                        'api-key' => 'Ключ API',
                        'api-key-info' => 'Ключ, с которым выполняется вход в кластер.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Cloud ID развёртывания Elastic Cloud.',
                        'index-prefix' => 'Префикс индекса',
                        'index-prefix-info' => 'Добавляется перед каждым именем индекса, чтобы несколько магазинов могли использовать один кластер.',
                        'min-query-length' => 'Минимальная длина запроса',
                        'min-query-length-info' => 'Самый короткий поисковый запрос, который принимает поле поиска магазина.',
                        'max-query-length' => 'Максимальная длина запроса',
                        'max-query-length-info' => 'Самый длинный поисковый запрос, который принимает поле поиска магазина.',
            ...
            'file-management' => [
                ...
                'info' => 'Выберите, где хранятся загруженные файлы, и настройте службу хранения.',

                'general' => [
                    'title' => 'Общие',
                    'info' => 'Хранилище, которое весь магазин использует для загруженных файлов.',

                    'settings' => [
                        'title' => 'Настройки',
                        'info' => 'Выберите хранилище, в которое сохраняются файлы и из которого они отдаются.',
                        'default-driver' => 'Драйвер хранилища по умолчанию',
                        'default-driver-info' => 'Файлы, загруженные с этого момента, будут сохраняться сюда. Ранее загруженные файлы останутся в прежнем хранилище, поэтому скопируйте их перед переключением, иначе они не будут найдены.',

                        'drivers' => [
                            'local' => 'Файл (локальное хранилище)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Учётные данные для Amazon S3 или любой службы, совместимой с его API.',

                    'settings' => [
                        'title' => 'Настройки',
                        'info' => 'Используются, когда драйвером хранилища по умолчанию выбран Amazon S3.',
                        'key' => 'Идентификатор ключа доступа',
                        'key-info' => 'Идентификатор ключа доступа учётной записи, которой принадлежит бакет.',
                        'secret' => 'Секретный ключ доступа',
                        'secret-info' => 'Секрет, соответствующий идентификатору ключа доступа.',
                        'region' => 'Регион',
                        'region-info' => 'Регион, в котором создан бакет, например us-east-1.',
                        'bucket' => 'Бакет',
                        'bucket-info' => 'Название бакета, в котором хранятся файлы.',
                        'url' => 'URL',
                        'url-info' => 'Адрес, с которого отдаются файлы. Оставьте пустым, чтобы использовать адрес, предоставленный службой.',
                        'endpoint' => 'Конечная точка',
                        'endpoint-info' => 'Требуется только для службы, отличной от Amazon S3, например размещённой на своём сервере. Для Amazon S3 оставьте пустым.',
                        'use-path-style-endpoint' => 'Использовать конечную точку с путём',
                        'use-path-style-endpoint-info' => 'Включите для собственной службы, которая адресует бакеты как путь, а не как поддомен.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Учётные данные для объектного хранилища Cloudflare R2.',

                    'settings' => [
                        'title' => 'Настройки',
                        'info' => 'Используются, когда драйвером хранилища по умолчанию выбран Cloudflare R2.',
                        'account-id' => 'Идентификатор учётной записи',
                        'account-id-info' => 'Учётная запись Cloudflare, которой принадлежит бакет. Адрес R2 строится на её основе, поэтому конечная точка не нужна.',
                        'key' => 'Идентификатор ключа доступа',
                        'key-info' => 'Идентификатор ключа доступа токена API R2.',
                        'secret' => 'Секретный ключ доступа',
                        'secret-info' => 'Секрет, соответствующий идентификатору ключа доступа.',
                        'bucket' => 'Бакет',
                        'bucket-info' => 'Название бакета R2, в котором хранятся файлы.',
                        'url' => 'Публичный URL',
                        'url-info' => 'Адрес, с которого отдаются файлы: публичный адрес бакета или собственный домен. Бакет R2 остаётся закрытым, пока адрес не задан, без него файлы будут недоступны.',
                    ],
                ],
            ],
        ...
        'layouts' => [
            'header' => [
                ...
                'mega-search' => [
                    ...
                    'shortcut' => 'Ctrl K',
                    'sku' => 'Артикул: :sku',
                    'title' => 'Поиск или нажмите Ctrl + K',
                ],
            ],
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'Отказы от договора (ЕС)',
        ],
        ...
        'acl' => [
            ...
            'view' => 'Просмотр',
            'decline' => 'Отклонить',
            'mark-refunded' => 'Отметить возврат',
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Включить',
                'enabled-info' => 'При включении клиенты этого канала видят кнопку «Отказаться от договора» на страницах с деталями заказа, а также публичную форму поиска по адресу /withdraw. Включайте только на каналах, продающих потребителям из ЕС.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence-note' => 'Неизменяемые — зафиксировано при отправке',
            'status' => 'Статус',
            ...
            'timeline' => 'Хронология',
            'timeline-received' => 'Заявление получено',
            'timeline-received-desc' => 'Клиент подал заявление об отказе от договора.',
            'timeline-email' => 'E-mail подтверждения',
            'timeline-email-pending' => 'Ещё не отправлен',
            'timeline-initial-email' => 'Первое письмо-подтверждение',
            'timeline-initial-email-desc-sent' => 'Письмо-подтверждение доставлено клиенту.',
            'timeline-initial-email-desc-error' => 'Не удалось отправить первое письмо-подтверждение.',
            'timeline-initial-email-desc-pending' => 'Первое письмо-подтверждение ещё не отправлено.',
            'timeline-final-email' => 'Итоговое письмо-подтверждение',
            'timeline-final-email-pending' => 'Ещё не отправлен',
            'timeline-final-email-desc-sent' => 'Итоговое письмо доставлено клиенту.',
            'timeline-final-email-desc-pending' => 'Итоговое письмо-подтверждение ещё не отправлено.',
            'timeline-declined' => 'Отклонено администратором',
            'timeline-declined-desc' => 'Отказ от договора отклонён :name.',
            'timeline-declined-desc-system' => 'Отказ от договора отклонён.',
            'timeline-declined-reason-label' => 'Указанная причина:',
            'timeline-refunded' => 'Отмечено как возврат администратором',
            'timeline-refunded-desc' => 'Возврат оформлен :name.',
            'timeline-refunded-desc-system' => 'Возврат оформлен.',
            'timeline-refunded-note-label' => 'Примечание администратора:',
            'timeline-resolution' => 'Решение',
            'timeline-resolution-desc' => 'Ожидает рассмотрения и решения администратором.',
            'timeline-resolution-pending' => 'Ожидает действия администратора',

            'confirmation-sent-at' => 'Подтверждение отправлено',
            'confirmation-error' => 'Ошибка подтверждения',
            'declined-at' => 'Отклонено',
            'refunded-at' => 'Возврат выполнен',

            'actions' => 'Действия',
            'actions-note' => 'Возвраты обрабатываются вручную с помощью существующих инструментов Bagisto: заказов, возвратов и RMA. Используйте эти действия, чтобы зафиксировать результат в материалах об отказе от договора.',
            'resend-confirmation' => 'Отправить письмо-подтверждение повторно',
            'mark-refunded' => 'Отметить как возврат',
            'refund-note-label' => 'Номер возврата (необязательно)',
            'refund-note-placeholder' => 'напр., Возврат №1234',
            'decline' => 'Отклонить отказ',
            'decline-reason-label' => 'Причина отклонения',
            'decline-reason-placeholder' => 'Объясните, почему право оспаривается',
            'mark-refunded-confirm-msg' => 'Отметить этот отказ как возвращённый? Предыдущая запись об отклонении будет удалена.',
            'decline-confirm-msg' => 'Отклонить этот отказ? Причина будет видна клиенту.',
            'resend-confirmation-confirm-msg' => 'Отправить клиенту письмо-подтверждение повторно?',
            'send-final-confirmation' => 'Отправить итоговое письмо-подтверждение',
            'send-final-confirmation-confirm-msg' => 'Отправить клиенту итоговое письмо со статусом?',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'Письмо-подтверждение было отправлено повторно.',
            'confirmation-failed' => 'Не удалось отправить письмо-подтверждение. Подробности смотрите в хронологии.',
        ],
    ],
];
