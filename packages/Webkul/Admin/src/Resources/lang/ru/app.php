...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'enter_code'            => 'Введите 6-значный код из приложения аутентификации, чтобы продолжить.',
    ...
    'account' => [
        ...
        'setup' => [
            ...
            'scan_qr'          => 'Сканируйте этот QR-код в приложении Google Authenticator и введите 6-значный код ниже.',
            'code_label'       => 'Код подтверждения',
            'code_placeholder' => 'Введите 6-значный код',
            'back'             => 'Назад',
