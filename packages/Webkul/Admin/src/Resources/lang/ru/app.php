        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'settings-title-info' => 'Настройки относятся к настраиваемым выборам, которые управляют поведением системы, приложения или устройства в соответствии с предпочтениями и требованиями пользователя.'
                ],
