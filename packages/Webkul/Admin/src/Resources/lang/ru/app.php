    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp-settings' => [
                    'info' => 'Настройте параметры SMTP для отправки электронных писем для этого канала.',
                    'smtp-enable' => 'Включить пользовательский SMTP',
                    'smtp-enable-info' => 'Включите или отключите использование пользовательских настроек SMTP для отправки писем с этого канала.',
                    'smtp-encryption' => 'Шифрование',
                    'smtp-encryption-info' => 'Выберите метод шифрования для защиты электронной почты. Доступные варианты: TLS, SSL или Нет.',
                    'smtp-host' => 'SMTP-хост',
                    'smtp-host-info' => 'Адрес SMTP-сервера, используемого для отправки электронных писем. Это может быть IP-адрес или доменное имя.',
                    'smtp-password' => 'Пароль SMTP',
                    'smtp-password-info' => 'Пароль, связанный с именем пользователя SMTP для аутентификации на почтовом сервере.',
                    'smtp-port' => 'SMTP-порт',
                    'smtp-port-info' => 'Номер порта, используемый для SMTP-связи. Распространённые порты: 25, 465 (SSL) и 587 (TLS).',
                    'smtp-username' => 'Имя пользователя SMTP',
                    'smtp-username-info' => 'Имя пользователя для аутентификации на SMTP-сервере, обычно это адрес электронной почты или имя пользователя, предоставленное почтовым сервисом.',
