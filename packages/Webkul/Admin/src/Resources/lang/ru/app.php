        ...
        'orders' => [
            ...
            'view' => [
                ...
                'booking-cancellation-not-allowed' => [
                    ...
                    'description' => 'В этом заказе есть продукт бронирования, настроенный как не подлежащий отмене. Клиент не может отменить его из своей учетной записи, и действие отмены здесь также отключено.',
                ],
