...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'disabled_message' => 'Двухфакторная аутентификация в данный момент отключена администратором.',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'API ключ',
                    'api_publishable_key'            => 'Публичный API ключ',
                    'api_test_key'                   => 'Тестовый секретный ключ API',
                    'api_test_publishable_key'       => 'Тестовый публичный ключ API',
                    'applicable-production'          => 'Применяется, если выбран режим производства',
                    'applicable-sandbox'             => 'Применяется, если выбран тестовый режим',
                    'application_fee'                => 'Плательщик комиссии за приложение',
                    ...
                    'paid'                           => 'Оплачено',
                    'payment-method-info'            => 'Платёжная опция Stripe для онлайн-бизнеса, позволяющая клиентам платить с помощью карт и развивать свой бизнес',
                    ...
                    'sort-order'                     => 'Порядок сортировки',
                    'statement_descriptor'           => 'Описание выписки',
                    'status'                         => 'Статус',
                    'stripePayment'                  => 'Платёж Stripe',
                    'stripe_refund'                  => 'Возврат Stripe',
                    'title'                          => 'Название',
                ],
