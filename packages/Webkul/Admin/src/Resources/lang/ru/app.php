        ...
        'index' => [
            ...
            'customer' => [
                ...
                'social-login' => [
                    ...
                    'info'  => 'Настройка входа через социальные сети',

                    'google-details' => [
                        'title'      => 'Данные Google',
                        'title-info' => 'Настройте свои учетные данные Google Auth для активации входа через Google.',

                        'client-id' => [
                            'title'      => 'ID клиента',
                            'title-info' => 'Уникальный идентификатор, предоставленный Google при создании приложения для авторизации.',
                        ],

                        'client-secret' => [
                            'title'      => 'Секрет клиента',
                            'title-info' => 'Секретный ключ, связанный с клиентом Google Auth. Держите его в секрете.',
                        ],

                        'redirect' => [
                            'title'      => 'URL перенаправления',
                            'title-info' => 'URL обратного вызова, на который пользователи перенаправляются после входа через Google. Должен совпадать с указанным в консоли Google.',
                        ],
                    ],

                    'facebook-details' => [
                        'title'      => 'Данные Facebook',
                        'title-info' => 'Настройте свои учетные данные Facebook Auth для активации входа через Facebook.',

                        'client-id' => [
                            'title'      => 'ID клиента',
                            'title-info' => 'ID приложения, предоставленный Facebook при создании приложения в консоли разработчика.',
                        ],

                        'client-secret' => [
                            'title'      => 'Секрет клиента',
                            'title-info' => 'Секретный ключ, связанный с вашим приложением Facebook. Храните его в безопасности.',
                        ],

                        'redirect' => [
                            'title'      => 'URL перенаправления',
                            'title-info' => 'URL обратного вызова, на который пользователи перенаправляются после входа через Facebook. Должен соответствовать настройкам вашего приложения.',
                        ],
                    ],

                    'github-details' => [
                        'title'      => 'Данные GitHub',
                        'title-info' => 'Настройте свои учетные данные GitHub Auth для активации входа через GitHub.',

                        'client-id' => [
                            'title'      => 'ID клиента',
                            'title-info' => 'Уникальный идентификатор, предоставленный GitHub при создании приложения.',
                        ],

                        'client-secret' => [
                            'title'      => 'Секрет клиента',
                            'title-info' => 'Секретный ключ, связанный с клиентом GitHub Auth. Держите его в секрете.',
                        ],

                        'redirect' => [
                            'title'      => 'URL перенаправления',
                            'title-info' => 'URL обратного вызова, на который пользователи перенаправляются после входа через GitHub. Должен совпадать с указанным в консоли GitHub.',
                        ],
                    ],

                    'linkedin-openid-details' => [
                        'title'      => 'Данные LinkedIn',
                        'title-info' => 'Настройте свои учетные данные LinkedIn Auth для активации входа через LinkedIn.',

                        'client-id' => [
                            'title'      => 'ID клиента',
                            'title-info' => 'Уникальный идентификатор, предоставленный LinkedIn при создании приложения.',
                        ],

                        'client-secret' => [
                            'title'      => 'Секрет клиента',
                            'title-info' => 'Секретный ключ, связанный с клиентом LinkedIn Auth. Держите его в секрете.',
                        ],

                        'redirect' => [
                            'title'      => 'URL перенаправления',
                            'title-info' => 'URL обратного вызова, на который пользователи перенаправляются после входа через LinkedIn. Должен совпадать с указанным в консоли LinkedIn.',
                        ],
                    ],

                    'twitter-details' => [
                        'title'      => 'Данные Twitter',
                        'title-info' => 'Настройте свои учетные данные Twitter Auth для активации входа через Twitter.',

                        'client-id' => [
                            'title'      => 'ID клиента',
                            'title-info' => 'Уникальный идентификатор, предоставленный Twitter при создании приложения.',
                        ],

                        'client-secret' => [
                            'title'      => 'Секрет клиента',
                            'title-info' => 'Секретный ключ, связанный с клиентом Twitter Auth. Держите его в секрете.',
                        ],

                        'redirect' => [
                            'title'      => 'URL перенаправления',
                            'title-info' => 'URL обратного вызова, на который пользователи перенаправляются после входа через Twitter. Должен совпадать с настройками в консоли Twitter.',
                        ],
                    ],
                ],
            ],
