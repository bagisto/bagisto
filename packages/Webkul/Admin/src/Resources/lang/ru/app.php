            ...
            'general' => [
                ...
                'general' => [
                    ...
                    'date-options' => [
                        ...
                        'info' => 'Установите параметры формата даты.',
                        'title' => 'Параметры даты',
                        'title-info' => 'Настройте формат даты, используемый в панели администратора, магазине и счетах-фактурах.',
                    ],
