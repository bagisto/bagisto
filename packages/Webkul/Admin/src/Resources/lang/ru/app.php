        ...
        'index' => [
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'product-view-page' => [
                        'allow-overlapping-booking-time-slots' => 'Разрешать пересекающиеся временные интервалы бронирования',
                        'allow-no-of-up-sells-products'        => 'Разрешенное количество товаров с допродажей',
                        'allow-no-of-related-products'         => 'Разрешенное количество связанных товаров',
                        'title'                                => 'Настройка страницы просмотра товара',
                        'title-info'                           => 'Настройка страницы просмотра товара включает изменение макета и элементов на странице товара, улучшение удобства использования и представления информации, а также управление пересекающимися временными интервалами бронирования для определения того, разрешены они или запрещены.',
                    ],
