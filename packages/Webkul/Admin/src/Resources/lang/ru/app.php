    ...
    'eu_withdrawal' => [
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Включить кнопку отказа от договора (ЕС)',
            ...
            'notifications' => [
                'title' => 'Уведомления',
                'info' => 'Переопределение отправителя писем-подтверждений отказа.',
                'sender_email' => 'E-mail отправителя',
                'sender_email_info' => 'Необязательно. Если не указано, используется глобальный отправитель писем.',
            ],
        ],
