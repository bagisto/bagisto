            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'api-key' => 'Ключ API',
                        'api-key-info' => 'Используется вместо имени пользователя и пароля. Его указание переключает подключение на аутентификацию по ключу API.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Для Elastic Cloud. Его указание переключает подключение на Elastic Cloud в паре с ключом API.',
