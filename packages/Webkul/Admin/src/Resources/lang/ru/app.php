...
return [
    ...
    'configuration' => [
        ...
        'catalog' => [
            ...
            'products' => [
                'info'  => 'Настройка оформления заказа гостя, главной страницы, страницы просмотра продукта, страницы корзины, фронтенда магазина, обзора и атрибутов для обмена в социальных сетях.',
                'title' => 'Продукты',
                ...
                'homepage' => [
                    ...
                    'allow-no-of-featured-products'  => 'Разрешенное количество выделенных продуктов на главной странице',
                    'title'                          => 'Настройка главной страницы',
                    'title-info'                     => 'Настройка главной страницы включает в себя настройку макета, содержания и дизайна основной страницы сайта для эффективного представления необходимой информации.',
                ],
        ...
        'customer' => [
            ...
            'settings' => [
                'settings-info' => 'Настройте список желаний, подписку на рассылку, проверку по электронной почте и социальный вход.',
                'title'         => 'Настройки',

                'wishlist' => [
                    'share'      => 'Разрешить обмен',
                    'title'      => 'Список желаний',
                    'title-info' => '"Список желаний" - это персональная коллекция желаемых товаров, позволяющая пользователям сохранять продукты для будущего просмотра или потенциальной покупки.',
                ],
