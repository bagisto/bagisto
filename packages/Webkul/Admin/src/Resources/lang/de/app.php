        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'Clau API',
                    'api_publishable_key'            => 'Clau publicable de l’API',
                    'api_test_key'                   => 'Clau secreta de prova de l’API',
                    'api_test_publishable_key'       => 'Clau publicable de prova de l’API',
                    'applicable-production'          => 'S’aplica si es selecciona el mode de producció',
                    'applicable-sandbox'             => 'S’aplica si es selecciona el mode de prova',
                    'application_fee'                => 'Pagador de la tarifa de l’aplicació',
                    ...
                    'client_id'                      => 'Identificador del client',
                    ...
                    'paid'                           => 'Bezahlt',
                    'payment-method-info'            => 'Opció de pagament Stripe per a negocis en línia que permet als clients pagar amb targetes de crèdit/dèbit i fer créixer el teu negoci',
