        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'API 密钥',
                    'api_publishable_key'            => '可发布的 API 密钥',
                    'api_test_key'                   => 'API 测试密钥',
                    'api_test_publishable_key'       => 'API 测试可发布密钥',
                    'applicable-production'          => '当选择生产模式时适用',
                    'applicable-sandbox'             => '当选择测试模式时适用',
                    'application_fee'                => '应用费用支付方',
                    ...
                    'page-title'                     => '支付方式',
                    'paid'                           => '已支付',
                    'payment-method-info'            => 'Stripe 为在线业务提供支付选项，允许客户使用信用卡/借记卡付款，助力业务增长。',
