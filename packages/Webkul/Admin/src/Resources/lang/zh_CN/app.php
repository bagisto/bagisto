...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => '密码',
            'powered-by-description' => 'Powered by :shopagg from :webkul',
            'submit-btn'             => '登录',
            'title'                  => '登录',
        ],
        ...
        'forget-password' => [
            'create' => [
                ...
                'page-title'             => '忘记密码',
                'powered-by-description' => '由 :webkul 提供支持1',
        ...
        'reset-password' => [
            ...
            'email'                  => '注册电子邮件',
            'password'               => '密码',
            'powered-by-description' => '由 :webkul 提供支持2',
            'submit-btn'             => '重置密码',
            'title'                  => '重置密码',
        ],
    ],
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'imports' => [
                ...
                'import' => [
                    ...
                    'edit-btn'                => '編輯',
                    'imported-info'           => '恭喜！您的导入已成功完成。',
                    'importing-info'          => '导入處理中',
                    ...
                    'total-updated'           => '已更新記錄：',
                    'validate-info'           => '按一下 „驗證數據“ 以檢查您的导入。',
                    'validate'                => '驗證',
                    'validating-info'         => '數據開始閱讀和驗證',
                    'validation-failed-info'  => '您的导入無效。請修正以下錯誤並再試一次。',
                    'validation-success-info' => '您的导入有效。按一下 „导入“ 以開始导入過程。',
                ],

                'create-success'    => '已成功建立导入。',
                'delete-failed'     => '导入刪除失敗。',
                'delete-success'    => '已成功刪除导入。',
                'not-valid'         => '导入無效',
                'nothing-to-import' => '沒有要导入的資源。',
                'setup-queue-error' => '請將您的佇列驅動程序更改為 „database“ 或 „redis“，以開始导入過程。',
                'update-success'    => '已成功更新导入。',
            ],
        ],
        ...
        'users' => [
            ...
            'activate-warning'   => '您的帐户尚未启用，请联系管理员。',
    ...
    'footer' => [
        'copy-right' => '由 <a href="https://www.shopagg.org/" target="_blank">SHOPAGG</a> 提供支持',
    ],
