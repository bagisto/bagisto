    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'taxes' => [
                    'title'      => '税费',
                    'title-info' => '税费是政府对商品、服务或交易强制征收的费用，由卖方收取并上缴给当局。',

                    'categories' => [
                        'title'      => '税费分类',
                        'title-info' => '税费分类是对不同类型的税费进行分类的分类，例如销售税、增值税或消费税，用于对产品或服务应用税率并进行分类。',
                        'product'    => '产品默认税费分类',
                        'shipping'   => '运输税费分类',
                        'none'       => '无',
                    ],
                    ...
                    'calculation' => [
                        'title'            => '计算设置',
                        'title-info'       => '关于商品或服务的成本的详细信息，包括基准价格、折扣、税费和其他费用。',
                        'based-on'         => '计算基于',
                        'shipping-address' => '运输地址',
                        'billing-address'  => '账单地址',
                        'shipping-origin'  => '运输起点',
                        'product-prices'   => '产品价格',
                        'shipping-prices'  => '运输价格',
                        'excluding-tax'    => '不含税',
                        'including-tax'    => '含税',
                    ],
                    ...
                    'default-destination-calculation' => [
                        ...
                        'default-post-code' => '默认邮编',
                        'default-state'     => '默认州',
                        'title'             => '默认目的地计算',
                        'title-info'        => '根据预定义的因素或设置自动确定标准或初始目的地。',
                    ],

                    'shopping-cart' => [
                        'title'                   => '购物车显示设置',
                        'title-info'              => '设置购物车中的税费显示',
                        'display-prices'          => '显示价格',
                        'display-subtotal'        => '显示小计',
                        'display-shipping-amount' => '显示运输金额',
                        'excluding-tax'           => '不含税',
                        'including-tax'           => '含税',
                        'both'                    => '同时显示不含税和含税',
                    ],
