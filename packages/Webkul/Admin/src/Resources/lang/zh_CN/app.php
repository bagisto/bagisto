                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-types' => [
                            ...
                            'basic' => '用户名和密码',
                            'api-key' => 'API 密钥',
                            'cloud-api-key' => '使用 API 密钥的 Elastic Cloud',
                            'cloud-basic' => '使用用户名和密码的 Elastic Cloud',
                        ],
    ...
    'eu-withdrawal' => [
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => '启用',
                'enabled-info' => '启用后，此渠道的客户将在订单详情页面看到“撤回合同”按钮，并可访问公开的 /withdraw 查找表单。请仅在面向欧盟消费者销售的渠道启用此功能。',
            ],
        ],
        ...
        'view' => [
            ...
            'timeline' => '时间线',
            'timeline-received' => '已收到声明',
            'timeline-received-desc' => '客户已提交合同撤回请求。',
            'timeline-email' => '确认邮件',
            'timeline-email-pending' => '尚未发送',
            'timeline-initial-email' => '初始确认邮件',
            'timeline-initial-email-desc-sent' => '确认邮件已发送给客户。',
            'timeline-initial-email-desc-error' => '初始确认邮件发送失败。',
            'timeline-initial-email-desc-pending' => '初始确认邮件尚未发送。',
            'timeline-final-email' => '最终确认邮件',
            'timeline-final-email-pending' => '尚未发送',
            'timeline-final-email-desc-sent' => '结果通知邮件已发送给客户。',
            'timeline-final-email-desc-pending' => '最终确认邮件尚未发送。',
            'timeline-declined' => '管理员已拒绝',
            'timeline-declined-desc' => ':name 已拒绝该撤回请求。',
            'timeline-declined-desc-system' => '撤回请求已被拒绝。',
            'timeline-declined-reason-label' => '所给理由：',
            'timeline-refunded' => '管理员已标记为已退款',
            'timeline-refunded-desc' => ':name 已发放退款。',
            'timeline-refunded-desc-system' => '已发放退款。',
            'timeline-refunded-note-label' => '管理员备注：',
            'timeline-resolution' => '处理',
            'timeline-resolution-desc' => '等待管理员审核和决定。',
            'timeline-resolution-pending' => '等待管理员处理',

            'confirmation-sent-at' => '确认邮件发送时间',
            'confirmation-error' => '确认邮件错误',
            'declined-at' => '拒绝时间',
            'refunded-at' => '退款时间',

            'actions' => '操作',
            'actions-note' => '退款通过 Bagisto 现有的订单 / 退款 / RMA 工具手动处理。请使用这些操作在撤回凭证上记录处理结果。',
            'resend-confirmation' => '重新发送确认邮件',
            'mark-refunded' => '标记为已退款',
            'refund-note-label' => '退款参考编号（可选）',
            'refund-note-placeholder' => '例如：退款 #1234',
            'decline' => '拒绝撤回',
            'decline-reason-label' => '拒绝理由',
            'decline-reason-placeholder' => '请说明对客户权利提出异议的理由',
            'mark-refunded-confirm-msg' => '将此撤回请求标记为已退款？此前的任何拒绝记录将被清除。',
            'decline-confirm-msg' => '拒绝此撤回请求？该理由将对客户可见。',
            'resend-confirmation-confirm-msg' => '向客户重新发送确认邮件？',
            'send-final-confirmation' => '发送最终确认邮件',
            'send-final-confirmation-confirm-msg' => '向客户发送最终状态邮件？',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => '确认邮件已重新发送。',
            'confirmation-failed' => '无法发送确认邮件。详情请查看时间线。',
        ],
    ],
];
