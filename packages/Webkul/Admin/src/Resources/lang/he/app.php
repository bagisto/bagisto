    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp-settings' => [
                    'info' => 'הגדר את הגדרות ה-SMTP לשליחת אימיילים עבור ערוץ זה.',
                    'smtp-enable' => 'אפשר SMTP מותאם אישית',
                    'smtp-enable-info' => 'אפשר או השבת את השימוש בהגדרות SMTP מותאמות אישית לשליחת אימיילים מערוץ זה.',
                    'smtp-encryption' => 'הצפנה',
                    'smtp-encryption-info' => 'בחר את שיטת ההצפנה לאבטחת תקשורת האימייל. האפשרויות כוללות TLS, SSL או ללא.',
                    'smtp-host' => 'שרת SMTP',
                    'smtp-host-info' => 'כתובת שרת ה-SMTP המשמש לשליחת אימיילים. זו יכולה להיות כתובת IP או שם דומיין.',
                    'smtp-password' => 'סיסמת SMTP',
                    'smtp-password-info' => 'הסיסמה המשויכת לשם המשתמש של SMTP לצורך אימות מול שרת הדואר.',
                    'smtp-port' => 'פורט SMTP',
                    'smtp-port-info' => 'מספר הפורט המשמש לתקשורת SMTP. פורטים נפוצים כוללים 25, 465 (SSL) ו-587 (TLS).',
                    'smtp-username' => 'שם משתמש SMTP',
                    'smtp-username-info' => 'שם המשתמש המשמש לאימות מול שרת ה-SMTP, לרוב כתובת האימייל או שם משתמש ייעודי שסופק על ידי שירות האימייל.',
                    'title' => 'הגדרות SMTP',
                    'tls' => 'TLS',
                    'ssl' => 'SSL',
                    'none' => 'ללא',
