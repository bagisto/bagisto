...
return [
    ...
    'configuration' => [
        'index' => [
            ...
            'file-management' => [
                'title' => 'ניהול קבצים',
                'info' => 'בחרו היכן יאוחסנו הקבצים שהועלו והגדירו את שירות האחסון.',

                'general' => [
                    'title' => 'כללי',
                    'info' => 'האחסון שכל החנות משתמשת בו עבור קבצים שהועלו.',

                    'settings' => [
                        'title' => 'הגדרות',
                        'info' => 'בחרו את האחסון שאליו הקבצים נשמרים וממנו הם מוגשים.',
                        'default-driver' => 'מנהל התקן אחסון ברירת מחדל',
                        'default-driver-info' => 'קבצים שיועלו מעכשיו יישמרו כאן. קבצים שכבר הועלו יישארו באחסון הקודם, לכן העתיקו אותם לפני המעבר אחרת לא יימצאו.',

                        'drivers' => [
                            'local' => 'קובץ (אחסון מקומי)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'פרטי גישה עבור Amazon S3 או כל שירות התומך באותו API.',

                    'settings' => [
                        'title' => 'הגדרות',
                        'info' => 'בשימוש כאשר מנהל התקן האחסון שנבחר הוא Amazon S3.',
                        'key' => 'מזהה מפתח גישה',
                        'key-info' => 'מזהה מפתח הגישה של החשבון שאליו שייכת הדלי.',
                        'secret' => 'מפתח גישה סודי',
                        'secret-info' => 'הסוד המשויך למזהה מפתח הגישה.',
                        'region' => 'אזור',
                        'region-info' => 'האזור שבו נוצרה הדלי, לדוגמה us-east-1.',
                        'bucket' => 'דלי',
                        'bucket-info' => 'שם הדלי שבו מאוחסנים הקבצים.',
                        'url' => 'כתובת',
                        'url-info' => 'הכתובת שממנה מוגשים הקבצים. השאירו ריק כדי להשתמש בכתובת שהשירות מספק.',
                        'endpoint' => 'נקודת קצה',
                        'endpoint-info' => 'נדרשת רק עבור שירות שאינו Amazon S3, למשל שירות באחסון עצמי. השאירו ריק עבור Amazon S3.',
                        'use-path-style-endpoint' => 'שימוש בנקודת קצה מבוססת נתיב',
                        'use-path-style-endpoint-info' => 'הפעילו עבור שירות באחסון עצמי הפונה לדליים כנתיב במקום כתת-דומיין.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'פרטי גישה עבור אחסון האובייקטים Cloudflare R2.',

                    'settings' => [
                        'title' => 'הגדרות',
                        'info' => 'בשימוש כאשר מנהל התקן האחסון שנבחר הוא Cloudflare R2.',
                        'account-id' => 'מזהה חשבון',
                        'account-id-info' => 'חשבון Cloudflare שאליו שייכת הדלי. כתובת R2 נבנית ממנו, ולכן אין צורך בנקודת קצה.',
                        'key' => 'מזהה מפתח גישה',
                        'key-info' => 'מזהה מפתח הגישה של אסימון API של R2.',
                        'secret' => 'מפתח גישה סודי',
                        'secret-info' => 'הסוד המשויך למזהה מפתח הגישה.',
                        'bucket' => 'דלי',
                        'bucket-info' => 'שם דלי R2 שבו מאוחסנים הקבצים.',
                        'url' => 'כתובת ציבורית',
                        'url-info' => 'הכתובת שממנה מוגשים הקבצים, הכתובת הציבורית של הדלי או דומיין מותאם אישית. דלי R2 נשאר פרטי עד שנקבעת כתובת, ובלעדיה הקבצים לא יהיו נגישים.',
                    ],
                ],
            ],
