...
return [
    ...
    'settings' => [
        ...
        'exchange-rates' => [
            'index' => [
                ...
                'update-rates-error' => 'לא ניתן היה לעדכן את שערי החליפין. או ששירות שערי החליפין אינו זמין, או שמפתח ה-API שלו לא הוגדר.',
    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    'title' => 'תשלום',
                    'info' => 'תשלום כאורח, עמוד העגלה והעגלה המוקטנת.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'הצג את העגלה המוקטנת, מונה הפריטים שבה וטקסט המבצע בתוכה.',
            ...
            'search-engines' => [
                'title' => 'מנועי חיפוש',
                'info' => 'בחרו את המנוע שמפעיל את חיפוש המוצרים והגדירו אותו.',
                ...
                'test-connection' => [
                    ...
                    'statuses' => [
                        'available' => ':engine זמין',
                        'unreachable' => ':engine לא הגיב',
                        'unauthorized' => ':engine דחה את פרטי הגישה',
                        'incompatible' => 'המארח הגיב אך אינו שרת :engine נתמך',
                        'misconfigured' => 'חיבור :engine אינו מוגדר',
                    ],
                ],

                'general' => [
                    'title' => 'כללי',
                    'info' => 'המנוע שעליו פועל חיפוש המוצרים.',

                    'settings' => [
                        'title' => 'הגדרות',
                        'info' => 'הפעילו מנוע חיפוש חיצוני ובחרו היכן הוא משמש.',
                        'enabled' => 'הפעלת מנוע חיפוש חיצוני',
                        'enabled-info' => 'כבו כדי לחפש במסד הנתונים בכל מקום, יהיו ההגדרות שלהלן אשר יהיו.',
                        'engine' => 'מנוע חיפוש ברירת מחדל',
                        'engine-info' => 'המנוע שבו נעשה שימוש בכל מקום שבו מצב חיפוש נותר על «שימוש בברירת המחדל».',
                        'inherit' => 'שימוש בברירת המחדל',
                    ],

                    'products' => [
                        'title' => 'מוצרים',
                        'info' => 'באיזה מנוע כל צד של החנות מחפש מוצרים.',
                        'admin-mode' => 'מצב חיפוש בלוח הניהול',
                        'admin-mode-info' => 'המנוע שמאחורי החיפוש המהיר, טבלאות הנתונים ושאר החיפושים בלוח הניהול.',
                        'storefront-mode' => 'מצב חיפוש בחנות',
                        'storefront-mode-info' => 'המנוע שמאחורי דפי הקטגוריות, דף החיפוש ושאר החיפושים בחנות.',
                    ],
                ],

                'elastic' => [
                    'info' => 'מצב החיבור ומגבלות השאילתה עבור Elasticsearch.',
                    ...
                    'settings' => [
                        ...
                        'auth-types' => [
                            ...
                            'api-key' => 'מפתח API',
                            'cloud-api-key' => 'Elastic Cloud עם מפתח API',
                            'cloud-basic' => 'Elastic Cloud עם שם משתמש וסיסמה',
                        ],

                        'hosts' => 'מארחים',
                        'hosts-info' => 'היכן האשכול נגיש, לדוגמה http://localhost:9200. הפרידו בין מארחים בפסיק. השאירו ריק כדי להשתמש בקובץ הסביבה.',
                        'username' => 'שם משתמש',
                        'username-info' => 'משמש באימות בסיסי. השאירו ריק אם האשכול אינו דורש זאת.',
                        'password' => 'סיסמה',
                        ...
                        'min-query-length-info' => 'מונח החיפוש הקצר ביותר שתיבת החיפוש בחנות מקבלת.',
                        'max-query-length' => 'אורך שאילתה מרבי',
                        'max-query-length-info' => 'מונח החיפוש הארוך ביותר שתיבת החיפוש בחנות מקבלת.',
                        'connection' => 'חיבור',
                    ],
                ],
            ],
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'ביטולי חוזה (האיחוד האירופי)',
        ],
        ...
        'acl' => [
            ...
            'view' => 'הצגה',
            'decline' => 'דחייה',
            'mark-refunded' => 'סימון כהוחזר',
            'resend-confirmation' => 'שליחה חוזרת של אישור',
        ],
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'הפעלה',
                'enabled-info' => 'כאשר מופעל, לקוחות בערוץ זה רואים כפתור "ביטול חוזה" בעמודי פרטי ההזמנה וכן טופס איתור ציבורי בכתובת ‎/withdraw. יש להפעיל רק בערוצים המוכרים לצרכנים באיחוד האירופי.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'ראיות',
            'evidence-note' => 'בלתי ניתן לשינוי — נלכד ברגע ההגשה',
            'status' => 'סטטוס',
            ...
            'timeline' => 'ציר זמן',
            'timeline-received' => 'ההצהרה התקבלה',
            'timeline-received-desc' => 'הלקוח הגיש בקשה לביטול החוזה.',
            'timeline-email' => 'דוא"ל אישור',
            'timeline-email-pending' => 'טרם נשלח',
            'timeline-initial-email' => 'דוא"ל אישור ראשוני',
            'timeline-initial-email-desc-sent' => 'דוא"ל האישור נמסר ללקוח.',
            'timeline-initial-email-desc-error' => 'שליחת דוא"ל האישור הראשוני נכשלה.',
            'timeline-initial-email-desc-pending' => 'דוא"ל האישור הראשוני טרם נשלח.',
            'timeline-final-email' => 'דוא"ל אישור סופי',
            'timeline-final-email-pending' => 'טרם נשלח',
            'timeline-final-email-desc-sent' => 'דוא"ל התוצאה נמסר ללקוח.',
            'timeline-final-email-desc-pending' => 'דוא"ל האישור הסופי טרם נשלח.',
            'timeline-declined' => 'נדחה על ידי המנהל',
            'timeline-declined-desc' => 'הביטול נדחה על ידי :name.',
            'timeline-declined-desc-system' => 'הביטול נדחה.',
            'timeline-declined-reason-label' => 'הסיבה שנמסרה:',
            'timeline-refunded' => 'סומן כהוחזר על ידי המנהל',
            'timeline-refunded-desc' => 'ההחזר בוצע על ידי :name.',
            'timeline-refunded-desc-system' => 'בוצע החזר.',
            'timeline-refunded-note-label' => 'הערת מנהל:',
            'timeline-resolution' => 'החלטה',
            'timeline-resolution-desc' => 'ממתין לבדיקה ולהחלטה של המנהל.',
            'timeline-resolution-pending' => 'ממתין לפעולת המנהל',

            'confirmation-sent-at' => 'מועד שליחת האישור',
            'confirmation-error' => 'שגיאת אישור',
            'declined-at' => 'מועד הדחייה',
            'refunded-at' => 'מועד ההחזר',

            'actions' => 'פעולות',
            'actions-note' => 'החזרים מטופלים ידנית באמצעות כלי ההזמנה / החזר / RMA הקיימים ב-Bagisto. השתמש בפעולות אלו כדי לתעד את התוצאה ברישומי הביטול.',
            'resend-confirmation' => 'שליחה חוזרת של דוא"ל האישור',
            'mark-refunded' => 'סימון כהוחזר',
            'refund-note-label' => 'אסמכתת החזר (לא חובה)',
            'refund-note-placeholder' => 'לדוגמה: החזר מס\' 1234',
            'decline' => 'דחיית הבקשה',
            'decline-reason-label' => 'סיבת הדחייה',
            'decline-reason-placeholder' => 'נמק מדוע הזכאות שנויה במחלוקת',
            'mark-refunded-confirm-msg' => 'לסמן ביטול זה כהוחזר? כל רישום דחייה קודם יימחק.',
            'decline-confirm-msg' => 'לדחות ביטול זה? הסיבה תהיה גלויה ללקוח.',
            'resend-confirmation-confirm-msg' => 'לשלוח שוב את דוא"ל האישור ללקוח?',
            'send-final-confirmation' => 'שליחת דוא"ל אישור סופי',
            'send-final-confirmation-confirm-msg' => 'לשלוח את דוא"ל הסטטוס הסופי ללקוח?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'ערוץ',
            'status' => 'סטטוס',
            'confirmation-sent-at' => 'אישור נשלח',
            'view' => 'הצגה',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'דוא"ל האישור נשלח שוב.',
            'confirmation-failed' => 'שליחת דוא"ל האישור נכשלה. ראה את ציר הזמן לפרטים.',
        ],
    ],
];
