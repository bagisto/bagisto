    ...
    'catalog' => [
        ...
        'categories' => [
            ...
            'create' => [
                ...
                'mobile-banner' => 'באנר לנייד',
                'mobile-banner-size' => 'אופציונלי. אם לא הועלה, ישמש הבאנר הרגיל (1320px X 300px).',
                'name' => 'שם',
    ...
    'settings' => [
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'mobile-logo' => 'לוגו לנייד',
                'mobile-logo-size' => 'אופציונלי. אם לא הועלה, ישמש הלוגו הרגיל (192px X 50px).',
                'name' => 'שם',
