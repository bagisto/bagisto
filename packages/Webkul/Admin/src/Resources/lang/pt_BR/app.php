...
return [
                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'Separe as extensões com vírgulas, por exemplo jpg, png, pdf. Páginas da web, imagens SVG, arquivos XML e scripts nunca são aceitos, mesmo que estejam listados aqui.',
                                'title' => 'Opção',
                                'type' => 'Tipo',
                                'yes' => 'Sim',
                            ],
    ...
    'command-palette' => [
        'placeholder' => 'Buscar menus, configurações, páginas e ações...',
        'esc' => 'ESC',
        'loading' => 'Carregando...',
        'no-results' => 'Nenhum resultado encontrado',
        'no-results-hint' => 'Tente um menu, página, configuração ou ação.',
        'navigate' => 'Navegar',
        'select' => 'Abrir',
        'close' => 'Fechar',
    ...
    'configuration' => [
        'index' => [
            'about' => [
                'info' => 'Em que esta loja funciona e quais serviços ela utiliza.',
                'title' => 'Sobre',
                ...
                'general' => [
                    ...
                    'labels' => [
                        ...
                        'cache' => 'Cache',
                        'composer-version' => 'Versão do Composer',
                        'config' => 'Configuração',
                    ...
                    'drivers' => [
                        'apc' => 'APC',
                        'array' => 'Array (em memória)',
                        'beanstalkd' => 'Beanstalkd',
                        'cookie' => 'Cookie',
                        'custom' => 'Personalizado',
                        'daily' => 'Arquivos diários',
                        'database' => 'Banco de dados',
                        'dynamodb' => 'DynamoDB',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'title' => 'Título',
                    'webhook-secret' => 'Segredo de assinatura do webhook',
                    'webhook-secret-info' => 'O segredo de assinatura do webhook adicionado no painel da Stripe para a URL da sua loja seguida de /stripe/webhook, com os eventos: checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. Aplica-se apenas ao modo de produção.',
                    'webhook-test-secret' => 'Segredo de assinatura do webhook de teste',
                    'webhook-test-secret-info' => 'O segredo de assinatura do webhook adicionado no painel da Stripe para a URL da sua loja seguida de /stripe/webhook, com os eventos: checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. Aplica-se apenas ao modo de teste.',
                ],
                ...
                'checkout' => [
                    ...
                    'info' => 'Compra como visitante, página do carrinho e minicarrinho.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Exibir o minicarrinho, o contador de itens que ele mostra e o texto de oferta nele.',
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'omnibus' => [
                        'title' => 'Divulgação de preços Omnibus',
                        'title-info' => 'Registra instantâneas de preço diárias e exibe o menor preço nos 30 dias anteriores a cada desconto, conforme exigido pela Diretiva Omnibus da UE.',
                        'enable' => 'Habilitar divulgação Omnibus',
                    ],
                ],
            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-type' => 'Autenticação',
                        'auth-type-info' => 'Como o cluster é acessado e autenticado. Apenas os campos necessários são exibidos.',

                        'auth-types' => [
                            'none' => 'Sem autenticação',
                            'basic' => 'Usuário e senha',
                            'api-key' => 'Chave de API',
                            'cloud-api-key' => 'Elastic Cloud com chave de API',
                            'cloud-basic' => 'Elastic Cloud com usuário e senha',
                        ],
                        ...
                        'api-key' => 'Chave de API',
                        'api-key-info' => 'A chave com a qual o cluster é autenticado.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'O Cloud ID da implantação do Elastic Cloud.',
            ...
            'file-management' => [
                ...
                'info' => 'Escolha onde os arquivos enviados são armazenados e configure o serviço de armazenamento.',

                'general' => [
                    'title' => 'Geral',
                    'info' => 'O armazenamento que toda a loja usa para os arquivos enviados.',

                    'settings' => [
                        'title' => 'Configurações',
                        'info' => 'Escolha o armazenamento em que os arquivos são salvos e a partir do qual são servidos.',
                        'default-driver' => 'Driver de armazenamento padrão',
                        'default-driver-info' => 'Os arquivos enviados a partir de agora serão salvos aqui. Os arquivos já enviados permanecem no armazenamento anterior: copie-os antes de trocar, caso contrário não serão encontrados.',

                        'drivers' => [
                            'local' => 'Arquivo (armazenamento local)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Credenciais do Amazon S3 ou de qualquer serviço compatível com sua API.',

                    'settings' => [
                        'title' => 'Configurações',
                        'info' => 'Usado quando o driver de armazenamento padrão está definido como Amazon S3.',
                        'key' => 'ID da chave de acesso',
                        'key-info' => 'O ID da chave de acesso da conta à qual o bucket pertence.',
                        'secret' => 'Chave de acesso secreta',
                        'secret-info' => 'O segredo associado ao ID da chave de acesso.',
                        'region' => 'Região',
                        'region-info' => 'A região em que o bucket foi criado, por exemplo us-east-1.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'O nome do bucket em que os arquivos são armazenados.',
                        'url' => 'URL',
                        'url-info' => 'O endereço a partir do qual os arquivos são servidos. Deixe vazio para usar o endereço fornecido pelo serviço.',
                        'endpoint' => 'Endpoint',
                        'endpoint-info' => 'Necessário apenas para um serviço diferente do Amazon S3, como um auto-hospedado. Deixe vazio para o Amazon S3.',
                        'use-path-style-endpoint' => 'Usar endpoint por caminho',
                        'use-path-style-endpoint-info' => 'Ative para um serviço auto-hospedado que endereça os buckets como caminho em vez de subdomínio.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Credenciais do armazenamento de objetos Cloudflare R2.',

                    'settings' => [
                        'title' => 'Configurações',
                        'info' => 'Usado quando o driver de armazenamento padrão está definido como Cloudflare R2.',
                        'account-id' => 'ID da conta',
                        'account-id-info' => 'A conta Cloudflare à qual o bucket pertence. O endereço do R2 é montado a partir dela, portanto nenhum endpoint é necessário.',
                        'key' => 'ID da chave de acesso',
                        'key-info' => 'O ID da chave de acesso de um token de API do R2.',
                        'secret' => 'Chave de acesso secreta',
                        'secret-info' => 'O segredo associado ao ID da chave de acesso.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'O nome do bucket do R2 em que os arquivos são armazenados.',
                        'url' => 'URL pública',
                        'url-info' => 'O endereço a partir do qual os arquivos são servidos, seja o endereço público do bucket ou um domínio próprio. Um bucket do R2 é privado até que um seja definido, sem ele os arquivos não ficarão acessíveis.',
                    ],
                ],
            ],
    ...
    'components' => [
        'layouts' => [
            'header' => [
                ...
                'mega-search' => [
                    ...
                    'shortcut' => 'Ctrl K',
                    'sku' => 'SKU: :sku',
                    'title' => 'Buscar ou pressione Ctrl + K',
                ],
            ],
        ...
        'date-range-picker' => [
            'presets' => [
                'last-month' => 'Mês passado',
                'last-six-months' => 'Últimos 6 meses',
                'last-thirty-days' => 'Últimos 30 dias',
                'last-three-months' => 'Últimos 3 meses',
                'this-month' => 'Este mês',
                'this-week' => 'Esta semana',
                'this-year' => 'Este ano',
    ...
    'eu-withdrawal' => [
        ...
        'acl' => [
            ...
            'view' => 'Visualizar',
            'decline' => 'Recusar',
            'mark-refunded' => 'Marcar como reembolsado',
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Ativar',
                'enabled-info' => 'Quando ativado, os clientes deste canal veem um botão «Renunciar ao contrato» nas páginas de detalhe do pedido e um formulário público de consulta em /withdraw. Ative-o apenas em canais que vendam a consumidores da UE.',
            ],
        ],
        ...
        'view' => [
            ...
            'heading' => 'Renúncia',
            'back' => 'Voltar à lista',
            'guest-badge' => 'Visitante',

            'evidence' => 'Comprovação',
            'evidence-note' => 'Imutável — capturada no envio',
            'status' => 'Status',
            ...
            'timeline-received' => 'Declaração recebida',
            'timeline-received-desc' => 'O cliente enviou uma solicitação de renúncia ao contrato.',
            'timeline-email' => 'E-mail de confirmação',
            'timeline-email-pending' => 'Ainda não enviado',
            'timeline-initial-email' => 'E-mail de confirmação inicial',
            'timeline-initial-email-desc-sent' => 'E-mail de confirmação entregue ao cliente.',
            'timeline-initial-email-desc-error' => 'Falha ao enviar o e-mail de confirmação inicial.',
            'timeline-initial-email-desc-pending' => 'O e-mail de confirmação inicial ainda não foi enviado.',
            'timeline-final-email' => 'E-mail de confirmação final',
            'timeline-final-email-pending' => 'Ainda não enviado',
            'timeline-final-email-desc-sent' => 'E-mail com o resultado entregue ao cliente.',
            'timeline-final-email-desc-pending' => 'O e-mail de confirmação final ainda não foi enviado.',
            'timeline-declined' => 'Renúncia recusada',
            'timeline-declined-desc' => 'Renúncia recusada por :name.',
            'timeline-declined-desc-system' => 'Renúncia recusada.',
            'timeline-declined-reason-label' => 'Motivo informado:',
            'timeline-refunded' => 'Reembolso emitido',
            'timeline-refunded-desc' => 'Reembolso emitido por :name.',
            'timeline-refunded-desc-system' => 'Reembolso emitido.',
            'timeline-refunded-note-label' => 'Observação do administrador:',
            'timeline-resolution' => 'Resolução pendente',
            'timeline-resolution-desc' => 'Aguardando análise e decisão do administrador.',
            'timeline-resolution-pending' => 'Aguardando ação do administrador',

            'confirmation-sent-at' => 'Confirmação enviada em',
            'confirmation-error' => 'Erro de confirmação',
            'declined-at' => 'Recusada em',
            'refunded-at' => 'Reembolsada em',

            'actions' => 'Ações',
            'actions-note' => 'Os reembolsos são processados manualmente pelas ferramentas existentes do Bagisto (pedido / reembolso / RMA). Use essas ações para registrar o resultado na comprovação da renúncia.',
            'resend-confirmation' => 'Reenviar e-mail de confirmação',
            'mark-refunded' => 'Marcar como reembolsado',
            'refund-note-label' => 'Referência do reembolso (opcional)',
            'refund-note-placeholder' => 'ex.: Reembolso n.º 1234',
            'decline' => 'Recusar renúncia',
            'decline-reason-label' => 'Motivo da recusa',
            'decline-reason-placeholder' => 'Explique por que o direito está sendo contestado',
            'mark-refunded-confirm-msg' => 'Marcar esta renúncia como reembolsada? Qualquer registro anterior de recusa será apagado.',
            'decline-confirm-msg' => 'Recusar esta renúncia? O motivo ficará visível para o cliente.',
            'resend-confirmation-confirm-msg' => 'Reenviar o e-mail de confirmação ao cliente?',
            'send-final-confirmation' => 'Enviar e-mail de confirmação final',
            'send-final-confirmation-confirm-msg' => 'Enviar ao cliente o e-mail com o status final?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'Canal',
            'status' => 'Status',
            'confirmation-sent-at' => 'Confirmação enviada',
            'view' => 'Visualizar',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'O e-mail de confirmação foi reenviado.',
            'confirmation-failed' => 'Não foi possível enviar o e-mail de confirmação. Consulte a linha do tempo para mais detalhes.',
        ],
    ],
];
