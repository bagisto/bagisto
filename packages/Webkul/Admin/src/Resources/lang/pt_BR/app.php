        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'Chave API',
                    'api_publishable_key'            => 'Chave Publicável da API',
                    'api_test_key'                   => 'Chave Secreta de Teste da API',
                    'api_test_publishable_key'       => 'Chave Publicável de Teste da API',
                    'applicable-production'          => 'Aplica-se se o modo de produção for selecionado',
                    'applicable-sandbox'             => 'Aplica-se se o modo de teste for selecionado',
                    'application_fee'                => 'Pagador da Taxa de Aplicação',
                    ...
                    'paid'                           => 'Pago',
                    'payment-method-info'            => 'Opção de pagamento Stripe para empresas online, permitindo que os clientes paguem com cartões de crédito/débito e expandam seus negócios',
                    ...
                    'sort-order'                     => 'Ordem de Classificação',
                    'statement_descriptor'           => 'Descritor de Extrato',
                    'status'                         => 'Status',
                    'stripePayment'                  => 'Pagamento Stripe',
