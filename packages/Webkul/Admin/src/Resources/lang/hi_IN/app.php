...
return [
    ...
    'configuration' => [
        'index' => [
            ...
            'file-management' => [
                'title' => 'फ़ाइल प्रबंधन',
                'info' => 'चुनें कि अपलोड की गई फ़ाइलें कहाँ संग्रहीत हों और संग्रहण सेवा कॉन्फ़िगर करें।',

                'general' => [
                    'title' => 'सामान्य',
                    'info' => 'वह संग्रहण जिसे पूरा स्टोर अपलोड की गई फ़ाइलों के लिए उपयोग करता है।',

                    'settings' => [
                        'title' => 'सेटिंग्स',
                        'info' => 'वह संग्रहण चुनें जिसमें फ़ाइलें सहेजी जाएँ और जहाँ से वे दिखाई जाएँ।',
                        'default-driver' => 'डिफ़ॉल्ट संग्रहण ड्राइवर',
                        'default-driver-info' => 'अब से अपलोड की जाने वाली फ़ाइलें यहाँ सहेजी जाएँगी। पहले अपलोड की गई फ़ाइलें पुराने संग्रहण में ही रहती हैं, इसलिए बदलने से पहले उन्हें कॉपी कर लें अन्यथा वे नहीं मिलेंगी।',

                        'drivers' => [
                            'local' => 'फ़ाइल (स्थानीय संग्रहण)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Amazon S3 या उसके API का समर्थन करने वाली किसी भी सेवा के क्रेडेंशियल।',

                    'settings' => [
                        'title' => 'सेटिंग्स',
                        'info' => 'तब उपयोग किए जाते हैं जब डिफ़ॉल्ट संग्रहण ड्राइवर Amazon S3 पर सेट हो।',
                        'key' => 'एक्सेस की ID',
                        'key-info' => 'उस खाते की एक्सेस की ID जिससे बकेट संबंधित है।',
                        'secret' => 'गुप्त एक्सेस की',
                        'secret-info' => 'एक्सेस की ID के साथ जुड़ी गुप्त कुंजी।',
                        'region' => 'क्षेत्र',
                        'region-info' => 'वह क्षेत्र जिसमें बकेट बनाया गया था, जैसे us-east-1।',
                        'bucket' => 'बकेट',
                        'bucket-info' => 'उस बकेट का नाम जिसमें फ़ाइलें संग्रहीत होती हैं।',
                        'url' => 'URL',
                        'url-info' => 'वह पता जहाँ से फ़ाइलें दिखाई जाती हैं। सेवा द्वारा दिए गए पते का उपयोग करने के लिए इसे खाली छोड़ें।',
                        'endpoint' => 'एंडपॉइंट',
                        'endpoint-info' => 'केवल Amazon S3 के अलावा किसी सेवा के लिए आवश्यक है, जैसे स्वयं होस्ट की गई सेवा। Amazon S3 के लिए खाली छोड़ें।',
                        'use-path-style-endpoint' => 'पाथ शैली एंडपॉइंट उपयोग करें',
                        'use-path-style-endpoint-info' => 'ऐसी स्वयं होस्ट की गई सेवा के लिए सक्षम करें जो बकेट को सबडोमेन के बजाय पाथ के रूप में संबोधित करती है।',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Cloudflare R2 ऑब्जेक्ट संग्रहण के क्रेडेंशियल।',

                    'settings' => [
                        'title' => 'सेटिंग्स',
                        'info' => 'तब उपयोग किए जाते हैं जब डिफ़ॉल्ट संग्रहण ड्राइवर Cloudflare R2 पर सेट हो।',
                        'account-id' => 'खाता ID',
                        'account-id-info' => 'वह Cloudflare खाता जिससे बकेट संबंधित है। R2 का पता इसी से बनता है, इसलिए किसी एंडपॉइंट की आवश्यकता नहीं है।',
                        'key' => 'एक्सेस की ID',
                        'key-info' => 'किसी R2 API टोकन की एक्सेस की ID।',
                        'secret' => 'गुप्त एक्सेस की',
                        'secret-info' => 'एक्सेस की ID के साथ जुड़ी गुप्त कुंजी।',
                        'bucket' => 'बकेट',
                        'bucket-info' => 'उस R2 बकेट का नाम जिसमें फ़ाइलें संग्रहीत होती हैं।',
                        'url' => 'सार्वजनिक URL',
                        'url-info' => 'वह पता जहाँ से फ़ाइलें दिखाई जाती हैं, या तो बकेट का सार्वजनिक पता या कोई कस्टम डोमेन। R2 बकेट तब तक निजी रहता है जब तक पता सेट नहीं किया जाता, इसके बिना फ़ाइलें पहुँच योग्य नहीं होंगी।',
                    ],
                ],
            ],
