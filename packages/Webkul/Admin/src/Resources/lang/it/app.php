...
return [
                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'Separa le estensioni con virgole, ad esempio jpg, png, pdf. Pagine web, immagini SVG, file XML e script non vengono mai accettati, anche se elencati qui.',
                                'title' => 'Opzione',
                                'type' => 'Tipo',
                                'yes' => 'Sì',
                            ],
    ...
    'command-palette' => [
        'placeholder' => 'Cerca menu, impostazioni, pagine e azioni...',
        'esc' => 'ESC',
        'loading' => 'Caricamento...',
        'no-results' => 'Nessun risultato',
        'no-results-hint' => 'Prova con un menu, una pagina, unimpostazione o unazione.',
        'navigate' => 'Naviga',
        'select' => 'Apri',
        'close' => 'Chiudi',

        'all' => 'Tutti i :resource',
        'back' => 'Indietro',
        'context-placeholder' => 'Cerca in :context...',

        'start-typing' => 'Digita per cercare',
        'record-actions' => [
            'view' => 'Vedi',
            'edit' => 'Modifica',
            'duplicate' => 'Duplica',
    ...
    'configuration' => [
        'index' => [
            'about' => [
                'info' => 'Su cosa gira questo negozio e quali servizi utilizza.',
                'title' => 'Informazioni',
                ...
                'general' => [
                    ...
                    'labels' => [
                        ...
                        'broadcast' => 'Broadcast',
                        'cache' => 'Cache',
                        'composer-version' => 'Versione di Composer',
                        ...
                        'environment' => 'Ambiente',
                        'events' => 'Eventi',
                        'laravel-version' => 'Versione di Laravel',
                        'link' => 'Collegamento pubblico',
                        'locale' => 'Lingua',
                        'log' => 'Registro',
                        'maintenance-mode' => 'Modalità manutenzione',
            ...
            'sales' => [
                ...
                'checkout' => [
                    'title' => 'Checkout',
                    'info' => 'Acquisto come ospite, pagina del carrello e mini carrello.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Mostra il mini carrello, il contatore di articoli che visualizza e il testo dell\'offerta al suo interno.',
            ...
            'search-engines' => [
                ...
                'info' => 'Scegli il motore che alimenta la ricerca dei prodotti e configuralo.',
                ...
                'test-connection' => [
                    'title' => 'Prova connessione',
                    'testing' => 'Prova in corso...',

                    'statuses' => [
                        'available' => ':engine è disponibile',
                        'unreachable' => ':engine non ha risposto',
                        'unauthorized' => ':engine ha rifiutato le credenziali',
                        'incompatible' => 'Lhost ha risposto ma non è un server :engine supportato',
                        'misconfigured' => 'La connessione a :engine non è configurata',
                    ],
                ],

                'general' => [
                    'title' => 'Generale',
                    'info' => 'Il motore su cui gira la ricerca dei prodotti.',

                    'settings' => [
                        'title' => 'Impostazioni',
                        'info' => 'Attiva un motore di ricerca esterno e scegli dove viene usato.',
                        'enabled' => 'Abilita motore di ricerca esterno',
                        'enabled-info' => 'Disattivalo per cercare ovunque nel database, qualunque cosa dicano le impostazioni sottostanti.',
                        'engine' => 'Motore di ricerca predefinito',
                        'engine-info' => 'Il motore usato ovunque una modalità di ricerca resti su Usa predefinito.',
                        'inherit' => 'Usa predefinito',
                    ],

                    'products' => [
                        'title' => 'Prodotti',
                        'info' => 'Con quale motore ciascun lato del negozio cerca i prodotti.',
                        'admin-mode' => 'Modalità di ricerca del pannello',
                        'admin-mode-info' => 'Il motore dietro la mega ricerca, le griglie dati e le altre ricerche del pannello di amministrazione.',
                        'storefront-mode' => 'Modalità di ricerca del negozio',
                        'storefront-mode-info' => 'Il motore dietro le pagine categoria, la pagina di ricerca e le altre ricerche del negozio.',
                    ],
                ],

                'elastic' => [
                    'info' => 'Stato della connessione e limiti di query per Elasticsearch.',

                    'settings' => [
                        'title' => 'Impostazioni',
                        'info' => 'Usato quando una modalità di ricerca è impostata su Elasticsearch.',
                        'auth-type' => 'Autenticazione',
                        'auth-type-info' => 'Come viene raggiunto il cluster e come si accede. Vengono mostrati solo i campi necessari.',

                        'auth-types' => [
                            'none' => 'Nessuna autenticazione',
                            'basic' => 'Nome utente e password',
                            'api-key' => 'Chiave API',
                            'cloud-api-key' => 'Elastic Cloud con chiave API',
                            'cloud-basic' => 'Elastic Cloud con nome utente e password',
                        ],

                        'hosts' => 'Host',
                        'hosts-info' => 'Dove si raggiunge il cluster, ad esempio http://localhost:9200. Separa più host con una virgola. Lascia vuoto per usare il file di ambiente.',
                        'username' => 'Nome utente',
                        'username-info' => 'Usato con lautenticazione di base. Lascia vuoto se il cluster non la richiede.',
                        'password' => 'Password',
                        'password-info' => 'La password abbinata al nome utente.',
                        'api-key' => 'Chiave API',
                        'api-key-info' => 'La chiave con cui si accede al cluster.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Il Cloud ID del deployment Elastic Cloud.',
                        'index-prefix' => 'Prefisso indice',
                        'index-prefix-info' => 'Anteposto a ogni nome di indice, così più negozi possono condividere un cluster.',
                        'min-query-length' => 'Lunghezza minima della query',
                        'min-query-length-info' => 'Il termine di ricerca più breve accettato dal campo di ricerca del negozio.',
                        'max-query-length' => 'Lunghezza massima della query',
                        'max-query-length-info' => 'Il termine di ricerca più lungo accettato dal campo di ricerca del negozio.',
            ...
            'file-management' => [
                ...
                'info' => 'Scegli dove vengono archiviati i file caricati e configura il servizio di archiviazione.',

                'general' => [
                    'title' => 'Generale',
                    'info' => 'L\'archiviazione utilizzata da tutto il negozio per i file caricati.',

                    'settings' => [
                        'title' => 'Impostazioni',
                        'info' => 'Scegli l\'archiviazione in cui i file vengono salvati e da cui vengono serviti.',
                        'default-driver' => 'Driver di archiviazione predefinito',
                        'default-driver-info' => 'I file caricati d\'ora in poi verranno salvati qui. I file già caricati restano sull\'archiviazione precedente: copiali prima di cambiare, altrimenti non verranno trovati.',

                        'drivers' => [
                            'local' => 'File (archiviazione locale)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'Credenziali per Amazon S3 o per qualsiasi servizio compatibile con la sua API.',

                    'settings' => [
                        'title' => 'Impostazioni',
                        'info' => 'Utilizzate quando il driver di archiviazione predefinito è Amazon S3.',
                        'key' => 'ID chiave di accesso',
                        'key-info' => 'L\'ID della chiave di accesso dell\'account a cui appartiene il bucket.',
                        'secret' => 'Chiave di accesso segreta',
                        'secret-info' => 'Il segreto abbinato all\'ID della chiave di accesso.',
                        'region' => 'Regione',
                        'region-info' => 'La regione in cui è stato creato il bucket, ad esempio us-east-1.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'Il nome del bucket in cui vengono archiviati i file.',
                        'url' => 'URL',
                        'url-info' => 'L\'indirizzo da cui vengono serviti i file. Lascia vuoto per usare l\'indirizzo fornito dal servizio.',
                        'endpoint' => 'Endpoint',
                        'endpoint-info' => 'Necessario solo per un servizio diverso da Amazon S3, ad esempio self-hosted. Lascia vuoto per Amazon S3.',
                        'use-path-style-endpoint' => 'Usa endpoint con percorso',
                        'use-path-style-endpoint-info' => 'Attiva per un servizio self-hosted che indirizza i bucket come percorso anziché come sottodominio.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'Credenziali per l\'archiviazione di oggetti Cloudflare R2.',

                    'settings' => [
                        'title' => 'Impostazioni',
                        'info' => 'Utilizzate quando il driver di archiviazione predefinito è Cloudflare R2.',
                        'account-id' => 'ID account',
                        'account-id-info' => 'L\'account Cloudflare a cui appartiene il bucket. L\'indirizzo di R2 viene costruito da esso, quindi non serve alcun endpoint.',
                        'key' => 'ID chiave di accesso',
                        'key-info' => 'L\'ID della chiave di accesso di un token API R2.',
                        'secret' => 'Chiave di accesso segreta',
                        'secret-info' => 'Il segreto abbinato all\'ID della chiave di accesso.',
                        'bucket' => 'Bucket',
                        'bucket-info' => 'Il nome del bucket R2 in cui vengono archiviati i file.',
                        'url' => 'URL pubblico',
                        'url-info' => 'L\'indirizzo da cui vengono serviti i file, l\'indirizzo pubblico del bucket oppure un dominio personalizzato. Un bucket R2 è privato finché non ne viene impostato uno, senza di esso i file non saranno raggiungibili.',
                    ],
                ],
            ],
    ...
    'components' => [
        ...
        'datagrid' => [
            'index' => [
                'action-error' => 'Si è verificato un errore',
        ...
        'date-range-picker' => [
            'presets' => [
                'last-month' => 'Ultimo Mese',
                'last-six-months' => 'Ultimi 6 Mesi',
                'last-thirty-days' => 'Ultimi 30 Giorni',
                'last-three-months' => 'Ultimi 3 Mesi',
                'this-month' => 'Questo Mese',
                'this-week' => 'Questa Settimana',
                'this-year' => 'Questo Anno',
    ...
    'eu-withdrawal' => [
        ...
        'acl' => [
            ...
            'view' => 'Visualizza',
            'decline' => 'Rifiuta',
            'mark-refunded' => 'Segna come rimborsato',
            'resend-confirmation' => 'Invia di nuovo la conferma',
        ],
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Attiva',
                'enabled-info' => 'Quando è abilitato, i clienti di questo canale vedono un pulsante «Recedere dal contratto» nelle pagine di dettaglio dell’ordine e un modulo pubblico di ricerca su /withdraw. Abilitare solo nei canali rivolti ai consumatori dell’UE.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Prova',
            'evidence-note' => 'Immutabile — acquisita al momento dell’invio',
            'status' => 'Stato',
            ...
            'timeline' => 'Cronologia',
            'timeline-received' => 'Dichiarazione ricevuta',
            'timeline-received-desc' => 'Il cliente ha inviato una richiesta di recesso dal contratto.',
            'timeline-email' => 'E-mail di conferma',
            'timeline-email-pending' => 'Non ancora inviata',
            'timeline-initial-email' => 'E-mail di conferma iniziale',
            'timeline-initial-email-desc-sent' => 'E-mail di conferma consegnata al cliente.',
            'timeline-initial-email-desc-error' => 'Invio dell’e-mail di conferma iniziale non riuscito.',
            'timeline-initial-email-desc-pending' => 'L’e-mail di conferma iniziale non è ancora stata inviata.',
            'timeline-final-email' => 'E-mail di conferma finale',
            'timeline-final-email-pending' => 'Non ancora inviata',
            'timeline-final-email-desc-sent' => 'E-mail con l’esito consegnata al cliente.',
            'timeline-final-email-desc-pending' => 'L’e-mail di conferma finale non è ancora stata inviata.',
            'timeline-declined' => 'Recesso rifiutato',
            'timeline-declined-desc' => 'Recesso rifiutato da :name.',
            'timeline-declined-desc-system' => 'Recesso rifiutato.',
            'timeline-declined-reason-label' => 'Motivazione indicata:',
            'timeline-refunded' => 'Rimborso emesso',
            'timeline-refunded-desc' => 'Rimborso emesso da :name.',
            'timeline-refunded-desc-system' => 'Rimborso emesso.',
            'timeline-refunded-note-label' => 'Nota dell’amministratore:',
            'timeline-resolution' => 'Decisione in sospeso',
            'timeline-resolution-desc' => 'In attesa di esame e decisione dell’amministratore.',
            'timeline-resolution-pending' => 'In attesa di azione dell’amministratore',

            'confirmation-sent-at' => 'Conferma inviata il',
            'confirmation-error' => 'Errore di conferma',
            'declined-at' => 'Rifiutato il',
            'refunded-at' => 'Rimborsato il',

            'actions' => 'Azioni',
            'actions-note' => 'I rimborsi vengono elaborati manualmente con gli strumenti di Bagisto già esistenti (ordine / rimborso / RMA). Utilizzare queste azioni per registrare l’esito sulla prova di recesso.',
            'resend-confirmation' => 'Invia di nuovo l’e-mail di conferma',
            'mark-refunded' => 'Segna come rimborsato',
            'refund-note-label' => 'Riferimento del rimborso (facoltativo)',
            'refund-note-placeholder' => 'es. Rimborso n. 1234',
            'decline' => 'Rifiuta recesso',
            'decline-reason-label' => 'Motivazione del rifiuto',
            'decline-reason-placeholder' => 'Spiegare perché il diritto è contestato',
            'mark-refunded-confirm-msg' => 'Segnare questo recesso come rimborsato? Eventuali registrazioni di rifiuto precedenti verranno cancellate.',
            'decline-confirm-msg' => 'Rifiutare questo recesso? La motivazione sarà visibile al cliente.',
            'resend-confirmation-confirm-msg' => 'Inviare di nuovo l’e-mail di conferma al cliente?',
            'send-final-confirmation' => 'Invia l’e-mail di conferma finale',
            'send-final-confirmation-confirm-msg' => 'Inviare al cliente l’e-mail con lo stato finale?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'Canale',
            'status' => 'Stato',
            'confirmation-sent-at' => 'Conferma inviata',
            'view' => 'Visualizza',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'L’e-mail di conferma è stata inviata di nuovo.',
            'confirmation-failed' => 'Impossibile inviare l’e-mail di conferma. Consultare la cronologia per maggiori dettagli.',
        ],
    ],
];
