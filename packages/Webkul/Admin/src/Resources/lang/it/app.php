...
return [
    ...
    'admin' => [
        ...
        'system' => [
            ...
            'allow-no-of-new-product-homepage' => 'Nuovi prodotti da visualizzare in Homepage',
            'allow-no-of-featured-product-homepage' => 'Prodotti consigliati da visualizzare in Homepage',
            'allow-out-of-stock-items' => 'Consenti prodotti esauriti',
            'products' => 'Prodotti',
            'guest-checkout' => 'Checkout come ospite',
            'allow-guest-checkout' => 'Consenti il checkout dei prodotti agli utenti non registrati',
            'allow-guest-checkout-hint' => 'Hint: se attiva, questa opzione può essere configurata per ciascun singolo prodotto.',
            'review' => 'Recensione',
            'allow-guest-review' => 'Consenti Recensioni agli utenti non registrati',
            'inventory' => 'Magazzino',
            'stock-options' => 'Opzioni Stock',
            'allow-backorders' => 'Consenti Backorders',
            'customer' => 'Cliente',
            'wishlist' => 'Wishlist',
            'wishlist-share' => 'Abilita Sharing',
            'settings' => 'Impostazioni',
            'address' => 'Indirizzo',
            'street-lines' => 'Linee campo indirizzo',
            'sales' => 'Vendite',
            'shipping-methods' => 'Metodi di Spedizione',
            'free-shipping' => 'Spedizione Gratuita',
            'flate-rate-shipping' => 'Spedizione a prezzo fisso',
            'shipping' => 'Spedizione',
            'origin' => 'Origine',
            'country' => 'Paese',
            'state' => 'Provincia',
            ...
            'footer-toggle' => 'Mostra footer',
            'locale-options' => 'Opzioni Unità',
            'weight-unit' => 'Unità di peso',
            'email-settings'    => 'Impostazioni Email',
            'email-sender-name' => 'Nome Mittente Email',
            'email-sender-name-tip' => 'Il nome visualizzato dal cliente quando riceverà un email',
            'shop-email-from'   => 'Indirizzo Email Negozio (per invio email)',
            'shop-email-from-tip' => 'L\' indirizzo di questo negozio per inviare le email ai tuoi clienti',
            'admin-name' => 'Nome Admin',
            'admin-name-tip' => 'Nome da visualizzare nelle email dell\' Admin',
            'admin-email' => 'Email Admin',
            'admin-email-tip' => 'L\'indirizzo email dell\' Admin per ricevere email da questo canale',
            'admin-page-limit' => 'Numero di risultati per Pagina (Admin)',
            'design' => 'Design',
            'admin-logo' => 'Logo Admin',
            'logo-image' => 'Immagine Logo',
            'credit-max' => 'Credito cliente massimo',
            'credit-max-value' => 'Valore massimo del credito',
            'use-credit-max' => 'Usa tutto il credito',
            'order-settings' => 'Impostazioni Ordini',
            ...
            'order-number-generator-class' => 'Generatore numero ordine',
            'minimum-order' => 'Impostazioni ordine minimo',
            ...
            'invoice-number-generator-class' => 'Generatore codice fattura',
            'payment-terms' => 'Termini di pagamento',
            'due-duration' => 'Scadenza',
            'due-duration-day' => ':due-duration giorno',
            'due-duration-days' => ':due-duration giorni',
            'invoice-slip-design' => 'Aspetto della Fattura',
            'logo' => 'Logo',
            'default' => 'Default',
            'invoice-reminders' => 'Memo fattura',
            'maximum-limit-of-reminders' => 'Limite massimo di promemoria',
            'interval-between-reminders' => 'Intervallo tra ciascun promemoria',
            'sandbox' => 'Sandbox',
            'all-channels' => 'Tutti',
            'all-locales' => 'Tutti',
            ...
            'enable' => 'Abilita',
            'show-weight' => 'Visualizza Peso',
            'show-categories' => 'Visualizza Categorie',
            'show-images' => 'Mostra Immagini',
            'show-reviews' => 'Mostra Recensioni',
            'show-ratings' => 'Mostra Rating',
            'show-offers' => 'Mostra Offerte',
            'show-sku' => 'Visualizza SKU',
            'categories' => 'Categorie',
            ...
            'mailing-address' => 'Indirizzo invio',
            'instructions' => 'Istruzioni',
            'custom-scripts' => 'Script Custom',
            'custom-css' => 'CSS Custom',
            'custom-javascript' => 'Custom Javascript',
            'paypal-smart-button' => 'PayPal',
            'client-id' => 'Id Cliente',
            'client-id-info' => 'Usare "sb" per testare.',
            'client-secret' => 'Chiave segreta Client',
            'client-secret-info' => 'Scrivi qui la chiave segreta',
            'accepted-currencies' => 'Valute accettate',
            'accepted-currencies-info' => 'Aggiungi codice valuta separato da virgola es. EUR, USD, ...',
            'buy-now-button-display' => 'Consenti ai clienti di acquistare i prodotti direttamente',
            'width' => 'Lunghezza',
            'height' => 'Altezza',
            'cache-small-image' => 'Immagine piccola',
            'cache-medium-image' => 'Immagine media',
            'cache-large-image' => 'Immagine grande',
            'generate-invoice'   => 'Genera la fattura automaticamente, dopo la registrazione di un ordine',
            'set-invoice-status' => 'Imposta lo stato della fattura dopo la sua creazione',
            'set-order-status'   => 'Imposta lo stato dell\'ordine dopo la creazione della fattura',
