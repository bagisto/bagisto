                    ...
                    'simple' => [
                        'customizable-options' => [
                            ...
                            'update-create' => [
                                ...
                                'supported-file-extensions-info' => 'Separate extensions with commas, for example jpg, png, pdf. Web pages, SVG images, XML and script files are never accepted, even when listed here.',
                                'title' => 'Option',
                                'type' => 'Type',
                                'yes' => 'Yes',
                            ],
    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    'title' => 'Checkout',
                    'info' => 'Guest checkout, the cart page and the mini cart.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Show the mini cart, the item count it displays, and the offer text inside it.',
            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-type-info' => 'How the cluster is reached and signed in to. Only the fields it needs are shown.',

                        'auth-types' => [
                            'none' => 'No authentication',
                            'basic' => 'Username and password',
                            'api-key' => 'API key',
                            'cloud-api-key' => 'Elastic Cloud with API key',
                            'cloud-basic' => 'Elastic Cloud with username and password',
                        ],
                        ...
                        'api-key' => 'API Key',
                        'api-key-info' => 'The key the cluster is signed in to with.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'The Cloud ID of the Elastic Cloud deployment.',
            ...
            'cache-management' => [
                ...
                'action-failed' => ':action failed. Check the output below.',
                ...
                'full-page-cache' => [
                    ...
                    'settings' => [
                        ...
                        'flush-info' => 'Empty the page cache so every storefront page is rendered again on its next visit.',
                    ],
                ],
            ],
        ],
    ...
    'eu-withdrawal' => [
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Enable',
                'enabled-info' => 'When enabled, customers on this channel see a "Withdraw from contract" button on order detail pages and a public /withdraw lookup form. Only enable on channels selling to EU consumers.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Evidence',
            'evidence-note' => 'Immutable — captured at submission',
            'status' => 'Status',
            'received-at' => 'Received At',
            'uuid' => 'Reference',
            'copy-reference' => 'Copy reference',
            'reference-copied' => 'Reference copied to clipboard.',
            'order' => 'Order',
            'customer-email' => 'Customer Email',
            'is-guest' => 'Guest',
            'channel' => 'Channel',
            ...
            'timeline' => 'Timeline',
            'timeline-received' => 'Declaration Received',
            'timeline-received-desc' => 'The customer submitted a withdrawal-from-contract request.',
            'timeline-email' => 'Confirmation email',
            'timeline-email-pending' => 'Not yet sent',
            'timeline-initial-email' => 'Initial Confirmation Email',
            'timeline-initial-email-desc-sent' => 'Confirmation email delivered to the customer.',
            'timeline-initial-email-desc-error' => 'Initial confirmation email failed to send.',
            'timeline-initial-email-desc-pending' => 'Initial confirmation email has not been sent yet.',
            'timeline-final-email' => 'Final Confirmation Email',
            'timeline-final-email-pending' => 'Not yet sent',
            'timeline-final-email-desc-sent' => 'Outcome email delivered to the customer.',
            'timeline-final-email-desc-pending' => 'Final confirmation email has not been sent yet.',
            'timeline-declined' => 'Withdrawal Declined',
            'timeline-declined-desc' => 'Withdrawal declined by :name.',
            'timeline-declined-desc-system' => 'Withdrawal declined.',
            'timeline-declined-reason-label' => 'Reason given:',
            'timeline-refunded' => 'Refund Issued',
            'timeline-refunded-desc' => 'Refund issued by :name.',
            'timeline-refunded-desc-system' => 'Refund issued.',
            'timeline-refunded-note-label' => 'Admin note:',
            'timeline-resolution' => 'Resolution Pending',
            'timeline-resolution-desc' => 'Awaiting admin review and decision.',
            'timeline-resolution-pending' => 'Awaiting admin action',
            ...
            'actions' => 'Actions',
            'actions-note' => 'Refunds are processed manually via Bagisto’s existing order / refund / RMA tools. Use these actions to record the outcome on the withdrawal evidence.',
            'resend-confirmation' => 'Resend Confirmation Email',
            'mark-refunded' => 'Mark as Refunded',
            'refund-note-label' => 'Refund reference (optional)',
            'refund-note-placeholder' => 'e.g. Refund #1234',
            'decline' => 'Decline Withdrawal',
            'decline-reason-label' => 'Reason for declining',
            'decline-reason-placeholder' => 'Explain why entitlement is contested',
            'mark-refunded-confirm-msg' => 'Mark this withdrawal as refunded? Any previous decline record will be cleared.',
            'decline-confirm-msg' => 'Decline this withdrawal? The reason will be visible to the customer.',
            'resend-confirmation-confirm-msg' => 'Resend the confirmation email to the customer?',
            'send-final-confirmation' => 'Send Final Confirmation Email',
            'send-final-confirmation-confirm-msg' => 'Send the final status email to the customer?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'Channel',
            'status' => 'Status',
            'confirmation-sent-at' => 'Confirmation Sent',
            'view' => 'View',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'Confirmation email has been resent.',
            'confirmation-failed' => 'Could not send the confirmation email. See the timeline for details.',
        ],
    ],
];
