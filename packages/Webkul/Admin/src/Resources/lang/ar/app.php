...
return [
    ...
    'response' => [
        ...
        'last-delete-error' => 'مطلوب اسم :واحد على الأقل',
        'user-define-error' => 'لا يستطيع حذف نظام :name',
        'attribute-error' => 'يستخدم الاسم في المنتجات القابلة للتكوين:',
        'attribute-product-error' => 'يستخدم الاسم في المنتجات:',
        'customer-associate' => 'لا يمكن حذف الاسم لأن العميل مرتبط بهذه المجموعة :',
        'currency-delete-error' => 'يتم تعيين هذه العملة كعملة أساسية القناة لذلك لا يمكن حذفها.',
        'upload-success' => 'تم تحميل الاسم بنجاح:',
        'delete-category-root' => 'لا يستطيع حذف الجذر الفئة',
        'create-root-failure' => 'الفئة مع الاسم الجذر موجود',
        'cancel-success' => 'تم إلغاء الاسم بنجاح:',
        'cancel-error' => 'لا يمكن إلغاء الاسم :',
        'already-taken' => 'الاسم: تم استخدامه بالفعل',
