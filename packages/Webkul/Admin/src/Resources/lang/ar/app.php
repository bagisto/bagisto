        ...
        'index' => [
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'omnibus' => [
                        'title' => 'الإفصاح عن أسعار أومنيبوس',
                        'title-info' => 'تسجيل لقطات أسعار يومية وعرض أقل سعر خلال الـ 30 يومًا السابقة لكل خصم، وفقًا لتوجيه أومنيبوس الأوروبي.',
                        'enable' => 'تمكين الإفصاح عن أومنيبوس',
                    ],
                ],
            ...
            'file-management' => [
                'title' => 'إدارة الملفات',
                'info' => 'اختر مكان تخزين الملفات المرفوعة واضبط إعدادات خدمة التخزين.',

                'general' => [
                    'title' => 'عام',
                    'info' => 'وحدة التخزين التي يستخدمها المتجر بأكمله للملفات المرفوعة.',

                    'settings' => [
                        'title' => 'الإعدادات',
                        'info' => 'اختر وحدة التخزين التي تُحفظ فيها الملفات وتُقدَّم منها.',
                        'default-driver' => 'مشغّل التخزين الافتراضي',
                        'default-driver-info' => 'ستُحفظ الملفات المرفوعة من الآن فصاعدًا هنا. أما الملفات المرفوعة سابقًا فتبقى في وحدة التخزين السابقة، لذا انسخها قبل التبديل وإلا فلن يتم العثور عليها.',

                        'drivers' => [
                            'local' => 'ملف (تخزين محلي)',
                            's3' => 'Amazon S3',
                            'r2' => 'Cloudflare R2',
                        ],
                    ],
                ...
                'amazon-s3' => [
                    'title' => 'Amazon S3',
                    'info' => 'بيانات الاعتماد الخاصة بـ Amazon S3 أو أي خدمة تدعم واجهة برمجة التطبيقات نفسها.',

                    'settings' => [
                        'title' => 'الإعدادات',
                        'info' => 'تُستخدم عند ضبط مشغّل التخزين الافتراضي على Amazon S3.',
                        'key' => 'معرّف مفتاح الوصول',
                        'key-info' => 'معرّف مفتاح الوصول للحساب الذي تنتمي إليه الحاوية.',
                        'secret' => 'مفتاح الوصول السري',
                        'secret-info' => 'المفتاح السري المقترن بمعرّف مفتاح الوصول.',
                        'region' => 'المنطقة',
                        'region-info' => 'المنطقة التي أُنشئت فيها الحاوية، مثل us-east-1.',
                        'bucket' => 'الحاوية',
                        'bucket-info' => 'اسم الحاوية التي تُخزَّن فيها الملفات.',
                        'url' => 'الرابط',
                        'url-info' => 'العنوان الذي تُقدَّم منه الملفات. اتركه فارغًا لاستخدام العنوان الذي توفره الخدمة.',
                        'endpoint' => 'نقطة النهاية',
                        'endpoint-info' => 'مطلوبة فقط لخدمة غير Amazon S3، مثل خدمة مستضافة ذاتيًا. اتركها فارغة مع Amazon S3.',
                        'use-path-style-endpoint' => 'استخدام نقطة نهاية بنمط المسار',
                        'use-path-style-endpoint-info' => 'فعّل هذا الخيار لخدمة مستضافة ذاتيًا تعنون الحاويات كمسار بدلًا من نطاق فرعي.',
                    ],
                ],

                'cloudflare-r2' => [
                    'title' => 'Cloudflare R2',
                    'info' => 'بيانات الاعتماد الخاصة بتخزين الكائنات Cloudflare R2.',

                    'settings' => [
                        'title' => 'الإعدادات',
                        'info' => 'تُستخدم عند ضبط مشغّل التخزين الافتراضي على Cloudflare R2.',
                        'account-id' => 'معرّف الحساب',
                        'account-id-info' => 'حساب Cloudflare الذي تنتمي إليه الحاوية. يُبنى عنوان R2 منه، لذا لا حاجة إلى نقطة نهاية.',
                        'key' => 'معرّف مفتاح الوصول',
                        'key-info' => 'معرّف مفتاح الوصول لرمز واجهة برمجة تطبيقات R2.',
                        'secret' => 'مفتاح الوصول السري',
                        'secret-info' => 'المفتاح السري المقترن بمعرّف مفتاح الوصول.',
                        'bucket' => 'الحاوية',
                        'bucket-info' => 'اسم حاوية R2 التي تُخزَّن فيها الملفات.',
                        'url' => 'الرابط العام',
                        'url-info' => 'العنوان الذي تُقدَّم منه الملفات، سواء العنوان العام للحاوية أو نطاق مخصص. تبقى حاوية R2 خاصة إلى أن يُضبط عنوان، وبدونه لن تكون الملفات متاحة.',
                    ],
                ],
            ],
