        ...
        'index' => [
            ...
            'general' => [
                ...
                'content' => [
                    ...
                    'speculation-rules' => [
                        'info'  => 'قم بتكوين الإعدادات لتمكين أو تعطيل منطق التنبؤ التلقائي.',
                        'title' => 'قواعد التنبؤ',

                        'settings' => [
                            'eagerness'              => 'مستوى الحماسة',
                            'eager'                  => 'متحمس',
                            'moderate'               => 'متوسط',
                            'conservative'           => 'محافظ',
                            'eagerness-info'         => 'يتحكم في مدى تطبيق قواعد التنبؤ بشكل عدواني. الخيارات: متحمس (أقصى), متوسط (افتراضي), محافظ (أدنى).',
                            'ignore-url-params'      => 'تجاهل معلمات URL',
                            'ignore-url-params-info' => 'حدد معلمات URL التي يجب تجاهلها في قواعد التنبؤ. استخدم رمز | للفصل بين المعلمات.',
                            'ignore-urls'            => 'تجاهل عناوين URL',
                            'ignore-urls-info'       => 'أدخل عناوين URL التي يجب استبعادها من منطق التنبؤ. افصل بين عناوين متعددة باستخدام |.',
                            'info'                   => 'قم بتعيين حالة قواعد التنبؤ.',
                            'title'                  => 'تمكين قواعد التنبؤ',
                        ],
                    ],
