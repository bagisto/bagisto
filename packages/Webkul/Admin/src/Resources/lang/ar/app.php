...
return [
    'users' => [
        ...
        'verify' => [
            ...
            'disabled-message' => 'التحقق من المصادقة الثنائية معطل حالياً من قبل المسؤول.',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'مفتاح API',
                    'api_publishable_key'            => 'مفتاح API القابل للنشر',
                    'api_test_key'                   => 'مفتاح API التجريبي السري',
                    'api_test_publishable_key'       => 'مفتاح API التجريبي القابل للنشر',
                    'applicable-production'          => 'ينطبق إذا تم اختيار وضع الإنتاج',
                    'applicable-sandbox'             => 'ينطبق إذا تم اختيار وضع الاختبار',
                    'application_fee'                => 'دافع رسوم التطبيق',
                    ...
                    'paid'                           => 'مدفوع',
                    'payment-method-info'            => 'خيار الدفع Stripe للأعمال عبر الإنترنت، يتيح للعملاء الدفع ببطاقات الائتمان/الخصم الخاصة بهم، وتنمية أعمالك',
                    'payment-success'                => 'تم إكمال الدفع بنجاح.',
                    ...
                    'sort-order'                     => 'ترتيب الفرز',
                    'statement_descriptor'           => 'وصف كشف الحساب',
                    'status'                         => 'الحالة',
                    'stripePayment'                  => 'الدفع عبر Stripe',
                    'stripe_refund'                  => 'استرداد Stripe',
                    'title'                          => 'العنوان',
                ],
