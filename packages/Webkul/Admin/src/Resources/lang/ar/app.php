        ...
        'index' => [
            ...
            'customer' => [
                ...
                'social-login' => [
                    ...
                    'info'  => 'إعداد تسجيل الدخول الاجتماعي',

                    'google-details' => [
                        'title'      => 'تفاصيل جوجل',
                        'title-info' => 'قم بتكوين بيانات اعتماد Google Auth لتمكين تسجيل الدخول عبر Google.',
                        ...
                        'client-secret' => [
                            ...
                            'title-info' => 'المفتاح السري المرتبط بعميل Google Auth الخاص بك. احتفظ به سريًا.',
                        ],

                        'redirect' => [
                            'title'      => 'إعادة التوجيه',
                            'title-info' => 'عنوان URL الذي يتم إعادة توجيه المستخدمين إليه بعد المصادقة مع Google. يجب أن يتطابق مع ما تم تعيينه في وحدة تحكم Google.',
                        ],
                    ],

                    'facebook-details' => [
                        'title'      => 'تفاصيل فيسبوك',
                        'title-info' => 'قم بتكوين بيانات اعتماد Facebook Auth لتمكين تسجيل الدخول عبر Facebook.',

                        'client-id' => [
                            'title'      => 'معرف التطبيق',
                            'title-info' => 'معرف التطبيق المقدم من Facebook عند إنشاء تطبيق في وحدة تحكم مطوري Facebook.',
                        ],

                        'client-secret' => [
                            'title'      => 'السر الخاص بالتطبيق',
                            'title-info' => 'السر المرتبط بتطبيق Facebook الخاص بك. احتفظ به آمنًا وسريًا.',
                        ],

                        'redirect' => [
                            'title'      => 'عنوان URL لإعادة التوجيه',
                            'title-info' => 'عنوان URL الذي يتم إعادة توجيه المستخدمين إليه بعد المصادقة مع Facebook. يجب أن يتطابق مع ما تم تكوينه في إعدادات تطبيق Facebook الخاص بك.',
                        ],
                    ],

                    'github-details' => [
                        'title'      => 'تفاصيل Github',
                        'title-info' => 'قم بتكوين بيانات اعتماد Github Auth لتمكين تسجيل الدخول عبر Github.',
                        ...
                        'client-secret' => [
                            'title'      => 'السر الخاص بالعميل',
                            'title-info' => 'المفتاح السري المرتبط بعميل Github Auth الخاص بك. احتفظ به سريًا.',
                        ],

                        'redirect' => [
                            'title'      => 'عنوان URL لإعادة التوجيه',
                            'title-info' => 'عنوان URL الذي يتم إعادة توجيه المستخدمين إليه بعد المصادقة مع Github. يجب أن يتطابق مع ما تم تعيينه في وحدة تحكم Github.',
                        ],
                    ],

                    'linkedin-openid-details' => [
                        'title'      => 'تفاصيل لينكد إن',
                        'title-info' => 'قم بتكوين بيانات اعتماد Linkedin Auth لتمكين تسجيل الدخول عبر Linkedin.',
                        ...
                        'client-secret' => [
                            'title'      => 'السر الخاص بالعميل',
                            'title-info' => 'المفتاح السري المرتبط بعميل Linkedin Auth الخاص بك. احتفظ به سريًا.',
                        ],

                        'redirect' => [
                            'title'      => 'عنوان URL لإعادة التوجيه',
                            'title-info' => 'عنوان URL الذي يتم إعادة توجيه المستخدمين إليه بعد المصادقة مع Linkedin. يجب أن يتطابق مع ما تم تعيينه في وحدة تحكم Linkedin.',
                        ],
                    ],

                    'twitter-details' => [
                        'title'      => 'تفاصيل تويتر',
                        'title-info' => 'قم بتكوين بيانات اعتماد Twitter Auth لتمكين تسجيل الدخول عبر Twitter.',
                        ...
                        'client-secret' => [
                            'title'      => 'السر الخاص بالعميل',
                            'title-info' => 'المفتاح السري المرتبط بعميل Twitter Auth الخاص بك. احتفظ به سريًا.',
                        ],

                        'redirect' => [
                            'title'      => 'عنوان URL لإعادة التوجيه',
                            'title-info' => 'عنوان URL الذي يتم إعادة توجيه المستخدمين إليه بعد المصادقة مع Twitter. يجب أن يتطابق مع ما تم تعيينه في وحدة تحكم Twitter.',
                        ],
                    ],
                ],
            ],
