    ...
    'catalog' => [
        ...
        'categories' => [
            ...
            'create' => [
                ...
                'mobile-banner' => 'بانر الجوال',
                'mobile-banner-size' => 'اختياري. يعتمد على البانر الأساسي إذا لم يتم رفعه (1320px X 300px).',
                'name' => 'الاسم',
    ...
    'settings' => [
        ...
        'channels' => [
            ...
            'create' => [
                ...
                'mobile-logo' => 'الشعار للجوال',
                'mobile-logo-size' => 'اختياري. يعتمد على الشعار الأساسي إذا لم يتم رفعه (192px X 50px).',
                'name' => 'الاسم',
