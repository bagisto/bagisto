...
return [
            ...
            'create' => [
                ...
                'cart' => [
                    ...
                    'address' => [
                        ...
                        'address-updated-payment-info' => 'سيتم تحديث طرق الدفع وإجماليات الطلب للعنوان المعدل. انقر على «المتابعة» لتحميل أحدث الخيارات.',
                        'address-updated-shipping-info' => 'ستتم إعادة احتساب طرق الشحن والأسعار للعنوان المعدل. انقر على «المتابعة» لتحميل أحدث الخيارات.',
                        'address-updated-title' => 'تم تحديث العنوان',
                        'addresses' => 'العناوين',
                        'back' => 'رجوع',
    ...
    'marketing' => [
        ...
        'promotions' => [
            ...
            'catalog-rules' => [
                ...
                'queue-note' => 'يؤدي حفظ هذه القاعدة إلى تحديث سعر كل منتج تنطبق عليه. إذا كانت تنطبق على عدد كبير من المنتجات، فاستخدم برنامج تشغيل قائمة الانتظار database أو redis مع تشغيل عامل قائمة الانتظار، حتى يتم تحديث الأسعار في الخلفية بدلاً من إبطاء عملية الحفظ.',
    ...
    'settings' => [
        ...
        'exchange-rates' => [
            'index' => [
                ...
                'update-rates-error' => 'لا يمكن تحديث أسعار الصرف. إما أن خدمة أسعار الصرف غير متاحة، أو لم يتم تكوين مفتاح API الخاص بها.',
        ...
        'users' => [
            ...
            'role-not-grantable' => 'لا يمكنك تعيين دور يتضمن صلاحيات لا تملكها.',
            'update-success' => 'تم تحديث المستخدم بنجاح.',
            'user-not-manageable' => 'لا يمكنك تعديل مستخدم يتضمن دوره صلاحيات لا تملكها.',
        ],
        ...
        'roles' => [
            ...
            'permissions-not-grantable' => 'لا يمكنك منح صلاحيات لا تملكها.',
    ...
    'configuration' => [
        'index' => [
            ...
            'sales' => [
                ...
                'checkout' => [
                    'title' => 'الدفع',
                    'info' => 'الشراء كضيف، وصفحة السلة، والسلة المصغّرة.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'عرض السلة المصغّرة وعدّاد العناصر الظاهر بها ونص العرض بداخلها.',
            ...
            'search-engines' => [
                'title' => 'محركات البحث',
                'info' => 'اختر المحرك الذي يشغّل بحث المنتجات واضبطه.',
                ...
                'test-connection' => [
                    ...
                    'statuses' => [
                        'available' => ':engine متاح',
                        'unreachable' => 'لم يستجب :engine',
                        'unauthorized' => 'رفض :engine بيانات الاعتماد',
                        'incompatible' => 'استجاب المضيف لكنه ليس خادم :engine مدعومًا',
                        'misconfigured' => 'لم يتم إعداد اتصال :engine',
                    ],
                ],

                'general' => [
                    'title' => 'عام',
                    'info' => 'المحرك الذي يعمل عليه بحث المنتجات.',

                    'settings' => [
                        'title' => 'الإعدادات',
                        'info' => 'فعّل محرك بحث خارجيًا واختر أين يُستخدم.',
                        'enabled' => 'تفعيل محرك البحث الخارجي',
                        'enabled-info' => 'أوقفه للبحث في قاعدة البيانات في كل مكان، مهما كانت الإعدادات أدناه.',
                        'engine' => 'محرك البحث الافتراضي',
                        'engine-info' => 'المحرك المستخدم في كل موضع يُترك فيه وضع البحث على «استخدام الافتراضي».',
                        'inherit' => 'استخدام الافتراضي',
                    ],

                    'products' => [
                        'title' => 'المنتجات',
                        'info' => 'بأي محرك يبحث كل جانب من المتجر عن المنتجات.',
                        'admin-mode' => 'وضع البحث في لوحة الإدارة',
                        'admin-mode-info' => 'المحرك الذي يقف خلف البحث الشامل وجداول البيانات وبقية عمليات البحث في لوحة الإدارة.',
                        'storefront-mode' => 'وضع البحث في المتجر',
                        'storefront-mode-info' => 'المحرك الذي يقف خلف صفحات الفئات وصفحة البحث وبقية عمليات البحث في المتجر.',
                    ],
                ],

                'elastic' => [
                    'info' => 'حالة الاتصال وحدود الاستعلام لـ Elasticsearch.',
                    ...
                    'settings' => [
                        ...
                        'auth-types' => [
                            ...
                            'api-key' => 'مفتاح API',
                            'cloud-api-key' => 'Elastic Cloud بمفتاح API',
                            'cloud-basic' => 'Elastic Cloud باسم المستخدم وكلمة المرور',
                        ],
                        ...
                        'username' => 'اسم المستخدم',
                        'username-info' => 'يُستخدم مع المصادقة الأساسية. اتركه فارغًا إذا كان العنقود لا يحتاجها.',
                        'password' => 'كلمة المرور',
                        ...
                        'min-query-length-info' => 'أقصر مصطلح بحث يقبله مربع البحث في المتجر.',
                        'max-query-length' => 'أقصى طول للاستعلام',
                        'max-query-length-info' => 'أطول مصطلح بحث يقبله مربع البحث في المتجر.',
                        'connection' => 'الاتصال',
                    ],
                ],
            ],
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'الانسحاب من العقد (الاتحاد الأوروبي)',
        ],
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'تفعيل',
                'enabled-info' => 'عند التفعيل، يرى العملاء على هذه القناة زر «الانسحاب من العقد» في صفحات تفاصيل الطلب، إضافةً إلى نموذج بحث عام على المسار ‎/withdraw. يُنصح بالتفعيل فقط على القنوات التي تبيع للمستهلكين داخل الاتحاد الأوروبي.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'الأدلة',
            'evidence-note' => 'غير قابلة للتعديل — مُسجَّلة لحظة التقديم',
            'status' => 'الحالة',
            'received-at' => 'تاريخ الاستلام',
            'uuid' => 'الرقم المرجعي',
            'copy-reference' => 'نسخ الرقم المرجعي',
            'reference-copied' => 'تم نسخ الرقم المرجعي إلى الحافظة.',
            'order' => 'الطلب',
            ...
            'timeline-received' => 'تم استلام الإقرار',
            'timeline-received-desc' => 'قدّم العميل طلب الانسحاب من العقد.',
            'timeline-email' => 'بريد التأكيد',
            'timeline-email-pending' => 'لم يُرسل بعد',
            'timeline-initial-email' => 'بريد التأكيد الأولي',
            'timeline-initial-email-desc-sent' => 'تم تسليم بريد التأكيد إلى العميل.',
            'timeline-initial-email-desc-error' => 'فشل إرسال بريد التأكيد الأولي.',
            'timeline-initial-email-desc-pending' => 'لم يُرسَل بريد التأكيد الأولي بعد.',
            'timeline-final-email' => 'بريد التأكيد النهائي',
            'timeline-final-email-pending' => 'لم يُرسل بعد',
            'timeline-final-email-desc-sent' => 'تم تسليم بريد القرار النهائي إلى العميل.',
            'timeline-final-email-desc-pending' => 'لم يُرسَل بريد التأكيد النهائي بعد.',
            'timeline-declined' => 'مرفوض من قِبَل المسؤول',
            'timeline-declined-desc' => 'تم رفض الطلب بواسطة :name.',
            'timeline-declined-desc-system' => 'تم رفض طلب الانسحاب.',
            'timeline-declined-reason-label' => 'السبب المُقدَّم:',
            'timeline-refunded' => 'مُعلَّم كمُستردّ من قِبَل المسؤول',
            'timeline-refunded-desc' => 'تم إصدار الاسترداد بواسطة :name.',
            'timeline-refunded-desc-system' => 'تم إصدار الاسترداد.',
            'timeline-refunded-note-label' => 'ملاحظة المسؤول:',
            'timeline-resolution' => 'القرار',
            'timeline-resolution-desc' => 'في انتظار مراجعة المسؤول واتخاذ القرار.',
            'timeline-resolution-pending' => 'في انتظار إجراء المسؤول',

            'confirmation-sent-at' => 'تاريخ إرسال التأكيد',
            'confirmation-error' => 'خطأ في التأكيد',
            'declined-at' => 'تاريخ الرفض',
            'refunded-at' => 'تاريخ الاسترداد',

            'actions' => 'الإجراءات',
            'actions-note' => 'تتم معالجة المبالغ المستردّة يدوياً عبر أدوات الطلبات / الاسترداد / RMA الموجودة في باجيستو. استخدم هذه الإجراءات لتسجيل النتيجة في أدلة الانسحاب.',
            'resend-confirmation' => 'إعادة إرسال بريد التأكيد',
            'mark-refunded' => 'تعليم كمُستردّ',
            'refund-note-label' => 'مرجع الاسترداد (اختياري)',
            'refund-note-placeholder' => 'مثلاً: استرداد رقم 1234',
            'decline' => 'رفض الطلب',
            'decline-reason-label' => 'سبب الرفض',
            'decline-reason-placeholder' => 'وضّح سبب الاعتراض على الاستحقاق',
            'mark-refunded-confirm-msg' => 'هل تريد تعليم هذا الطلب كمُستردّ؟ سيتم مسح أي سجل رفض سابق.',
            'decline-confirm-msg' => 'هل تريد رفض هذا الطلب؟ سيكون السبب مرئياً للعميل.',
            'resend-confirmation-confirm-msg' => 'هل تريد إعادة إرسال بريد التأكيد إلى العميل؟',
            'send-final-confirmation' => 'إرسال بريد التأكيد النهائي',
            'send-final-confirmation-confirm-msg' => 'هل تريد إرسال بريد الحالة النهائية إلى العميل؟',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'القناة',
            'status' => 'الحالة',
            'confirmation-sent-at' => 'تم إرسال التأكيد',
            'view' => 'عرض',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'تم إعادة إرسال بريد التأكيد.',
            'confirmation-failed' => 'تعذّر إرسال بريد التأكيد. راجع المسار الزمني للاطلاع على التفاصيل.',
        ],
    ],
];
