        ...
        'index' => [
            ...
            'customer' => [
                ...
                'captcha' => [
                    ...
                    'credentials-info' => 'مفتاح الموقع: خريطة تصميم الموقع لمحركات البحث. مفتاح السر: رمز آمن لتشفير البيانات أو الاعتماد أو حماية الوصول إلى واجهة برمجة التطبيقات (API).',
            ...
            'taxes' => [
                'title'                        => 'الضرائب',
                'catalogue'                    => 'الفهرس',
                'catalogue-info'               => 'تعيين التسعير وحسابات الموقع الافتراضي',
                'pricing'                      => 'التسعير',
                'pricing-info'                 => 'تفاصيل حول تكلفة السلع أو الخدمات، بما في ذلك السعر الأساسي والخصومات والضرائب والرسوم الإضافية.',
                'tax-inclusive'                => 'شامل الضريبة',
                'default-location-calculation' => 'حساب الموقع الافتراضي',
                'default-location-calculation-info' => 'تحديد آلي للموقع القياسي أو الافتراضي استنادًا إلى العوامل أو الإعدادات المحددة مسبقًا.',
