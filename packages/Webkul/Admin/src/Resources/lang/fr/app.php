        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api_key'                        => 'Clé API',
                    'api_publishable_key'            => 'Clé publique de l’API',
                    'api_test_key'                   => 'Clé secrète de test de l’API',
                    'api_test_publishable_key'       => 'Clé publique de test de l’API',
                    'applicable-production'          => 'S’applique si le mode production est sélectionné',
                    'applicable-sandbox'             => 'S’applique si le mode test est sélectionné',
                    'application_fee'                => 'Payeur des frais d’application',
                    ...
                    'paid'                           => 'Payé',
                    'payment-method-info'            => 'Option de paiement Stripe pour les entreprises en ligne permettant aux clients de payer par carte de crédit/débit et de développer votre activité',
