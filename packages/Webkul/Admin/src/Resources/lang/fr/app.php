            ...
            'edit' => [
                ...
                'price' => [
                    'group' => [
                        ...
                        'fixed-group-price-info'    => 'Pour :qty unité(s) au prix de :price par :type',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                'general' => [
                    'title'             => 'Général',
                    'info'              => 'Définissez les options d\'unités.',
                    'unit-options'      => 'Options d\'unité',
                    'unit-options-info' => 'Taille, couleur, matériau, personnalisation, amélioration de la satisfaction client et personnalisation des achats.',
                    'weight-unit'       => 'Unité de poids',
                ],

                'content' => [
                    'title'               => 'Contenu',
                    'info'                => 'Définissez les options de comparaison, les options de liste de souhaits, les options de recherche d\'images, le pied de page, le basculement du pied de page et les scripts personnalisés.',
                ...
                'design' => [
                    ...
                    'admin-logo-info' => 'Le logo de l\'administrateur est l\'image ou l\'emblème distinctif représentant l\'interface d\'administration d\'un système ou d\'un site Web, souvent personnalisable.',
            ...
            'catalog' => [
                ...
                'inventory' => [
                    'title'              => 'Inventaire',
                    'info'               => 'Définissez les commandes en attente',
                    'stock-options'      => 'Options de stock',
                    'stock-options-info' => 'Les options de stock sont des contrats d\'investissement qui accordent le droit d\'acheter ou de vendre des actions de société à un prix prédéterminé, influençant ainsi les bénéfices potentiels.',
                    'allow-back-orders'  => 'Autoriser les commandes en attente',
                ],

                'products' => [
                    'title'                              => 'Produits',
                    'info'                               => 'Définissez la validation des invités, la page d\'accueil, la page de vue du produit, la page de vue du panier, la vitrine, l\'avis et le partage social des attributs.',
                    ...
                    'allow-guest-checkout-hint'          => 'Astuce : si activée, cette option peut être configurée pour chaque produit spécifiquement.',
                    'attribute'                          => 'Attribut',
                    ...
                    'allow-no-of-cross-sells-products'   => 'Nombre autorisé de produits de vente incitative',
                    'product-view-page'                  => 'Configuration de la page de vue du produit',
                    'product-view-page-info'             => 'La configuration de la page de vue du produit consiste à ajuster la mise en page et les éléments sur la page d\'affichage d\'un produit, améliorant ainsi l\'expérience utilisateur et la présentation des informations.',
                    'cart-view-page'                     => 'Configuration de la page de vue du panier',
                    'cart-view-page-info'                => 'La configuration de la page de vue du panier consiste à organiser les articles, les détails et les options sur la page du panier d\'achat, améliorant ainsi l\'interaction utilisateur et le flux d\'achat.',
                    'storefront'                         => 'Vitrine',
                    'storefront-info'                    => 'La vitrine est l\'interface orientée client d\'une boutique en ligne, présentant des produits, des catégories et une navigation pour une expérience d\'achat transparente.',
                    ...
                    'cache-small-image'                  => 'Image réduite',
                    'cache-small-image-info'             => 'La vitrine est l\'interface orientée client d\'une boutique en ligne, présentant des produits, des catégories et une navigation pour une expérience d\'achat transparente.',
                    'width'                              => 'Largeur',
                    'height'                             => 'Hauteur',
                    'cache-medium-image'                 => 'Image moyenne',
                    'cache-medium-image-info'            => 'L\'image moyenne fait référence à une image de taille modérée qui offre un équilibre entre les détails et l\'espace d\'écran, souvent utilisée pour les visuels.',
                    'cache-large-image'                  => 'Image large',
                    'cache-large-image-info'             => 'L\'image large représente une image haute résolution offrant des détails et un impact visuel améliorés, souvent utilisée pour mettre en valeur des produits ou des graphiques.',
                    'review'                             => 'Avis',
                    'review-info'                        => 'Évaluation ou évaluation de quelque chose, impliquant souvent des opinions et des commentaires.',
                    'allow-guest-review'                 => 'Autoriser les avis des clients invités',
                    ...
                    'image-upload-size'                  => 'Taille autorisée de téléchargement d\'image (en Ko)',
                    'file-upload-size'                   => 'Taille autorisée de téléchargement de fichier (en Ko)',
                ...
                'rich-snippets' => [
                    ...
                    'categories'                => 'Catégories',
                    'categories-info'           => 'Les "catégories" font référence à des groupes ou à des classifications qui aident à organiser et à regrouper des produits ou des articles similaires pour une navigation et une recherche plus faciles.',
            ...
            'customer' => [
                ...
                'address' => [
                    'title'              => 'Adresse',
                    'info'               => 'Définissez le pays, l\'état, le code postal et les lignes d\'une adresse.',
                    'requirements'       => 'Exigences',
                    'requirements-info'  => 'Les exigences sont les conditions, les caractéristiques ou les spécifications nécessaires pour que quelque chose soit accompli, réalisé ou atteint avec succès.',
                    'country'            => 'Pays',
                    'state'              => 'État',
                    'zip'                => 'Code postal',
                    'city'               => 'Ville',
                    'information'        => 'Informations',
                    'information-info'   => 'Les "lignes d\'une adresse" font référence aux segments individuels d\'une adresse, souvent séparés par des virgules, fournissant des informations de localisation telles que le numéro de maison, la rue, la ville, et plus encore.',
                    'street-lines'       => 'Lignes d\'une adresse',
                ],

                'settings' => [
                    'title'                   => 'Paramètres',
                    'settings-info'           => 'Définissez la liste de souhaits, les abonnements à la newsletter, la vérification par e-mail et la connexion via les réseaux sociaux.',
                    'wishlist'                => 'Liste de souhaits',
                    'wishlist-info'           => 'Une "liste de souhaits" est une collection personnalisée d\'articles souhaités, permettant aux utilisateurs de sauvegarder des produits pour référence future ou pour un achat éventuel.',
                    'wishlist-share'          => 'Activer le partage',
                    'newsletter'              => 'Abonnement à la newsletter',
                    'newsletter-info'         => 'Les "informations sur la newsletter" contiennent des mises à jour, des offres ou du contenu partagé régulièrement par e-mail aux abonnés, les tenant informés et engagés.',
