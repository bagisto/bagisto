...
return [
    ...
    'command-palette' => [
        'placeholder' => 'Rechercher menus, réglages, pages et actions...',
        'esc' => 'ÉCHAP',
        'loading' => 'Chargement...',
        'no-results' => 'Aucun résultat',
        'no-results-hint' => 'Essayez un menu, une page, un réglage ou une action.',
        'navigate' => 'Naviguer',
        'select' => 'Ouvrir',
        'close' => 'Fermer',

        'all' => 'Tous les :resource',
        'back' => 'Retour',
        'context-placeholder' => 'Rechercher dans :context...',

        'start-typing' => 'Saisissez pour rechercher',
        'record-actions' => [
            'view' => 'Voir',
            'edit' => 'Modifier',
            'duplicate' => 'Dupliquer',
        ...
        'actions' => [
            ...
            'create-page' => 'Créer une page CMS',
    ...
    'configuration' => [
        'index' => [
            'about' => [
                'info' => 'Sur quoi fonctionne cette boutique et quels services elle utilise.',
                'title' => 'À propos',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'title' => 'Titre',
                    'webhook-secret' => 'Secret de signature du webhook',
                    'webhook-secret-info' => 'Le secret de signature du webhook ajouté dans le tableau de bord Stripe pour l\'URL de votre boutique suivie de /stripe/webhook, avec les événements : checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. S\'applique uniquement au mode production.',
                    'webhook-test-secret' => 'Secret de signature du webhook de test',
                    'webhook-test-secret-info' => 'Le secret de signature du webhook ajouté dans le tableau de bord Stripe pour l\'URL de votre boutique suivie de /stripe/webhook, avec les événements : checkout.session.completed, checkout.session.async_payment_succeeded, charge.refunded, charge.dispute.created, charge.dispute.closed. S\'applique uniquement au mode test.',
                ],
                ...
                'checkout' => [
                    ...
                    'info' => 'Commande en tant qu\'invité, page du panier et mini-panier.',
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Afficher le mini-panier, le compteur d\'articles qu\'il affiche et le texte d\'offre qu\'il contient.',
            ...
            'catalog' => [
                ...
                'products' => [
                    ...
                    'omnibus' => [
                        'title' => 'Divulgation des prix Omnibus',
                        'title-info' => 'Enregistre des instantanés de prix quotidiens et affiche le prix le plus bas dans les 30 jours précédant chaque réduction, conformément à la directive Omnibus de l\'UE.',
                        'enable' => 'Activer la divulgation Omnibus',
                    ],
                ],
            ...
            'search-engines' => [
                ...
                'elastic' => [
                    ...
                    'settings' => [
                        ...
                        'auth-type-info' => 'Comment le cluster est joint et l\'authentification effectuée. Seuls les champs nécessaires sont affichés.',

                        'auth-types' => [
                            'none' => 'Aucune authentification',
                            'basic' => 'Nom d\'utilisateur et mot de passe',
                            'api-key' => 'Clé API',
                            'cloud-api-key' => 'Elastic Cloud avec clé API',
                            'cloud-basic' => 'Elastic Cloud avec nom d\'utilisateur et mot de passe',
                        ],
                        ...
                        'api-key' => 'Clé API',
                        'api-key-info' => 'La clé avec laquelle l\'authentification au cluster est effectuée.',
                        'cloud-id' => 'Cloud ID',
                        'cloud-id-info' => 'Le Cloud ID du déploiement Elastic Cloud.',
    ...
    'components' => [
        'layouts' => [
            'header' => [
                ...
                'mega-search' => [
                    ...
                    'shortcut' => 'Ctrl K',
                    'sku' => 'SKU : :sku',
                    'title' => 'Rechercher ou appuyez sur Ctrl + K',
                ],
            ],
        ...
        'datagrid' => [
            'index' => [
                'action-error' => 'Une erreur s\'est produite',
    ...
    'eu-withdrawal' => [
        'menu' => [
            'eu-withdrawals' => 'Rétractations UE',
        ],
        ...
        'acl' => [
            ...
            'view' => 'Voir',
            'decline' => 'Refuser',
            'mark-refunded' => 'Marquer comme remboursée',
        ...
        'config' => [
            ...
            'general' => [
                ...
                'enabled' => 'Activer',
                'enabled-info' => 'Lorsqu’il est activé, les clients de ce canal voient un bouton « Se rétracter du contrat » sur les pages de détail de commande ainsi qu’un formulaire public de recherche /withdraw. Activez-le uniquement sur les canaux destinés aux consommateurs de l’UE.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Preuve',
            'evidence-note' => 'Immuable — capturée à l’envoi',
            'status' => 'Statut',
            'received-at' => 'Reçue le',
            'uuid' => 'Référence',
            'copy-reference' => 'Copier la référence',
            'reference-copied' => 'Référence copiée dans le presse-papiers.',
            'order' => 'Commande',
            'customer-email' => 'E-mail du client',
            'is-guest' => 'Invité',
            'channel' => 'Canal',
            ...
            'timeline-received' => 'Déclaration reçue',
            'timeline-received-desc' => 'Le client a soumis une demande de rétractation du contrat.',
            'timeline-email' => 'E-mail de confirmation',
            'timeline-email-pending' => 'Pas encore envoyé',
            'timeline-initial-email' => 'E-mail de confirmation initial',
            'timeline-initial-email-desc-sent' => 'E-mail de confirmation remis au client.',
            'timeline-initial-email-desc-error' => 'L’envoi de l’e-mail de confirmation initial a échoué.',
            'timeline-initial-email-desc-pending' => 'L’e-mail de confirmation initial n’a pas encore été envoyé.',
            'timeline-final-email' => 'E-mail de confirmation final',
            'timeline-final-email-pending' => 'Pas encore envoyé',
            'timeline-final-email-desc-sent' => 'E-mail de résultat remis au client.',
            'timeline-final-email-desc-pending' => 'L’e-mail de confirmation final n’a pas encore été envoyé.',
            'timeline-declined' => 'Rétractation refusée',
            'timeline-declined-desc' => 'Rétractation refusée par :name.',
            'timeline-declined-desc-system' => 'Rétractation refusée.',
            'timeline-declined-reason-label' => 'Motif indiqué :',
            'timeline-refunded' => 'Remboursement effectué',
            'timeline-refunded-desc' => 'Remboursement effectué par :name.',
            'timeline-refunded-desc-system' => 'Remboursement effectué.',
            'timeline-refunded-note-label' => 'Note de l’administrateur :',
            'timeline-resolution' => 'Décision en attente',
            'timeline-resolution-desc' => 'En attente de l’examen et de la décision de l’administrateur.',
            'timeline-resolution-pending' => 'En attente d’action de l’administrateur',

            'confirmation-sent-at' => 'Confirmation envoyée le',
            'confirmation-error' => 'Erreur de confirmation',
            'declined-at' => 'Refusée le',
            'refunded-at' => 'Remboursée le',

            'actions' => 'Actions',
            'actions-note' => 'Les remboursements sont traités manuellement via les outils existants de Bagisto (commande / remboursement / RMA). Utilisez ces actions pour enregistrer le résultat sur la preuve de rétractation.',
            'resend-confirmation' => 'Renvoyer l’e-mail de confirmation',
            'mark-refunded' => 'Marquer comme remboursée',
            'refund-note-label' => 'Référence du remboursement (facultatif)',
            'refund-note-placeholder' => 'ex. Remboursement n° 1234',
            'decline' => 'Refuser la rétractation',
            'decline-reason-label' => 'Motif du refus',
            'decline-reason-placeholder' => 'Expliquez pourquoi le droit est contesté',
            'mark-refunded-confirm-msg' => 'Marquer cette rétractation comme remboursée ? Tout enregistrement de refus précédent sera effacé.',
            'decline-confirm-msg' => 'Refuser cette rétractation ? Le motif sera visible par le client.',
            'resend-confirmation-confirm-msg' => 'Renvoyer l’e-mail de confirmation au client ?',
            'send-final-confirmation' => 'Envoyer l’e-mail de confirmation final',
            'send-final-confirmation-confirm-msg' => 'Envoyer au client l’e-mail de statut final ?',
        ],
        ...
        'datagrid' => [
            ...
            'channel' => 'Canal',
            'status' => 'Statut',
            'confirmation-sent-at' => 'Confirmation envoyée',
            'view' => 'Voir',
        ],
        ...
        'flash' => [
            ...
            'confirmation-resent' => 'L’e-mail de confirmation a été renvoyé.',
            'confirmation-failed' => 'Impossible d’envoyer l’e-mail de confirmation. Consultez la chronologie pour plus de détails.',
        ],
    ],
];
