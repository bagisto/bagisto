    ...
    <script type="text/x-template" id="tax-rate-form-template">
        <div>
            ...
            <div class="control-group" :class="[errors.has('tax_rate') ? 'has-error' : '']">
                ...
                <input v-validate="'required|numeric|min_value:0.0001'" class="control" id="tax_rate" name="tax_rate" data-vv-as="&quot;{{ __('admin::app.configuration.tax-rates.tax_rate') }}&quot;" value="{{ old('tax_rate') }}"/>
