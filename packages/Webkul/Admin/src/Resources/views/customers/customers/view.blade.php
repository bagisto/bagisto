        ...
        <div class="flex gap-4 justify-between items-center max-sm:flex-wrap">
            <div class="flex gap-2.5 items-center">
                ...
                <div>
                    ...
                    @else    
                        <span class="label-canceled text-sm leading-none mx-1.5">
                    ...
                    @if ($customer->is_suspended == 1)
                        <span class="label-canceled text-sm leading-none">
        ...
        <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded box-shadow">
                @if ($totalInvoiceCount = count($customer->invoices))
                    <!--Invoice Count -->
                    <p class="p-4 text-base leading-none text-gray-800 dark:text-white font-semibold">
                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left min-w-[800px]">
                            <thead class="text-sm leading-none text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                                <tr>
            ...
            <x-admin::accordion>
                <x-slot:header>
                    <div class="flex w-full">
                        <p class="w-full p-2.5 text-gray-800 dark:text-white text-base leading-none font-semibold">
            ...
            <x-admin::accordion>
                <x-slot:header>
                    <div class="flex items-center justify-between p-1.5">
                        <p class="text-gray-800 dark:text-white text-base leading-none font-semibold">
