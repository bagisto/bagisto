                    ...
                    <accordian title="{{ __('admin::app.customers.addresses.general') }}" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" name="phone" v-validate="'required|numeric|max:15|min:6'" value="{{ old('phone') }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.phone') }}&quot;">
