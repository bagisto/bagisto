    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h1>
                    <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('admin.customers.customers.edit', ['id' => $customer->id]) }}'"></i>
            ...
            @if (bouncer()->hasPermission('customers.addresses.create '))
                <a href="{{ route('admin.customers.customers.addresses.create', ['id' => $customer->id]) }}" class="btn btn-lg btn-primary">
        ...
        <div class="page-content">
            <datagrid-plus src="{{ route('admin.customers.customers.addresses.index', $customer->id) }}"></datagrid-plus>
        </div>
