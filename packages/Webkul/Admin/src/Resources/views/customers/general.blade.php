...
<form method="POST" action="{{ route('admin.customer.update', $customer->id) }}">
    <div class="page-content">
        <div class="form-container">
            ...
            <div slot="body" style="display: flex; justify-content: space-between;">
                ...
                <div style="width: 50%;">
                    <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
                        ...
                        <input type="text" id="first_name" class="control" name="first_name" v-validate="'required'" value="{{old('first_name') ?:$customer->first_name}}"
                    ...
                    <div class="control-group" :class="[errors.has('last_name') ? 'has-error' : '']">
                        ...
                        <input type="text" id="last_name" class="control"  name="last_name"   v-validate="'required'" value="{{old('last_name') ?:$customer->last_name}}" data-vv-as="&quot;{{ __('shop::app.customer.signup-form.lastname') }}&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('email') ? 'has-error' : '']">
                        ...
                        <input type="email" id="email" class="control"  name="email" v-validate="'required|email'" value="{{old('email') ?:$customer->email}}" data-vv-as="&quot;{{ __('shop::app.customer.signup-form.email') }}&quot;">
                    ...
                    {!! view_render_event('bagisto.admin.customer.edit.email.after', ['customer' => $customer]) !!}
                            ...
                            <div class="control-group" :class="[errors.has('gender') ? 'has-error' : '']">
                                ...
                                <select name="gender" id="gender" class="control" value="{{ $customer->gender }}" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.customers.customers.gender') }}&quot;">
                        ...
                        <div style="width: 50%;">
                            <div class="control-group" :class="[errors.has('date_of_birth') ? 'has-error' : '']">
                                ...
                                <input type="date" id="dob" class="control" name="date_of_birth" value="{{ old('date_of_birth') ?:$customer->date_of_birth }}" v-validate="" data-vv-as="&quot;{{ __('admin::app.customers.customers.date_of_birth') }}&quot;">
                            ...
                            <div class="control-group">
                                ...
                                <select id="customerGroup" class="control" name="customer_group_id">
