                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <div class="flex pt-5">
                        ...
                        <div class="flex w-3/5 flex-col gap-2">
                            ...
                            <p class="text-xs text-gray-500">
                                @lang('admin::app.catalog.categories.edit.mobile-banner-size')
                            </p>

                            <x-admin::media.images
                                name="mobile_banner_path"
                                :uploaded-images="$category->mobile_banner_path ? [['id' => 'mobile_banner_path', 'url' => $category->mobile_banner_url]] : []"
                                width="220px"
                            />
                        </div>
                    </div>
