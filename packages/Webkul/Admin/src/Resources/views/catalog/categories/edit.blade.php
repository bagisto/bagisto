<x-admin::layouts>
    ...
    <v-category-edit-form></v-category-edit-form>

    @pushOnce('scripts')
        <script type="text/x-template" id="v-category-edit-form-template">
            <div>
                <x-admin::form
        ...
        <script type="module">
            app.component('v-category-edit-form', {
                template: '#v-category-edit-form-template',
