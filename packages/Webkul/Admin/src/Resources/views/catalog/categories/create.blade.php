<x-admin::layouts>
    ...
    {{-- Create form of category --}}
    <v-category-create-form></v-category-create-form>

    @pushOnce('scripts')
        <script type="text/x-template" id="v-category-create-form-template">
            <div>
                <x-admin::form
        ...
        <script type="module">
            app.component('v-category-create-form', {
                template: '#v-category-create-form-template',
