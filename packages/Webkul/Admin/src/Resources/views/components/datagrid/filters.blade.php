    ...
    <div v-if="column.filterable">
        ...
        <div v-if="column.type === 'date_range'">
            ...
            <div class="mt-[5px] grid grid-cols-2 gap-[5px]">
                <p
                    class="cursor-pointer rounded-[6px] border border-gray-300 px-[8px] py-[6px] text-center text-[14px] font-medium leading-[24px] text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400"
        ...
        <div v-else>
            ...
            <div class="mb-[8px] mt-[5px] grid">
                <input
                    type="text"
                    class="block w-full rounded-[6px] border border-gray-300 bg-white dark:bg-gray-900  px-[8px] py-[6px] text-[14px] leading-[24px] text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400 focus:border-gray-400"
                    :name="column.index"
                    :placeholder="column.label"
