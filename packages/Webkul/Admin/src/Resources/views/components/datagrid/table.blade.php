        ...
        <div class="w-full">
            <div class="table-responsive grid w-full box-shadow rounded-[4px] bg-white dark:bg-gray-900 overflow-hidden">
                <slot name="header">
                    ...
                    <template v-else>
                        <div
                            class="row grid gap-2.5 min-h-[47px] px-[16px] py-2.5 border-b-[1px] dark:border-gray-800 text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 font-semibold items-center"
