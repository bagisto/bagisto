@pushOnce('scripts')
    ...
    >
        ...
        >
            ...
            <span class="icon-uncheckbox peer-checked:icon-checked cursor-pointer rounded-md text-2xl text-gray-300 transition-colors peer-checked:text-blue-600 dark:text-gray-600">
            </span>
