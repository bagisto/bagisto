    ...
    <body class="h-full dark:bg-gray-950">
        ...
        <div id="app" class="h-full">
            ...
            >
                ...
                <div class="flex-1 max-w-full px-4 pt-[11px] pb-[22px] bg-white dark:bg-gray-950 ltr:pl-[286px] rtl:pr-[286px] max-lg:!px-4 transition-all duration-300 group-[.sidebar-collapsed]/container:ltr:pl-[85px] group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
