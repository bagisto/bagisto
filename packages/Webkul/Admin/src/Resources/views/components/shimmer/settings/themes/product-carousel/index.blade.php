            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                ...
                @for ($i = 1; $i < 4; $i++)
                    <div class="pt-4">
                        ...
                        <div class="flex h-10 w-full rounded-md border px-3 py-2 text-sm text-gray-600 transition-all focus:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-gray-400"></div>
                    </div>
                @endfor
