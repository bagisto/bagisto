<div class="rounded box-shadow">
    ...
    @for ($i = 1; $i <= 5; $i++)
        <div class="row grid grid-cols-4 gap-y-6 p-4 bg-white dark:bg-gray-900 border-b-[1px] dark:border-gray-800 transition-all hover:bg-gray-50 dark:hover:bg-gray-950 max-1580:grid-cols-3 max-sm:grid-cols-1">
