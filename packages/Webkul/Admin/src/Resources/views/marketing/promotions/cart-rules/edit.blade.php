                        ...
                        <div v-else>
                            ...
                            >
                                <input
                                    ...
                                    class="w-full py-2 px-3 bg-white dark:bg-gray-900 border dark:border-gray-800 appearance-none rounded-md text-[14px] text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400"
