                        ...
                        <div v-else>
                            ...
                            >
                                <input
                                    ...
                                    class="w-full py-2 px-3 bg-white dark:bg-gray-900 border dark:border-gray-800 appearance-none rounded-md text-sm leading-none text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400"
                            ...
                            <div v-if="matchedAttribute.type == 'multiselect' || matchedAttribute.type == 'checkbox'">
                                <select
                                    :name="['conditions[' + index + '][value][]']"
                                    class="inline-flex gap-x-1 justify-between items-center max-h-10 w-[196px] max-w-[196px] py-1.5 ltr:pl-3 rtl:pr-3 px-3 bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-md text-sm leading-none text-gray-600 dark:text-gray-300 font-normal cursor-pointer marker:shadow appearance-none focus:ring-2 focus:outline-none focus:ring-black transition-all hover:border-gray-400"
                                    v-model="condition.value"
                                    multiple
                                >
                                    <option
            ...
            <div class="p-4 bg-white dark:bg-gray-900 rounded box-shadow">
                <div class="grid gap-1.5">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex gap-x-2.5 items-center">
                            <p class="text-xl leading-none text-gray-800 dark:text-white font-bold"></p>
                        </div>
