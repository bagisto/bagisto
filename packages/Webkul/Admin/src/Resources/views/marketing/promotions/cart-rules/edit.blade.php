                        ...
                        <div v-else>
                            ...
                            >
                                <input 
                                    ...
                                    class="bg-white dark:bg-gray-900 border dark:border-gray-800 w-full py-2 px-3 appearance-none rounded-[6px] text-[14px] text-gray-600 dark:text-gray-300 transition-all hover:border-gray-400"
