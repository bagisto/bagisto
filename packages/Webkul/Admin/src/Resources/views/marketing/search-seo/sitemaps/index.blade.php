            ...
            >
                ...
                <template #body="{ columns, records, performAction }">
                    <div
                        ...
                        class="row grid gap-2.5 items-center px-[16px] py-[16px] border-b-[1px] dark:border-gray-800 break-all text-gray-600 dark:text-gray-300 transition-all hover:bg-gray-50 dark:hover:bg-gray-950"
