<x-admin::layouts>
    ...
    {{-- Input Form --}}
    <x-admin::form :action="route('admin.marketing.promotions.email_templates.update', $template->id)">
            ...
            <div class="flex gap-x-[10px] items-center">
                ...
                <a href="{{ route('admin.marketing.promotions.email_templates.index') }}">
                    <span class="px-[12px] py-[6px] border-[2px] border-transparent rounded-[6px] text-gray-600 font-semibold whitespace-nowrap transition-all hover:bg-gray-100 cursor-pointer">
                        @lang('admin::app.marketing.email-marketing.templates.edit.back-btn')
                    </span>
                </a>
