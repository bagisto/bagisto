<x-admin::layouts>
    ...
    {{-- Input Form --}}
    <x-admin::form :action="route('admin.marketing.promotions.campaigns.update', $campaign->id)">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-x-[10px] items-center">
                {{-- Cancel Button --}}
                <a href="{{ route('admin.marketing.promotions.campaigns.index') }}">
                    <span class="px-[12px] py-[6px] border-[2px] border-transparent rounded-[6px] text-gray-600 font-semibold whitespace-nowrap transition-all hover:bg-gray-100 cursor-pointer">
                        @lang('admin::app.marketing.email-marketing.campaigns.edit.back-btn')
                    </span>
                </a>
                ...
                <x-admin::accordion>
                    <x-slot:header>
                        <p class="p-[10px] text-gray-600 text-[16px] font-semibold">
                            @lang('admin::app.marketing.email-marketing.campaigns.create.setting')
                        </p>
                    </x-slot:header>
