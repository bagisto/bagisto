        ...
        <script type="text/x-template" id="v-users-template">
            ...
            >
                ...
                <template #header="{columns, records, sortPage, applied}">
                    <div class="row grid grid-cols-{{ $hasPermission ? '6' : '5' }} grid-rows-1 gap-[10px] items-center px-[16px] py-[10px] border-b-[1px] border-gray-300 text-gray-600 dark:text-gray-300 bg-gray-50 font-semibold">
                        <div
