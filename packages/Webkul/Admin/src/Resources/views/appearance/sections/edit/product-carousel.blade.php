<v-product-carousel :errors="errors">
    <x-admin::shimmer.appearance.sections.product-carousel />
</v-product-carousel>
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.product-carousel')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.product-carousel-description')
                        </p>
                    </div>
                </div>
                ...
                <x-admin::form.control-group class="mb-2.5 pt-4">
                    <x-admin::form.control-group.label class="required">
                        @lang('admin::app.appearance.sections.edit.filter-title')
                    ...
                    <v-field
                        ...
                        rules="required"
                        label="@lang('admin::app.appearance.sections.edit.filter-title')"
                        placeholder="@lang('admin::app.appearance.sections.edit.filter-title')"
                    >
                    </v-field>
                ...
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label class="required">
                        @lang('admin::app.appearance.sections.edit.sort')
                    </x-admin::form.control-group.label>
                    ...
                    <v-field
                        ...
                        label="@lang('admin::app.appearance.sections.edit.sort')"
                    >
                        <select
                            name="{{ $currentLocale->code }}[options][filters][sort]"
                            v-bind="field"
                        ...
                        >
                            <option value="" selected disabled>
                                @lang('admin::app.appearance.sections.edit.select')
                            </option>
                ...
                <x-admin::form.control-group>
                    <x-admin::form.control-group.label class="required">
                        @lang('admin::app.appearance.sections.edit.limit')
                    </x-admin::form.control-group.label>
                    ...
                    <v-field
                        ...
                        label="@lang('admin::app.appearance.sections.edit.limit')"
                    >
                        <select
                        ...
                        >
                            <option value="" selected disabled>@lang('admin::app.appearance.sections.edit.select')</option>
                ...
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.filters')
                        </p>
                    </div>
                    ...
                    >
                        @lang('admin::app.appearance.sections.edit.add-filter-btn')
                    </div>
                </div>
                        ...
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('admin::app.appearance.sections.edit.key')".replace(':key', filter.key) }}
                                </p>

                                <p class="text-gray-600 dark:text-gray-300">
                                    @{{ "@lang('admin::app.appearance.sections.edit.value')".replace(':value', filter.value) }}
                                </p>
                            </div>
                        </div>
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.appearance.sections.edit.product-carousel')"
                    >
                    ...
                    <x-admin::modal ref="productFilterModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('admin::app.appearance.sections.edit.create-filter')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.appearance.sections.edit.key-input')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    rules="required"
                                    :label="trans('admin::app.appearance.sections.edit.key-input')"
                        ...
                        <x-slot:footer>
                            ...
                            <x-admin::button
                                ...
                                :title="trans('admin::app.appearance.sections.edit.save-btn')"
                            />
                        </x-slot>
                    </x-admin::modal>
                </form>
                        ...
                        available: [
                            {
                                ...
                                code: 'new',
                                type: 'select',
                                name: '@lang('admin::app.appearance.sections.edit.new')',
                                options: [
                                    {
                                        'id': 0,
                                        'admin_name': '@lang('admin::app.appearance.sections.edit.no')',
                                    },
                                    {
                                        'id': 1,
                                        'admin_name': '@lang('admin::app.appearance.sections.edit.yes')',
                                    },
                                ],
                            },
                            {
                                ...
                                code: 'featured',
                                type: 'select',
                                name: '@lang('admin::app.appearance.sections.edit.featured')',
                                options: [
                                    {
                                        'id': 0,
                                        'admin_name': '@lang('admin::app.appearance.sections.edit.no')',
                            ...
                            },
                            {
                                ...
                                code: 'category_id',
                                type: 'text',
                                name: '@lang('admin::app.appearance.sections.edit.category-id')',
                            },
