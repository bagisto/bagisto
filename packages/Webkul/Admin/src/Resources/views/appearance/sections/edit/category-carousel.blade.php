<v-category-carousel :errors="errors">
    <x-admin::shimmer.appearance.sections.category-carousel />
</v-category-carousel>
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.category-carousel')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.category-carousel-description')
                        </p>
                    </div>
                </div>
                ...
                <x-admin::form.control-group>
                    ...
                    >
                        ...
                        >
                            ...
                            <option value="desc">
                                @lang('admin::app.appearance.sections.edit.desc')
                            </option>

                            <option value="asc">
                                @lang('admin::app.appearance.sections.edit.asc')
                            </option>
                        </select>
                    </v-field>
                ...
                <x-admin::form.control-group>
                    ...
                    <v-field
                        ...
                        placeholder="@lang('admin::app.appearance.sections.edit.limit')"
                    >
                    </v-field>
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.appearance.sections.edit.category-carousel')"
                    >
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <template v-else>
                                    ...
                                    >
                                        @lang('admin::app.appearance.sections.edit.parent-id-hint')
                                    </p>
                                </template>
                        ...
                        available: [
                            {
                                id: 'parent_id',
                                code: 'parent_id',
                                name: '@lang('admin::app.appearance.sections.edit.parent-id')',
                                type: 'text',
                            },
                            {
                                id: 'name',
                                code: 'name',
                                name: '@lang('admin::app.appearance.sections.edit.name')',
                                type: 'text',
                            },
                            {
                                id: 'status',
                                code: 'status',
                                name: '@lang('admin::app.appearance.sections.edit.status')',
                                type: 'select',
                                options: [
                                    {
                                        id: '1',
                                        name: '@lang('admin::app.appearance.sections.edit.active')',
                                    },
                                    {
                                        id: '0',
                                        name: '@lang('admin::app.appearance.sections.edit.inactive')',
                                    },
                                ],
                            },
                        ],
