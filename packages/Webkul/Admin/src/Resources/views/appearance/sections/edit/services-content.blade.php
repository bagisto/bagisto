<v-services-content :errors="errors">
    <x-admin::shimmer.appearance.sections.services-content />
</v-services-content>
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.services-content.services')
                        </p>
                        
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.services-content.service-info')
                        </p>
                    </div>
                    ...
                    <div class="flex gap-2.5">
                        <div
                            ...
                            @click="add"
                        >
                            @lang('admin::app.appearance.sections.edit.services-content.add-btn')
                        </div>
                    </div>
                </div>
                    ...
                    >
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    <div> 
                                        @lang('admin::app.appearance.sections.edit.services-content.title'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    <div> 
                                        @lang('admin::app.appearance.sections.edit.services-content.description'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('admin::app.appearance.sections.edit.services-content.service-icon'): 
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            <div class="flex items-center gap-x-5">
                                ...
                                > 
                                    @lang('admin::app.appearance.sections.edit.services-content.delete')
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.appearance.sections.edit.services-content.services')"
                    >
                    ...
                    <x-admin::modal ref="addServiceModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                ...
                                <template v-else>
                                    @lang('admin::app.appearance.sections.edit.services-content.update-service')
                                </template>
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.appearance.sections.edit.services-content.title')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.services-content.title')"
                                />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.appearance.sections.edit.services-content.description')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.services-content.description')"
                                />
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.appearance.sections.edit.services-content.service-icon-class')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.appearance.sections.edit.services-content.service-icon-class')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.services-content.service-icon-class')"
                                />
                        ...
                        <x-slot:footer>
                            ...
                            <x-admin::button
                                ...
                                :title="trans('admin::app.appearance.sections.edit.services-content.save-btn')"
                            />
                        </x-slot>
                    </x-admin::modal>
                </form>
