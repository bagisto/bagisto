<v-image-carousel :errors="errors">
    <x-admin::shimmer.appearance.sections.image-carousel />
</v-image-carousel>
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                <div class="flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.slider')
                        </p>
                        
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.slider-description')
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        @click="create"
                    >
                        @lang('admin::app.appearance.sections.edit.slider-add-btn')
                    </div>
                </div>
                    ...
                    >
                        <div class="flex gap-2.5">
                            <div class="grid place-content-start gap-1.5">
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('admin::app.appearance.sections.edit.image-title'): 
                                ...
                                <p class="text-gray-600 dark:text-gray-300">
                                    @lang('admin::app.appearance.sections.edit.link'): 
                        ...
                        <div class="grid place-content-start gap-1 text-right">
                            <div class="flex items-center gap-x-5">
                                ...
                                >
                                    @lang('admin::app.appearance.sections.edit.edit')
                                </p>
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.appearance.sections.edit.slider')"
                    >
                    ...
                    <x-admin::modal ref="addSliderModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                ...
                                <template v-else>
                                    @lang('admin::app.appearance.sections.edit.update-slider')
                                </template>
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :placeholder="trans('admin::app.appearance.sections.edit.image-title')"
                                    :label="trans('admin::app.appearance.sections.edit.image-title')"
                                />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :placeholder="trans('admin::app.appearance.sections.edit.link')"
                                />
                            </x-admin::form.control-group>

                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.appearance.sections.edit.slider-image')
                                </x-admin::form.control-group.label>
                            ...
                            <p class="text-xs text-gray-600 dark:text-gray-300">
                                @lang('admin::app.appearance.sections.edit.image-size')
                            </p>
                        </x-slot>
                ...
                saveSliderImage(_, { resetForm, setErrors }) {
                    ...
                    try {
                        ...
                        if (! this.hasSliderImage(formData, hasUploadedImage)) {
                            throw new Error("{{ trans('admin::app.appearance.sections.edit.slider-required') }}");
                        }
