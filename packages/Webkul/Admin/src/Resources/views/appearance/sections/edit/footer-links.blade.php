<v-footer-links :errors="errors">
    <x-admin::shimmer.appearance.sections.footer-links />
</v-footer-links>
            ...
            <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                ...
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.footer-link')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.footer-link-description')
                        </p>
                    </div>
                    ...
                    >
                        @lang('admin::app.appearance.sections.edit.add-link')
                    </div>
                </div>
                            ...
                            <div class="flex gap-2.5">
                                <div class="grid place-content-start gap-1.5">
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('admin::app.appearance.sections.edit.column'): 
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300">
                                        @lang('admin::app.appearance.sections.edit.url'):
                ...
                >
                    <img
                        ...
                        alt="@lang('admin::app.appearance.sections.edit.footer-link')"
                    >
                    ...
                    <x-admin::modal ref="addLinksModal">
                        ...
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800 dark:text-white">
                                @lang('admin::app.appearance.sections.edit.footer-link-form-title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="column"
                                    rules="required"
                                    :label="trans('admin::app.appearance.sections.edit.column')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.column')"
                                    ::disabled="isUpdating"
                                >
                            ...
                            <x-admin::form.control-group>
                                <x-admin::form.control-group.label class="required">
                                    @lang('admin::app.appearance.sections.edit.footer-title')
                                </x-admin::form.control-group.label>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="title"
                                    rules="required"
                                    :label="trans('admin::app.appearance.sections.edit.footer-title')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.footer-title')"
                                />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    name="url"
                                    rules="required|url"
                                    :label="trans('admin::app.appearance.sections.edit.url')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.url')"
                                />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control
                                    ...
                                    :label="trans('admin::app.appearance.sections.edit.sort-order')"
                                    :placeholder="trans('admin::app.appearance.sections.edit.sort-order')"
                                />
