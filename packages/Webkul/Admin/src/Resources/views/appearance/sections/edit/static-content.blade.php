<v-static-content :errors="errors">
    <x-admin::shimmer.appearance.sections.static-content />
</v-static-content>
                ...
                <div class="mb-2.5 flex items-center justify-between gap-x-2.5">
                    <div class="flex flex-col gap-1">
                        <p class="text-base font-semibold text-gray-800 dark:text-white">
                            @lang('admin::app.appearance.sections.edit.static-content')
                        </p>

                        <p class="text-xs font-medium text-gray-500 dark:text-gray-300">
                            @lang('admin::app.appearance.sections.edit.static-content-description')
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <label
                            ...
                            for="static_image"
                        >
                            @lang('admin::app.appearance.sections.edit.add-image-btn')
                        </label>
                    ...
                    <div class="tabs">
                        <div class="mb-4 flex gap-4 border-b-2 pt-2 max-sm:hidden">
                            ...
                            <p @click="switchEditor('v-html-editor-theme', 1)">
                                ...
                                >
                                    @lang('admin::app.appearance.sections.edit.html')
                                </div>
                            </p>
                            ...
                            <p @click="switchEditor('v-css-editor-theme', 0);">
                                ...
                                >
                                    @lang('admin::app.appearance.sections.edit.css')
                                </div>
                            </p>
                            ...
                            <p @click="switchEditor('v-static-content-previewer', 0);">
                                ...
                                >
                                    @lang('admin::app.appearance.sections.edit.preview')
                                </div>
                            </p>
                        </div>
                    </div>
                ...
                storeImage($event) {
                    ...
                    if (! validFiles) {
                        this.$emitter.emit('add-flash', {
                            type: 'warning',
                            message: '@lang('admin::app.appearance.sections.edit.image-upload-message')'
                        });
        ...
        app.component('v-html-editor-theme', {
            ...
            methods: {
                ...
                storeImage($event) {
                    ...
                    this.$axios.post('{{ route('admin.appearance.sections.store') }}', formData)
                        .then((response) => {
