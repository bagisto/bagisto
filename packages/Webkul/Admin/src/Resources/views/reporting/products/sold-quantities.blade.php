        ...
        <div class="flex-1 relative p-[16px] bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
            ...
            <template v-else>
                ...
                <div class="grid gap-[16px]">
                    <div class="flex gap-[16px]">
                        ...
                        <div class="flex gap-[2px] items-center">
                            <span
                                ...
                                :class="[report.statistics.quantities.progress < 0 ? 'icon-down-stat text-red-500' : 'icon-up-stat text-emerald-500']"
                            ></span>
                    ...
                    <!-- Line Chart -->
                    <canvas
                        id="getTotalSoldQuantitiesStats"
            ...
            methods: {
                getStats() {
                    ...
                    this.$axios.get("{{ route('admin.reporting.sales.stats') }}", {
                            params: {
                                type: 'getTotalSoldQuantitiesStats'
                            }
                        })
                        .then(response => {
                            ...
                            setTimeout(() => {
                                this.$parent.prepareChart('getTotalSoldQuantitiesStats', response.data.statistics.over_time);
                            }, 0);
