    ...
    [
        ...
        'fields' => [
            [
                ...
                'name'          => 'enable_ram',
                'title'         => 'Enable RAM Login',
                'type'          => 'boolean',
                'channel_based' => true,
            ], [
                'name'    => 'ram_client_id',
                'title'   => 'RAM App ID',
                'info'    => 'OAuth App ID from RAM (redactivamexico.net/apps)',
                'type'    => 'text',
                'depends' => 'enable_ram:1',
            ], [
                'name'    => 'ram_client_secret',
                'title'   => 'RAM App Secret',
                'info'    => 'OAuth App Secret from RAM',
                'type'    => 'text',
                'depends' => 'enable_ram:1',
            ], [
                'name'    => 'ram_callback_url',
                'title'   => 'RAM Callback URL',
                'info'    => 'OAuth redirect URI (e.g., https://plaza.redactivamexico.net/customer/social-login/ram/callback)',
                'type'    => 'text',
                'depends' => 'enable_ram:1',
            ], [
                'name'    => 'ram_base_url',
