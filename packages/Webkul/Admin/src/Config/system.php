    ...
    [
        ...
        'fields' => [
            [
                ...
                'name' => 'webhook_secret',
                'title' => 'admin::app.configuration.index.sales.payment-methods.webhook-secret',
                'info' => 'admin::app.configuration.index.sales.payment-methods.webhook-secret-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                ...
                'title' => 'admin::app.configuration.index.sales.payment-methods.webhook-test-secret',
                'info' => 'admin::app.configuration.index.sales.payment-methods.webhook-test-secret-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
