...
return [
        ...
        'products' => [
            ...
            'validation' => [
                'errors' => [
                    ...
                    'image-not-file' => 'Зображення: \'%s\' — це вебадреса, хоча цей імпорт налаштовано брати зображення з файлів. Оберіть джерело «Посилання на зображення у файлі» або замініть значення іменем файлу.',
                    'image-not-found' => 'Зображення: \'%s\' не знайдено там, де цей імпорт очікує свої зображення.',
                    'image-not-url' => 'Зображення: \'%s\' не є вебадресою, хоча цей імпорт налаштовано завантажувати зображення за посиланнями з файлу. Оберіть інше джерело зображень або замініть значення повною адресою https://.',
    ...
    'validation' => [
        'errors' => [
            ...
            'more-issues' => 'і ще :count проблем(и) — завантажте повний звіт для повного списку.',
            'more-rows' => '(+ще :count рядків)',
