                    ...
                    methods: {
                        ...
                        reloadPrice: function () {
                            ...
                            if (this.childAttributes.length == selectedOptionCount) {
                                ...
                                if(this.config.variant_prices[this.simpleProduct].regular_price.formated_price=="$0.00" || this.config.variant_prices[this.simpleProduct].regular_price.formated_price==this.config.variant_prices[this.simpleProduct].final_price.formated_price){
                                    regularPriceElement.innerHTML = "";
                                }

                                if (regularPriceElement && this.config.variant_prices[this.simpleProduct].regular_price.formated_price!="$0.00" && this.config.variant_prices[this.simpleProduct].regular_price.formated_price!=this.config.variant_prices[this.simpleProduct].final_price.formated_price) {
