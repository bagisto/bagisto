...
return [
    'admin'         => [
        'system'    => [
            'velocity' => [
                ...
                'category'       => 'වර්ගය',
                'settings'       => 'සැකසුම්',
                'extension_name' => 'ප්‍රවේග තේමාව',
                'error-module-inactive' => 'අවවාදයයි: ප්‍රවේග තේමා තත්ත්වය අක්‍රියයි',
            ],
            ...
            'category' => [
                ...
                'icon-status'       => 'ප්‍රවර්ග නිරූපක තත්ත්වය',
                'image-status'      => 'ප්‍රවර්ග රූප තත්ත්වය',
                'sub-category-show' => 'උප ලකුණු',
                'image-height'      => 'රූපයේ උස [පික්සලයෙන්]',
                'image-width'       => "රූපයේ පළල' [පික්සලයෙන්]",
                'show-tooltip'      => 'ප්‍රවර්ගයේ මෙවලම් උපදෙස් පෙන්වන්න',
        ...
        'meta-data' => [
            ...
            'footer-left-raw-content'   =>'<p>අපි මෘදුකාංග සැකසීමට සහ ද්විමය සමඟ සැබෑ ලෝකයේ ගැටලු විසඳීමට කැමතියි. අපි අපේ ඉලක්ක සඳහා ඉතා කැපවී සිටිමු. ව්‍යවසාය ව්‍යාපාරය සඳහා භාවිත කිරීමට පහසු මෘදුකාංග සහ යෙදුම් නිර්මාණය කිරීමට අපි අපගේ සම්පත් ආයෝජනය කරන්නේ ඉහළම මට්ටමේ තාක්ෂණික විශේෂඥතාව මතයි.</p>',
            'slider-path'               => 'ස්ලයිඩර් මාර්ගය',
            'category-logo'             => 'ප්‍රවර්ග ලාංඡනය',
            'product-policy'            => 'නිෂ්පාදන ප්‍රතිපත්තිය',
            ...
            'footer-middle' => [
                ...
                'order-and-returns'  => 'ඇණවුම සහ ප්‍රතිලාභ',
                'payment-policy'     => 'ගෙවීම් ප්‍රතිපත්තිය',
                'shipping-policy'    => 'නැව් ප්‍රතිපත්තිය',
                'privacy-and-cookies-policy' => 'පෞද්ගලිකත්වය සහ කුකීස් ප්‍රතිපත්තිය'
            ]
        ],
        'category'  => [
            'image-four-resolution'     => "පළමු රූප විභේදනය 427px X 410px වැනි විය යුතුය ,
            ...
            'title'                     => 'ප්‍රවර්ග මෙනු ලැයිස්තුව',
            'add-title'                 => 'මෙනු අන්තර්ගතය එක් කරන්න',
            'edit-title'                => 'මෙනු අන්තර්ගතය සංස්කරණය කරන්න',
            'btn-add-category'          => 'ප්‍රවර්ග අන්තර්ගතය එක් කරන්න',
            'datagrid' => [
                'category-id'     => 'ප්‍රවර්ග හැඳුනුම්පත',
                'category-name'   => 'ප්‍රවර්ග නාමය',
                'category-icon'   => 'ප්‍රවර්ග නිරූපකය',
            ...
            'mass-delete-success' => 'තෝරාගත් ප්‍රවර්ග මෙනුව සාර්ථකව මකා ඇත.',
        ],
        'general'   => [
    ...
    'product-removed'  => 'පරිපාලක විසින් ඉවත් කරන ලද පරිදි නිෂ්පාදනය තවදුරටත් ලබා ගත නොහැක',
    ...
    'home'          => [
        ...
        'popular-categories' => 'ජනප්‍රිය කාණ්ඩ',
    ],
    ...
    'customer'      => [
        ...
        'login-form'        => [
            ...
            'form-login-text'       => 'ඔබට ගිණුමක් තිබේ නම්, ඔබගේ විද්‍යුත් තැපැල් ලිපිනයෙන් පුරන්න.',
        ],
        'signup-form'       => [
            'login'             => 'ඇතුල් වන්න',
            'become-user'       => 'පරිශීලක වන්න',
            'user-registration' => 'පරිශීලක ලියාපදිංචිය',
            'form-signup-text'  => 'ඔබ අපගේ ගබඩාවට අලුත් නම්, ඔබ සාමාජිකයෙකු වීම ගැන අපි සතුටු වෙමු.',
        ],
        'forget-password'   => [
            'login'                 => 'ඇතුල් වන්න',
            'forgot-password'       => 'මුරපදය අමතක වුණා ද',
            'recover-password'      => 'රහස් පදය සොයා',
            'recover-password-text' => 'ඔබට ඔබගේ මුරපදය අමතක වී ඇත්නම්, ඔබගේ විද්‍යුත් තැපැල් ලිපිනය ඇතුලත් කිරීමෙන් එය ප්‍රතිසාධන කරන්න.',
        ],
        'wishlist' => [
    ...
    'products'      => [
        ...
        'customer-rating'   => 'පාරිභෝගික ශ්‍රේණිගත කිරීම',
