@component('admin::emails.layout')
    <div style="margin-bottom: 34px;">
        <p style="font-weight: bold;font-size: 20px;color: #121A26;line-height: 24px;margin-bottom: 24px">
            @lang('admin::app.emails.dear', ['admin_name' => $admin->name]),
        </p>

        <p style="font-size: 16px;color: #384860;line-height: 24px;">
            @lang('two_factor_auth::app.emails.backup-codes.greeting')
        </p>
    </div>

    <p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 40px">
        @lang('two_factor_auth::app.emails.backup-codes.description')
    </p>

    <div style="margin-bottom: 40px;">
        <p style="font-weight: bold;font-size: 18px;color: #121A26;line-height: 24px;margin-bottom: 16px">
            @lang('two_factor_auth::app.emails.backup-codes.codes-title')
        </p>

        <p style="font-size: 14px;color: #384860;line-height: 20px;margin-bottom: 20px">
            @lang('two_factor_auth::app.emails.backup-codes.codes-subtitle')
        </p>
    ...
    <div style="background: #FFF3CD;border: 1px solid #F59E0B;border-radius: 4px;padding: 20px;margin-bottom: 40px;">
        <p style="font-weight: bold;font-size: 16px;color: #92400E;line-height: 24px;margin-bottom: 8px;">
            @lang('two_factor_auth::app.emails.backup-codes.warning-title')
        </p>
        <p style="font-size: 14px;color: #92400E;line-height: 20px;margin: 0;">
            @lang('two_factor_auth::app.emails.backup-codes.warning-description')
        </p>
    </div>
@endcomponent