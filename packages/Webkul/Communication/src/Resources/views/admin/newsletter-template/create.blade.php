    ...
    <div class="content full-page dashboard">
        ...
        <div class="page-content">
            <div class="form-container">
                <form name="template_form" method="POST" action="{{ route('communication.newsletter-templates.store') }}">
                    @csrf
                    ...
                    <div class="control-group" :class="[errors.has('template_name') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" id="template-name" name="template_name" v-validate="'required'" value="{{ old('template_name') }}" data-vv-as="&quot;{{ __('communication::app.newsletter-templates.template-form.template-name') }}&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('template_subject') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" id="template-subject" name="template_subject" v-validate="'required'" value="{{ old('template_subject') }}" data-vv-as="&quot;{{ __('communication::app.newsletter-templates.template-form.template-subject') }}&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('sender_name') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" id="sender-name" name="sender_name" v-validate="'required'" value="{{ old('sender_name') }}" data-vv-as="&quot;{{ __('communication::app.newsletter-templates.template-form.sender-name') }}&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('sender_email') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" id="sender-email" name="sender_email" v-validate="'required'" value="{{ old('sender_email') }}" data-vv-as="&quot;{{ __('communication::app.newsletter-templates.template-form.sender-email') }}&quot;">
                    ...
                    <div class="control-group" :class="[errors.has('template_content') ? 'has-error' : '']">
                        ...
                        <textarea type="text" class="control" id="template-content" name="template_content" v-validate="'required'" data-vv-as="&quot;{{ __('communication::app.newsletter-templates.template-form.template-content') }}&quot;">
