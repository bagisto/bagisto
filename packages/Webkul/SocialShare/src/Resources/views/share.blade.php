@if (core()->getConfigData('catalog.products.social_share.enabled'))
    ...
    <div class="flex gap-[25px]">
        ...
        <div class="hidden gap-[10px] justify-center items-center max-md:flex cursor-pointer">
            ...
            <a href="intent://share/#Intent;action=android.intent.action.SEND;type=text/plain;S.android.intent.extra.TEXT={{ rawurlencode($product->name . ' ' . route('shop.product_or_category.index', [$product->url_key])) }};end">Share</a>
        </div>
