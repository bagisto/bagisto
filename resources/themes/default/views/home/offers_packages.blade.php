<section class="w-full max-w-[1400px] mx-auto px-8 py-20">

  <!-- Header Row -->
  <div class="flex items-start justify-between mb-12">
    <h2 class="font-semibold text-[56px] uppercase tracking-wide text-[#2a1f14] leading-none">
      Offers and Packages
    </h2>
  ...
  <div id="offersContainer" class="flex gap-7 overflow-x-auto scroll-smooth">
    ...
    <div class="offer-card flex flex-col min-w-[300px] cursor-pointer">
      <div class="w-full aspect-square rounded-2xl overflow-hidden mb-5 relative">
        ...
        <span class="absolute top-3 left-3 bg-white/90 text-[#2a1f14] text-[11px] px-3 py-1.5 rounded-full">
          2hrs, 30mins
        </span>
      </div>
      <div class="flex justify-between mb-2">
        <span class="font-semibold uppercase">Offer 299</span>
        <span class="font-semibold text-[#c07a3a]">AED 299</span>
      </div>
      <p class="text-[13px] text-gray-500">Mani Pedi with polish + 30 minutes massage</p>
    </div>
    ...
    <div class="offer-card flex flex-col min-w-[300px] cursor-pointer">
      ...
      <div class="flex justify-between mb-2">
        <span class="font-semibold uppercase">Hair Botox</span>
        <span class="font-semibold text-[#c07a3a]">AED 710</span>
      </div>
      <p class="text-[13px] text-gray-500">Deep conditioning treatments for damaged hair</p>
    </div>
    ...
    <div class="offer-card flex flex-col min-w-[300px] cursor-pointer">
      ...
      <div class="flex justify-between mb-2">
        <span class="font-semibold uppercase">Pampering Offer</span>
        <span class="font-semibold text-[#c07a3a]">AED 450</span>
      </div>
      <p class="text-[13px] text-gray-500">Mani + Pedi + Polish + Swedish Massage</p>
    </div>
    ...
    <div class="offer-card flex flex-col min-w-[300px] cursor-pointer">
      ...
      <div class="flex justify-between mb-2">
        <span class="font-semibold uppercase">Offer Massage</span>
        <span class="font-semibold text-[#c07a3a]">AED 258</span>
      </div>
      <p class="text-[13px] text-gray-500">Mani Pedi with polish + 30 minutes massage</p>
    </div>
