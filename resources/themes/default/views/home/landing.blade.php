...
<!-- SPA SERVICE -->
<div class="relative bg-[#D4AF37] rounded-[28px] overflow-hidden text-white pt-8 pl-11 pr-6 pb-8 w-full max-w-[420px] h-[520px]">
    ...
    <img
        ...
        alt="Model"
        class="absolute bottom-0 -right-12 h-[380px] object-contain pointer-events-none z-0">
</div>



<!-- PERFUME -->
<div class="relative rounded-[28px] pt-10 pl-12 pr-10 pb-6 h-[520px] overflow-hidden"
    ...
    <img
        ...
        <!-- RIGHT COLUMN -->
        <div class="grid grid-rows-2 gap-6 h-[520px]">
