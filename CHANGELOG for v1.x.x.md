...
* #5089 [enhancement] - on clinking Buy Now button cart items should not carried in checkout

* #5061 [enhancement] - Option to add DB_prefix on web installer

* #5173 [fixed] - Typo in type hinting

* #5170 [fixed] - Admin Orders page doesn;t reload while clicking back

* #5155 [fixed] - When product inventory is having same quantity then total qty on the listing page is not calculated properly

* #5125 [fixed] - wrong order status showing at admin and customer end

* #5122 [fixed] - Issue in Mobile number field

* #5115 [fixed] - Getting exception in case admin change url by passing 0 in place of asc or desc
...
* #5104 [fixed] - Last name should be mandatory field even while editing customer profile

* #5101 [fixed] - Incorrect validation message for sort order and Download Allowed field in downloadable information section
