...
window.VeeValidate = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setProps: function setProps() {
      ...
      if ($('.show-content').html(this.content[0])) console.log('content pushed');else console.log('cannot push');
    },
    ...
    changeIndexLeft: function changeIndexLeft() {
      if (this.currentIndex > 0) {
        this.currentIndex--;
        if ($('.show-content').html(this.content[this.currentIndex])) console.log('content pushed');else console.log('cannot push');
