            ...
            <div class="content">
                <div class="form-container" style="padding: 10%; padding-top: 35px">
                    ...
                    <div class="control-group" id="mail_username">
                        <label for="mail_username" class="required">Email</label>
                        <input type="text" name="mail_username" class="control" placeholder="store@example.com" data-validation="required email length" data-validation-length="max50">
                    </div>
